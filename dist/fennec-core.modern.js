...
function ModelRenderer(props) {
  ...
  var renderHeader = function renderHeader() {
    ...
    }, /*#__PURE__*/React.createElement("div", null, meta.label)), /*#__PURE__*/React.createElement("div", null, meta.name && visible && getObjectDisplay(object, meta.name, gmeta))), /*#__PURE__*/React.createElement("div", {
...
function Overlay(props) {
  ...
  return /*#__PURE__*/React.createElement("div", null, !open && renderChildren(false), open && typeof document !== 'undefined' && ReactDOM.createPortal(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: overlayStyle
  }, /*#__PURE__*/React.createElement("div", {
...
export { Action, ActionCore, ActionFormCore, ActionMobileRenderer, ActionModalCore, ActionWizardCore, AuthProvider, AuthService, index$4 as CRUD, ClipboardContext, Collection, CollectionMobileRenderer, index as ErrorHandling, Field, FieldMobileRenderer, FormObserverContext, index$2 as Meta, MetaContext, MetaProvider, Model, ModelMobileRenderer, Overlay, index$5 as PubSub, index$3 as Query, RequireAuth, index$7 as Roles, TranslateContext, TranslateProvider, UIAdapter, UIProvider, UserConfigContext, UserConfigProvider, UserContext, index$6 as UtilsCore, index$1 as Validation, useActionRef, useAuth, useClipboardContext, useCollectionRef, useFormObserverContext, useMetaContext, useNavigation, useTranslateContext, useUI, useUIOptional, useUserConfigContext, useUserContext };
