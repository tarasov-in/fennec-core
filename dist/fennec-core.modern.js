import React, { createContext, useContext, useState, useEffect, useMemo, memo, useCallback, useRef, isValidElement, cloneElement, Fragment as Fragment$1 } from 'react';
import PubSub from 'pubsub-js';
import uuid from 'react-uuid';
import { useNavigate } from 'react-router-dom';
import decode from 'jwt-decode';
import { useMediaQuery } from 'react-responsive';
import { TextArea as TextArea$1, Checkbox as Checkbox$1, Radio as Radio$1, Switch as Switch$1, Slider as Slider$1, SearchBar, Stepper, List as List$1, Tag as Tag$1, Badge as Badge$1, Image as Image$1, ProgressBar, Popup, CenterPopup, Loading, Button as Button$1, Picker, CascadePicker, Form as Form$1, Input as Input$1, Selector, DatePicker as DatePicker$1, ImageUploader, Modal as Modal$1, Toast, InfiniteScroll, Dialog } from 'antd-mobile';
import ReactDOM from 'react-dom';
import getScrollBarSize from 'rc-util/lib/getScrollBarSize';
import { updateCSS, removeCSS } from 'rc-util/lib/Dom/dynamicCSS';
import { Input as Input$2, Select as Select$1, DatePicker as DatePicker$2, TimePicker as TimePicker$1, Form as Form$2, Table as Table$1, List as List$2, Modal as Modal$2, Drawer as Drawer$1, Tabs as Tabs$1, Divider as Divider$1, Space as Space$1, Card as Card$1, Button as Button$2, Dropdown as Dropdown$1, Tooltip as Tooltip$1, Pagination as Pagination$2, Spin as Spin$1, Empty as Empty$1, Tag as Tag$2, Badge as Badge$2, InputNumber as InputNumber$1, Slider as Slider$2, Upload as Upload$1, Checkbox as Checkbox$2, Radio as Radio$2, Image as Image$2, Switch as Switch$2, Rate as Rate$2, ColorPicker as ColorPicker$1, message } from 'antd';
import { FilterOutlined, SortAscendingOutlined, SortDescendingOutlined, FullscreenOutlined, FullscreenExitOutlined } from '@ant-design/icons';
import locale from 'antd/es/date-picker/locale/ru_RU';
import { TextField, FormControl, InputLabel, Select as Select$2, MenuItem, Checkbox as Checkbox$3, FormControlLabel, RadioGroup, Radio as Radio$3, Switch as Switch$3, Stack, Slider as Slider$3, Button as Button$3, Rating, TableContainer, Table as Table$2, TableHead, TableRow, TableCell, TableBody, TablePagination, List as List$3, ListItem, ListItemText, Card as Card$2, CardHeader, CardContent, Box, FormHelperText, Dialog as Dialog$1, DialogTitle, DialogContent, DialogActions, Drawer as Drawer$2, Tabs as Tabs$2, Tab, Divider as Divider$2, CircularProgress, Menu, Tooltip as Tooltip$2, Chip, Badge as Badge$3 } from '@mui/material';
import { DatePicker as DatePicker$3, TimePicker as TimePicker$2 } from '@mui/x-date-pickers';
import { LocalizationProvider } from '@mui/x-date-pickers/LocalizationProvider';
import { AdapterDayjs } from '@mui/x-date-pickers/AdapterDayjs';
import { Listbox, Transition, Switch as Switch$4, Disclosure, Tab as Tab$1, Dialog as Dialog$2, Menu as Menu$1 } from '@headlessui/react';
import { ChevronLeftIcon, ChevronRightIcon, ChevronUpDownIcon, CheckIcon, XMarkIcon, InformationCircleIcon, CheckCircleIcon, ExclamationTriangleIcon, XCircleIcon } from '@heroicons/react/24/outline';
...
function UserConfigProvider(_ref) {
  ...
  return /*#__PURE__*/React.createElement(UserConfigContext.Provider, {
...
function MetaProvider(_ref) {
  ...
  return /*#__PURE__*/React.createElement(MetaContext.Provider, {
    value: meta
  }, (ready || !auth.loggedIn()) && children);
}
...
function UIProvider(_ref) {
  ...
  var memoizedAdapter = useMemo(function () {
    return adapter;
  }, [adapter]);
...
function useUI() {
  var adapter = useContext(UIContext);
  if (!adapter) {
...
var FieldRenderer = function FieldRenderer(_ref) {
  ...
  if (!UIComponent) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: className,
      style: style
    }, /*#__PURE__*/React.createElement("input", componentProps));
  }
  ...
  if (!FormItem) {
    return /*#__PURE__*/React.createElement("div", {
      className: className,
      style: style
    }, label && /*#__PURE__*/React.createElement("label", null, label), /*#__PURE__*/React.createElement(UIComponent, componentProps), help && /*#__PURE__*/React.createElement("small", null, help));
  }
  ...
  }, /*#__PURE__*/React.createElement(UIComponent, componentProps));
};
...
function FieldMobileRenderer(props) {
  ...
  var renderField = function renderField() {
    ...
    if (fieldType === 'number') {
      return /*#__PURE__*/React.createElement(ui.InputNumber, {
        value: value,
        onChange: _onChange,
        placeholder: placeholder,
        disabled: disabled,
    ...
    if (fieldType === 'time') {
      ...
      return /*#__PURE__*/React.createElement(ui.TimePicker, {
    ...
    if (fieldType === 'checkbox') {
      return /*#__PURE__*/React.createElement(ui.Checkbox, {
        checked: value,
        onChange: function onChange(e) {
    ...
    if (fieldType === 'radio') {
      return /*#__PURE__*/React.createElement(ui.Radio.Group, {
        value: value,
        onChange: function onChange(e) {
          return _onChange(e.target.value);
        },
        ...
        return /*#__PURE__*/React.createElement(ui.Radio, {
          key: opt.value,
          value: opt.value
        }, opt.label);
      }));
    ...
    if (fieldType === 'switch') {
      return /*#__PURE__*/React.createElement(ui.Switch, {
        checked: value,
    ...
    if (fieldType === 'slider') {
      return /*#__PURE__*/React.createElement(ui.Slider, {
        value: value,
        onChange: _onChange,
        disabled: disabled,
        min: item.min || 0,
    ...
    if (fieldType === 'rate') {
      return /*#__PURE__*/React.createElement(ui.Rate, {
        value: value,
        onChange: _onChange,
        disabled: disabled,
        count: item.count || 5
    ...
    if (fieldType === 'file' || fieldType === 'image') {
      return /*#__PURE__*/React.createElement(ui.Upload, {
        fileList: value || [],
    ...
    if (fieldType === 'tag') {
      ...
      }), !disabled && !readonly && /*#__PURE__*/React.createElement(ui.SearchBar, {
        placeholder: "Add tag",
...
var Field = memo(FieldComponent, arePropsEqual);
...
function ModelRenderer(props) {
  ...
  var modelCore = React.useMemo(function () {
  ...
  var renderRelationTabs = function renderRelationTabs() {
    ...
    }, /*#__PURE__*/React.createElement(Tabs, null, propertiesOneMany.map(function (property, idx) {
  ...
  var renderHeader = function renderHeader() {
    ...
    }, meta.name && visible && /*#__PURE__*/React.createElement("div", {
      style: headerLabelStyle
    }, /*#__PURE__*/React.createElement("div", null, meta.label)), /*#__PURE__*/React.createElement("div", null, meta.name && visible && getObjectDisplay$1(object, meta.name, gmeta))), /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(AntForm, _extends({
    form: form,
    onFinish: submit,
...
function ModelMobileRenderer(props) {
  ...
  var renderField = function renderField(item) {
    ...
    }, /*#__PURE__*/React.createElement(FieldMobileRenderer, {
      fieldCore: fieldCore,
      item: item,
...
function Model(props) {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, subheader || null, /*#__PURE__*/React.createElement(Renderer, props));
}
...
function ActionRenderer(_ref) {
  ...
  var renderFormContent = function renderFormContent() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      children: /*#__PURE__*/React.createElement(FormComponent, {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, renderTrigger(), ui.renderModal(_extends({}, modalProps, {
    title: titles === null || titles === void 0 ? void 0 : titles.header,
    subTitle: titles === null || titles === void 0 ? void 0 : titles.subheader,
    footer: renderFooter(),
    width: 600,
    destroyOnClose: true,
    children: /*#__PURE__*/React.createElement(Fragment, null, renderWizardNavigation(), renderFormContent())
  })));
}
...
function ActionMobileRenderer(_ref) {
  ...
  var renderWizardProgress = function renderWizardProgress() {
    ...
    }, "Step ", currentStep + 1, " of ", totalSteps), /*#__PURE__*/React.createElement(ui.Progress, {
      percent: progress,
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, triggerElement, /*#__PURE__*/React.createElement(ui.CenterPopup, {
  ...
  }, modalProps.title && /*#__PURE__*/React.createElement("div", {
    className: headerClassName,
    style: headerStyle
...
function CollectionMobileRenderer(props) {
  ...
  var renderItem = function renderItem(item) {
    ...
    }, displayText), onItemClick && /*#__PURE__*/React.createElement("div", {
...
var AntdMobileAdapter = /*#__PURE__*/function (_UIAdapter) {
  ...
  _proto.wrapSelector = function wrapSelector() {
    return function (props) {
      ...
      return /*#__PURE__*/React.createElement(Selector, _extends({}, rest, {
  ...
  _proto.wrapDatePicker = function wrapDatePicker() {
    return function (props) {
      ...
      return /*#__PURE__*/React.createElement(DatePicker$1, _extends({}, rest, {
        value: value,
  ...
  _proto.wrapImageUploader = function wrapImageUploader() {
    return function (props) {
      ...
      return /*#__PURE__*/React.createElement(ImageUploader, _extends({}, rest, {
        value: fileList,
        maxCount: maxCount,
  ...
  _proto.wrapList = function wrapList() {
    return function (props) {
      ...
      if (renderItem) {
        return /*#__PURE__*/React.createElement(List$1, rest, dataSource.map(function (item, index) {
          return /*#__PURE__*/React.createElement(List$1.Item, {
      ...
      return /*#__PURE__*/React.createElement(List$1, rest, loading && /*#__PURE__*/React.createElement(Loading, null), !loading && dataSource.map(function (item, index) {
        return /*#__PURE__*/React.createElement(List$1.Item, {
          key: item.ID || item.id || index
  ...
  _proto.wrapModal = function wrapModal() {
    return function (props) {
      ...
      return /*#__PURE__*/React.createElement(Modal$1, _extends({}, rest, {
        visible: visible,
        title: title,
        onClose: onCancel,
        content: children,
  ...
  _proto.wrapPagination = function wrapPagination() {
    return function (props) {
      ...
      return /*#__PURE__*/React.createElement(InfiniteScroll, _extends({}, rest, {
        hasMore: hasMore,
...
function Overlay(props) {
  ...
  var renderChildren = useCallback(function (opened) {
    if (children) {
      if (isValidElement(children)) {
        return /*#__PURE__*/React.createElement("div", null, cloneElement(children, {}));
      }
    }
  }, [children, setOpen]);
  return /*#__PURE__*/React.createElement("div", null, !open && renderChildren(false), open && ReactDOM.createPortal(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: overlayStyle
  }, /*#__PURE__*/React.createElement("div", {
...
var AntTextArea = Input$2.TextArea;
function Input(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Input$2, _extends({
    value: value,
...
function TextArea(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(AntTextArea, _extends({
    value: value,
    onChange: handleChange
  }, rest));
}
...
var AntRangePicker = DatePicker$2.RangePicker;
function DatePicker(_ref) {
  ...
  return /*#__PURE__*/React.createElement(DatePicker$2, _extends({
    value: value,
    onChange: onChange,
    format: format,
    showTime: showTime,
...
function RangePicker(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(AntRangePicker, _extends({
    value: value,
    onChange: onChange,
    format: format,
    locale: locale
...
function Form(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Form$2, _extends({
    onFinish: onFinish,
    initialValues: initialValues,
    form: form,
    layout: layout
...
function List(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(List$2, _extends({
    dataSource: dataSource,
    renderItem: renderItem,
    loading: loading,
    pagination: pagination
...
function Modal(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Modal$2, _extends({
    open: visible,
    onCancel: onClose,
    title: title,
    footer: footer,
...
function Drawer(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(Drawer$1, _extends({
    open: visible,
    onClose: onClose,
    title: title,
    placement: placement,
...
function TabPane(_ref4) {
  ...
  return /*#__PURE__*/React.createElement(AntTabPane, _extends({
    tab: tab
  }, rest), children);
}
function Divider(_ref5) {
  ...
  return /*#__PURE__*/React.createElement(Divider$1, _extends({
    type: type,
...
function Space(_ref6) {
  ...
  return /*#__PURE__*/React.createElement(Space$1, _extends({
    direction: direction,
    size: size
  }, rest), children);
}
...
var AntDragger = Upload$1.Dragger;
function Pagination(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Pagination$2, _extends({
    current: current,
    total: total,
    pageSize: pageSize,
    onChange: onChange,
...
function Spin(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(Spin$1, _extends({
    spinning: spinning,
    size: size
  }, rest), children);
}
function Empty(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(Empty$1, _extends({
...
function Tag(_ref4) {
  ...
  return /*#__PURE__*/React.createElement(Tag$2, _extends({
    color: color,
    onClose: onClose,
    closable: closable
  }, rest), children);
...
function Badge(_ref5) {
  ...
  return /*#__PURE__*/React.createElement(Badge$2, _extends({
    count: count,
    dot: dot
  }, rest), children);
}
...
function Dragger(_ref9) {
  ...
  return /*#__PURE__*/React.createElement(AntDragger, _extends({
    fileList: fileList,
    onChange: handleChange,
    accept: accept,
    multiple: multiple
...
function Checkbox(_ref0) {
  ...
  return /*#__PURE__*/React.createElement(Checkbox$2, _extends({
    checked: checked,
    onChange: handleChange,
    disabled: disabled
  }, rest), label || children);
...
function Radio(_ref1) {
  ...
  return /*#__PURE__*/React.createElement(Radio$2.Group, _extends({
    value: value,
    onChange: function onChange(e) {
...
function Image(_ref10) {
  ...
  return /*#__PURE__*/React.createElement(Image$2, _extends({
    src: src,
    alt: alt,
    width: width,
    height: height,
...
function Switch(_ref11) {
  ...
  return /*#__PURE__*/React.createElement(Switch$2, _extends({
    checked: checked,
    onChange: handleChange,
    disabled: disabled
  }, rest));
...
function Rate(_ref12) {
  ...
  return /*#__PURE__*/React.createElement(Rate$2, _extends({
    value: value,
    onChange: handleChange,
    count: count,
    disabled: disabled,
...
function ColorPicker(_ref13) {
  ...
  return /*#__PURE__*/React.createElement(ColorPicker$1, _extends({
    value: value,
    onChange: handleChange,
    disabled: disabled,
    showText: showText
...
function PopoverModal(_ref) {
  var open = _ref.open,
    ...
    contentStyle = _ref.contentStyle,
    contentClassName = _ref.contentClassName;
  return /*#__PURE__*/React.createElement(Fragment, null, children, /*#__PURE__*/React.createElement(Overlay, {
    open: open,
    setOpen: setOpen,
...
function SortingFieldsUI(props) {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(Divider, {
    ...
    icon: /*#__PURE__*/React.createElement(SortAscIcon, null),
    ...
    icon: /*#__PURE__*/React.createElement(SortDescIcon, null),
...
function FiltersFieldsUI(props) {
  ...
  var _onFilterChange = useMemo(function () {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(Divider, {
    ...
    style: contentStyle,
    className: contentClassName
  }, /*#__PURE__*/React.createElement("div", null, JSXMap$1(filters === null || filters === void 0 ? void 0 : filters.filter(function (i) {
    return i.filter;
  }), function (item, idx) {
    var _item$name;
    return /*#__PURE__*/React.createElement("div", {
...
function FilterContent(props) {
  ...
  var adapter = useUIAdapter();
  var Button = adapter.Button;
  return /*#__PURE__*/React.createElement(Fragment, null, function () {
...
function CollectionRenderer(props) {
  ...
  var collectionCore = useMemo(function () {
  ...
  var _useState0 = useState(collectionCore.getDefaultSorting(fltrs)),
  ...
  var setCurrent = useCallback(function (value) {
    _setCurrent(value);
  ...
  var setCollection = useCallback(function (array) {
    if (onSetCollection) {
  ...
  var applyFilter = useCallback(function () {
  ...
  var request = useCallback(function (filter) {
  ...
  var renderContext = useMemo(function () {
    return {
      collection: collection,
      setCollection: setCollection,
  ...
  var shellContext = useMemo(function () {
  ...
  var renderFilterPanel = function renderFilterPanel() {
    ...
    return /*#__PURE__*/React.createElement(PopoverModal, {
      open: filtered,
      setOpen: setFiltered,
      bounding: bounding,
      content: /*#__PURE__*/React.createElement(FilterContent, {
        auth: auth,
        filters: filters,
        sorting: sorting,
        setSorting: setSorting,
...
function Collection(props) {
  return /*#__PURE__*/React.createElement(CollectionRenderer, props);
}
  ...
  function MaterialUIAdapter() {
    ...
    _this.Select = function (_ref4) {
      ...
      return /*#__PURE__*/React.createElement(FormControl, {
        ...
        size: "small",
        disabled: disabled
      }, props.label && /*#__PURE__*/React.createElement(InputLabel, null, props.label), /*#__PURE__*/React.createElement(Select$2, _extends({
    ...
    _this.Checkbox = function (_ref5) {
      ...
      var checkbox = /*#__PURE__*/React.createElement(Checkbox$3, _extends({
        checked: !!checked,
        onChange: function onChange(e) {
    ...
    _this.Radio = function (_ref6) {
      ...
      return /*#__PURE__*/React.createElement(RadioGroup, _extends({
        ...
        return /*#__PURE__*/React.createElement(FormControlLabel, {
          key: option.value,
          value: option.value,
          control: /*#__PURE__*/React.createElement(Radio$3, null),
          label: option.label,
          disabled: disabled
        });
      }));
    ...
    _this.Switch = function (_ref7) {
      ...
      var switchComponent = /*#__PURE__*/React.createElement(Switch$3, _extends({
        checked: !!checked,
        onChange: function onChange(e) {
    ...
    _this.DatePicker = function (_ref8) {
      ...
      }, /*#__PURE__*/React.createElement(DatePicker$3, _extends({
    ...
    _this.TimePicker = function (_ref9) {
      ...
      return /*#__PURE__*/React.createElement(LocalizationProvider, {
        dateAdapter: AdapterDayjs
      }, /*#__PURE__*/React.createElement(TimePicker$2, _extends({
        value: value ? dayjs_min(value) : null,
        onChange: function onChange(newValue) {
    ...
    _this.RangePicker = function (_ref0) {
      ...
      }, props)), /*#__PURE__*/React.createElement(DatePicker$3, _extends({
        label: "End Date",
    ...
    _this.Slider = function (_ref10) {
      ...
      return /*#__PURE__*/React.createElement(Slider$3, _extends({
    ...
    _this.Upload = function (_ref11) {
      ...
      return /*#__PURE__*/React.createElement(Button$3, _extends({
        ...
        disabled: disabled,
        fullWidth: true
      }, props), "Upload File", /*#__PURE__*/React.createElement("input", {
        type: "file",
        hidden: true,
        accept: accept,
        multiple: multiple,
    ...
    _this.Table = function (_ref14) {
      ...
      return /*#__PURE__*/React.createElement(TableContainer, null, /*#__PURE__*/React.createElement(Table$2, _extends({
        size: "small"
      }, props), /*#__PURE__*/React.createElement(TableHead, null, /*#__PURE__*/React.createElement(TableRow, null, columns.map(function (col) {
        return /*#__PURE__*/React.createElement(TableCell, {
          key: col.key || col.dataIndex
        }, col.title);
      }))), /*#__PURE__*/React.createElement(TableBody, null, dataSource.map(function (row, index) {
      ...
      }))), pagination && /*#__PURE__*/React.createElement(TablePagination, {
        component: "div",
    ...
    _this.List = function (_ref15) {
      ...
      return /*#__PURE__*/React.createElement(List$3, props, dataSource.map(function (item, index) {
        return /*#__PURE__*/React.createElement(ListItem, {
          key: index
        }, renderItem ? renderItem(item, index) : /*#__PURE__*/React.createElement(ListItemText, {
    ...
    _this.Card = function (_ref16) {
      ...
      return /*#__PURE__*/React.createElement(Card$2, props, title && /*#__PURE__*/React.createElement(CardHeader, {
        title: title,
        action: extra
    ...
    _this.FormItem = function (_ref19) {
      ...
      return /*#__PURE__*/React.createElement(FormControl, _extends({
        ...
        shrink: true
      }, label), children, help && /*#__PURE__*/React.createElement(FormHelperText, null, help));
    };
    _this.Modal = function (_ref20) {
      ...
      }, props), title && /*#__PURE__*/React.createElement(DialogTitle, null, title), /*#__PURE__*/React.createElement(DialogContent, null, children), footer && /*#__PURE__*/React.createElement(DialogActions, null, footer));
    };
    _this.Drawer = function (_ref22) {
      ...
      return /*#__PURE__*/React.createElement(Drawer$2, _extends({
    ...
    _this.Tabs = function (_ref24) {
      ...
      var _React$useState = React.useState(activeKey || 0),
      ...
      return /*#__PURE__*/React.createElement(Box, null, /*#__PURE__*/React.createElement(Tabs$2, _extends({
        value: value,
        onChange: handleChange
    ...
    _this.Divider = function (_ref25) {
      ...
      return /*#__PURE__*/React.createElement(Divider$2, _extends({
    ...
    _this.Dropdown = function (_ref28) {
      ...
      }, children), /*#__PURE__*/React.createElement(Menu, _extends({
        anchorEl: anchorEl,
    ...
    _this.Tooltip = function (_ref29) {
      ...
      return /*#__PURE__*/React.createElement(Tooltip$2, _extends({
        title: title
    ...
    _this.Spin = function (_ref31) {
      ...
      }, /*#__PURE__*/React.createElement(CircularProgress, _extends({
        size: size
      }, props)), children);
    };
    ...
    _this.Badge = function (_ref34) {
      ...
      return /*#__PURE__*/React.createElement(Badge$3, _extends({
...
var ChakraUIAdapter = /*#__PURE__*/function (_UIAdapter) {
  ...
  _proto.loadChakraComponents = function loadChakraComponents() {
    try {
      var _this2 = this;
      var _temp = _catch(function () {
        return Promise.resolve(import('@chakra-ui/react')).then(function (chakra) {
          ...
          _this2.InputNumber = function (_ref3) {
            ...
            return /*#__PURE__*/React.createElement(chakra.NumberInput, _extends({
              value: value != null ? value : '',
              ...
              isDisabled: disabled,
              size: "md"
            }, props), /*#__PURE__*/React.createElement(chakra.NumberInputField, {
              placeholder: placeholder
            }), /*#__PURE__*/React.createElement(chakra.NumberInputStepper, null, /*#__PURE__*/React.createElement(chakra.NumberIncrementStepper, null), /*#__PURE__*/React.createElement(chakra.NumberDecrementStepper, null)));
          };
          _this2.Select = function (_ref4) {
            ...
            if (multiple) {
              return /*#__PURE__*/React.createElement(chakra.Select, _extends({
                value: value || [],
                onChange: function onChange(e) {
          ...
          _this2.Checkbox = function (_ref5) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Checkbox, _extends({
              isChecked: !!value,
              onChange: function onChange(e) {
                return _onChange5 === null || _onChange5 === void 0 ? void 0 : _onChange5(e.target.checked);
              },
          ...
          _this2.Radio = function (_ref6) {
            ...
            return /*#__PURE__*/React.createElement(chakra.RadioGroup, _extends({
              value: value != null ? value : '',
              onChange: onChange,
              isDisabled: disabled
            }, props), /*#__PURE__*/React.createElement(chakra.Stack, {
              direction: "column",
              spacing: 2
            }, options.map(function (option) {
              return /*#__PURE__*/React.createElement(chakra.Radio, {
                key: option.value,
                value: option.value
              }, option.label);
            })));
          ...
          _this2.Switch = function (_ref7) {
            ...
            return /*#__PURE__*/React.createElement(chakra.FormControl, {
              display: "flex",
              alignItems: "center"
            }, /*#__PURE__*/React.createElement(chakra.Switch, _extends({
              isChecked: !!value,
              onChange: function onChange(e) {
              ...
              isDisabled: disabled,
              size: "md"
            }, props)), children && /*#__PURE__*/React.createElement(chakra.FormLabel, {
              ml: 2,
              mb: 0
            }, children));
          };
          ...
          _this2.RangePicker = function (_ref0) {
            ...
            return /*#__PURE__*/React.createElement(chakra.HStack, _extends({
              spacing: 2
            }, props), /*#__PURE__*/React.createElement(chakra.Input, {
              type: "date",
              ...
              size: "md"
            }), /*#__PURE__*/React.createElement(chakra.Text, null, "to"), /*#__PURE__*/React.createElement(chakra.Input, {
              type: "date",
          ...
          _this2.Slider = function (_ref1) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Slider, _extends({
              value: value != null ? value : min,
              onChange: onChange,
              min: min,
              max: max,
              step: step,
              isDisabled: disabled
            }, props), /*#__PURE__*/React.createElement(chakra.SliderTrack, null, /*#__PURE__*/React.createElement(chakra.SliderFilledTrack, null)), /*#__PURE__*/React.createElement(chakra.SliderThumb, null));
          };
          _this2.Upload = function (_ref10) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Box, props, /*#__PURE__*/React.createElement(chakra.Input, {
              ref: inputRef,
              type: "file",
              onChange: function onChange(e) {
              ...
              multiple: multiple,
              display: "none"
            }), /*#__PURE__*/React.createElement(chakra.Button, {
              onClick: function onClick() {
                var _inputRef$current;
                return (_inputRef$current = inputRef.current) === null || _inputRef$current === void 0 ? void 0 : _inputRef$current.click();
              },
              isDisabled: disabled,
              leftIcon: /*#__PURE__*/React.createElement(chakra.Icon, {
                as: function as() {
                  return '📁';
                }
              }),
          ...
          _this2.Rate = function (_ref11) {
            ...
            return /*#__PURE__*/React.createElement(chakra.HStack, _extends({
              ...
              return /*#__PURE__*/React.createElement(chakra.Icon, {
                key: index,
                as: function as() {
                  return index < value ? '⭐' : '☆';
                },
          ...
          _this2.Table = function (_ref13) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Box, _extends({
              overflowX: "auto"
            }, props), /*#__PURE__*/React.createElement(chakra.Table, {
              variant: "simple"
            }, /*#__PURE__*/React.createElement(chakra.Thead, null, /*#__PURE__*/React.createElement(chakra.Tr, null, columns.map(function (col, index) {
              return /*#__PURE__*/React.createElement(chakra.Th, {
                key: col.key || index
              }, col.title);
            }))), /*#__PURE__*/React.createElement(chakra.Tbody, null, loading ? /*#__PURE__*/React.createElement(chakra.Tr, null, /*#__PURE__*/React.createElement(chakra.Td, {
              colSpan: columns.length,
              textAlign: "center"
            }, /*#__PURE__*/React.createElement(chakra.Spinner, null))) : dataSource.length === 0 ? /*#__PURE__*/React.createElement(chakra.Tr, null, /*#__PURE__*/React.createElement(chakra.Td, {
              colSpan: columns.length,
              textAlign: "center",
              color: "gray.500"
          ...
          _this2.List = function (_ref14) {
            ...
            return /*#__PURE__*/React.createElement(chakra.List, _extends({
              spacing: 2
            }, props), dataSource.map(function (item, index) {
              return /*#__PURE__*/React.createElement(chakra.ListItem, {
                key: item.id || index
          ...
          _this2.Card = function (_ref15) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Card, props, title && /*#__PURE__*/React.createElement(chakra.CardHeader, {
              display: "flex",
              justifyContent: "space-between",
              alignItems: "center"
            }, /*#__PURE__*/React.createElement(chakra.Heading, {
              size: "md"
            }, title), extra), /*#__PURE__*/React.createElement(chakra.CardBody, null, children));
          };
          _this2.Image = function (_ref16) {
            var src = _ref16.src,
              alt = _ref16.alt,
              props = _objectWithoutPropertiesLoose(_ref16, _excluded16$1);
            return /*#__PURE__*/React.createElement(chakra.Image, _extends({
              src: src,
              alt: alt
            }, props));
          };
          _this2.Modal = function (_ref17) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Modal, _extends({
              isOpen: visible,
              onClose: onClose,
              size: width ? 'full' : 'md'
            }, props), /*#__PURE__*/React.createElement(chakra.ModalOverlay, null), /*#__PURE__*/React.createElement(chakra.ModalContent, {
              maxWidth: width
            }, title && /*#__PURE__*/React.createElement(chakra.ModalHeader, null, title), /*#__PURE__*/React.createElement(chakra.ModalCloseButton, null), /*#__PURE__*/React.createElement(chakra.ModalBody, null, children), footer && /*#__PURE__*/React.createElement(chakra.ModalFooter, null, footer)));
          };
          _this2.Drawer = function (_ref18) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Drawer, _extends({
              isOpen: visible,
              onClose: onClose,
              placement: placement,
              size: width ? 'full' : 'md'
            }, props), /*#__PURE__*/React.createElement(chakra.DrawerOverlay, null), /*#__PURE__*/React.createElement(chakra.DrawerContent, {
              maxWidth: width
            }, /*#__PURE__*/React.createElement(chakra.DrawerCloseButton, null), title && /*#__PURE__*/React.createElement(chakra.DrawerHeader, null, title), /*#__PURE__*/React.createElement(chakra.DrawerBody, null, children)));
          };
          _this2.Tabs = function (_ref19) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Tabs, _extends({
              index: index,
            ...
            }, props), /*#__PURE__*/React.createElement(chakra.TabList, null, items.map(function (item) {
              return /*#__PURE__*/React.createElement(chakra.Tab, {
                key: item.key
              }, item.label);
            })), /*#__PURE__*/React.createElement(chakra.TabPanels, null, items.map(function (item) {
              return /*#__PURE__*/React.createElement(chakra.TabPanel, {
                key: item.key
              }, item.children);
            })));
          };
          _this2.Divider = function (_ref20) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Divider, _extends({
              orientation: orientation
            }, props));
          };
          _this2.Space = function (_ref21) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Stack, _extends({
          ...
          _this2.Dropdown = function (_ref23) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Menu, props, /*#__PURE__*/React.createElement(chakra.MenuButton, {
              as: chakra.Button,
              rightIcon: /*#__PURE__*/React.createElement(chakra.Icon, {
                as: function as() {
                  return '▼';
                }
              })
            }, children), /*#__PURE__*/React.createElement(chakra.MenuList, null, items.map(function (item) {
              return /*#__PURE__*/React.createElement(chakra.MenuItem, {
                key: item.key,
          ...
          _this2.Tooltip = function (_ref24) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Tooltip, _extends({
              label: title
            }, props), children);
          };
          _this2.Pagination = function (_ref25) {
            ...
            return /*#__PURE__*/React.createElement(chakra.HStack, _extends({
              spacing: 2,
              justifyContent: "center"
            }, props), /*#__PURE__*/React.createElement(chakra.Button, {
              size: "sm",
              onClick: function onClick() {
                return onChange === null || onChange === void 0 ? void 0 : onChange(current - 1, pageSize);
              },
              isDisabled: current === 1
            }, "Previous"), /*#__PURE__*/React.createElement(chakra.Text, null, "Page ", current, " of ", totalPages), /*#__PURE__*/React.createElement(chakra.Button, {
              size: "sm",
              onClick: function onClick() {
                return onChange === null || onChange === void 0 ? void 0 : onChange(current + 1, pageSize);
              },
          ...
          _this2.Spin = function (_ref26) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Box, _extends({
              position: "relative"
            }, props), /*#__PURE__*/React.createElement(chakra.Center, {
              position: "absolute",
              top: 0,
              left: 0,
              right: 0,
              ...
              bg: "whiteAlpha.800",
              zIndex: 1
            }, /*#__PURE__*/React.createElement(chakra.Spinner, {
              size: "lg",
              color: "blue.500"
            })), /*#__PURE__*/React.createElement(chakra.Box, {
          ...
          _this2.Empty = function (_ref27) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Box, _extends({
              ...
              py: 8,
              color: "gray.500"
            }, props), /*#__PURE__*/React.createElement(chakra.Text, {
              fontSize: "3xl",
              mb: 2
            }, "\uD83D\uDCED"), /*#__PURE__*/React.createElement(chakra.Text, null, description));
          };
          _this2.Tag = function (_ref28) {
            ...
            return /*#__PURE__*/React.createElement(chakra.Tag, _extends({
              colorScheme: color,
              size: "md"
            }, props), /*#__PURE__*/React.createElement(chakra.TagLabel, null, children), closable && /*#__PURE__*/React.createElement(chakra.TagCloseButton, {
              onClick: onClose
            }));
          };
          _this2.Badge = function (_ref29) {
            ...
            }, props), children, (count > 0 || dot) && /*#__PURE__*/React.createElement(chakra.Badge, {
              position: "absolute",
              top: "-2",
              right: "-2",
              colorScheme: "red",
...
var Pagination$1 = function Pagination(_ref) {
  ...
  }, (current - 1) * pageSize + 1), " to", ' ', /*#__PURE__*/React.createElement("span", {
    className: "font-medium"
  }, Math.min(current * pageSize, total)), " of", ' ', /*#__PURE__*/React.createElement("span", {
    className: "font-medium"
  }, total), " results")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("nav", {
...
var TailwindUIAdapter = function TailwindUIAdapter() {
  ...
  this.Input = function (_ref3) {
    ...
    return /*#__PURE__*/React.createElement("div", null, label && /*#__PURE__*/React.createElement(_this.Label, {
      htmlFor: id,
      required: required
    }, label), /*#__PURE__*/React.createElement("div", {
    ...
    }, props))), error && /*#__PURE__*/React.createElement(_this.ErrorMessage, null, error));
  };
  ...
  this.Password = function (_ref5) {
    ...
    return /*#__PURE__*/React.createElement(_this.Input, _extends({
      type: "password",
      value: value,
      onChange: onChange,
      placeholder: placeholder,
  ...
  this.Select = function (_ref7) {
    ...
    return /*#__PURE__*/React.createElement("div", null, label && /*#__PURE__*/React.createElement(_this.Label, {
      required: required
    }, label), /*#__PURE__*/React.createElement(Listbox, {
      value: value,
      onChange: onChange,
      disabled: disabled
    }, /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement(Listbox.Option, {
        ...
        return /*#__PURE__*/React.createElement(Fragment$1, null, /*#__PURE__*/React.createElement("span", {
    ...
    }))))), error && /*#__PURE__*/React.createElement(_this.ErrorMessage, null, error));
  };
  ...
  this.Switch = function (_ref1) {
    ...
    return /*#__PURE__*/React.createElement(Switch$4.Group, {
      as: "div",
      className: "flex items-center"
    }, /*#__PURE__*/React.createElement(Switch$4, {
      checked: checked || false,
      onChange: onChange,
      disabled: disabled,
    ...
    })), (label || children) && /*#__PURE__*/React.createElement(Switch$4.Label, {
      as: "span",
  ...
  this.RadioGroup = function (_ref10) {
    var value = _ref10.value,
      ...
      label = _ref10.label;
    return /*#__PURE__*/React.createElement("fieldset", null, label && /*#__PURE__*/React.createElement("legend", {
  ...
  this.Autocomplete = function (_ref15) {
    ...
    return /*#__PURE__*/React.createElement(_this.Select, _extends({
      value: value,
      onChange: onChange,
      options: options,
      label: label,
  ...
  this.Alert = function (_ref20) {
    ...
    var icons = {
      ...
      warning: /*#__PURE__*/React.createElement(ExclamationTriangleIcon, {
        className: "h-5 w-5"
      }),
      error: /*#__PURE__*/React.createElement(XCircleIcon, {
        className: "h-5 w-5"
      })
    };
    var colorClasses = {
    ...
    }, message || children)), closable && /*#__PURE__*/React.createElement("div", {
  ...
  this.Drawer = function (_ref25) {
    ...
    return /*#__PURE__*/React.createElement(Transition, {
      show: open,
      as: Fragment$1
    }, /*#__PURE__*/React.createElement(Dialog$2, {
      as: "div",
    ...
    }, /*#__PURE__*/React.createElement(Dialog$2.Panel, {
    ...
    }, /*#__PURE__*/React.createElement(Dialog$2.Title, {
  ...
  this.Button = function (_ref26) {
    ...
    }, props), loading && /*#__PURE__*/React.createElement(_this.Spin, {
      size: "small"
    }), !loading && children);
  };
  this.Dropdown = Menu$1;
  ...
  this.Table = function (_ref28) {
    ...
    }, /*#__PURE__*/React.createElement("tr", null, columns.map(function (col, idx) {
...
export { Action, ActionCore, ActionFormCore, ActionMobileRenderer, ActionModalCore, ActionWizardCore, And, AntdAdapter, AntdMobileAdapter, AuthProvider, AuthService, CREATE, CREATEP, index$4 as CRUD, ChakraUIAdapter, ClipboardContext, Collection, CollectionMobileRenderer, ContextFiltersToQueryFilters, DELETE, DELETEP, index as ErrorHandling, FennecError, Field, FieldMobileRenderer, FilterToQueryParameters, FormObserverContext, GET, GETP, GETWITH, GETWITHP, GetMeta, GetMetaProperties, GetMetaPropertyByPath, HasRole, HasRoleID, If, IfElse, JSX, JSXIndex, JSXMap, JSXPathMap, LOCATOR_ACTIONS, LOCATOR_TYPES, MaterialUIAdapter, index$2 as Meta, MetaColumns, MetaContext, MetaProvider, Model, ModelMobileRenderer, ObjectToContextFilters, ObjectToQueryParam, Or, Overlay, POST, POSTFormData, POSTFormDataP, POSTP, index$5 as PubSub, index$3 as Query, QueryDetail, QueryFiltersToContextFilters, QueryFunc, QueryOrder, QueryParam, QueryParametersToFilters, QueryParams, READ, READP, READWITH, READWITHP, Request, RequireAuth, index$7 as Roles, SetMetaProperties, TailwindUIAdapter, TranslateContext, TranslateProvider, UIAdapter, UIProvider, UPDATE, UPDATEP, UserConfigContext, UserConfigProvider, UserContext, index$6 as UtilsCore, index$1 as Validation, arrayUnpack, clean, contextFilterToObject, contextFilterToQueryFilters, createArrayInArray, createInArray, deleteArrayInArray, deleteInArray, deleteInProperties, deleteInPropertiesUUID, deletePropertiesInProperties, detectMutation, emptyInArray, _equals as equals, errorAlert, errorCatch, eventExecution, filterByItem, foreachInProperties, formItemRules, getAILocator, getDisplay, getFieldDisplay, getFormatFieldValueTableView, getLocator, getObjectDisplay, getObjectValue, getObjectValueOrDefault, getSortingDisplayFields, isRequired, makeFormData, messageError, metaGetCloneObject, metaGetFieldByName, preventDefault, priceFormat, publish, pushStateHistoryModal, queryFilterByItem, _queryFiltersToContextFilter as queryFiltersToContextFilter, subscribe, triggerArrayInArray, triggerInArray, triggerInProperties, triggerInPropertiesUUID, triggerPropertiesInProperties, typeIsNumber, uncapitalize, undefinedInArray, unpackFormFields, unsubscribe, _unwrap as unwrap, updateArrayInArray, updateInArray, updateInProperties, updateInPropertiesUUID, updatePropertiesInProperties, upgradeInArray, useActionRef, useAuth, useClipboardContext, useCollectionRef, useFormObserverContext, useMetaContext, useNavigation, useTranslateContext, useUI, useUIOptional, useUserConfigContext, useUserContext, validator, ycStorage };
