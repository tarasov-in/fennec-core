...
import { errorCatch as errorCatch$1 } from 'fennec-core/core/error';
import { READWITH as READWITH$1, POST as POST$1 } from 'fennec-core/core/crud';
import { QueryDetail as QueryDetail$1 } from 'fennec-core/core/utils';
import { QueryDetail as QueryDetail$2 } from 'fennec-core/core/query';
...
function UserConfigProvider(_ref) {
  ...
  useEffect(function () {
    if (!auth.loggedIn()) return;
    READWITH$1(auth, 'UserConfig', [QueryDetail$1("model")], function (_ref4) {
      var data = _ref4.data;
      if (data.length > 0) {
...
function TranslateProvider(_ref) {
  ...
  useEffect(function () {
    READWITH$1(auth, 'Translate', [QueryDetail$2("model")], function (_ref2) {
      var data = _ref2.data;
      if (data.length > 0) {
