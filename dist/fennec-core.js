...
!function(o,e){module.exports=e();}(commonjsGlobal,(function(){return function(o,e,t){e.prototype.isTomorrow=function(){var o="YYYY-MM-DD",e=t().add(1,"day");return this.format(o)===e.format(o)};}}));
});
...
var CurrentForm = function CurrentForm(props) {
  ...
  var _ref = FormComponent ? FormComponent.useForm() : [null],
    frm = _ref[0];
  var item = React__default.useMemo(function () {
    return steps[current];
  }, [steps, current]);
  var F = React__default.useMemo(function () {
    return item.form;
  }, [item]);
  React.useEffect(function () {
    if (setSubmit) {
  ...
  var newData = React__default.useMemo(function () {
    return _extends({}, item.object, object[steps[current].key]);
  }, [item, object, steps, current]);
  var cstep = React__default.useMemo(function () {
    return item.steps || steps;
  }, [item, steps]);
  var csubheader = React__default.useMemo(function () {
...
function ActionWithFormInstance(_ref3) {
  ...
  return /*#__PURE__*/React__default.createElement(ActionContent, _extends({
    formInstance: form,
    ui: ui
  }, props));
}
function Action(props) {
  ...
  if ((props.steps || props.form) && ui !== null && ui !== void 0 && ui.Form && ui.createFormInstance) {
    return /*#__PURE__*/React__default.createElement(ActionWithFormInstance, _extends({
      ui: ui
    }, props));
  }
  return /*#__PURE__*/React__default.createElement(ActionContent, _extends({
...
function ActionContent(incomingProps) {
  ...
  var isChangedField = React__default.useCallback(function (name) {
    return lodash.get(values, name) !== lodash.get(object, name);
  }, [values, object]);
  var isChangedForm = React__default.useMemo(function () {
    var f = false;
    for (var key in values) {
  ...
  var onValuesChange = React__default.useCallback(function (changed, all) {
    setValues(all);
  }, [values, setValues]);
  var _useState2 = React.useState(false),
  ...
  var stack = [];
  var getStack = React.useCallback(function () {
    return stack;
  }, []);
  React.useEffect(function () {
    if (uuid) {
  ...
  var submitCache = React__default.useMemo(function () {
    return {};
  }, []);
  var execStep = React__default.useCallback(function (current) {
  ...
  var lock = React__default.useCallback(function () {
    setLoading(true);
  }, []);
  var unlock = React__default.useCallback(function () {
    setLoading(false);
  }, []);
  ...
  var action = React__default.useCallback(function (_values) {
  ...
  var click = React__default.useCallback(function (e) {
  ...
  var next = React__default.useCallback(function (values, item, currentStep) {
  ...
  var FooterOkButtons = React.useCallback(function () {
    if (steps) {
  ...
  var footer = React__default.useCallback(function () {
    var ctx = {
  ...
  var trigger = React__default.useCallback(function () {
    return props.trigger ? props.trigger(click) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null);
  ...
  var FormRenderer = React__default.useCallback(function () {
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, steps && (ui === null || ui === void 0 ? void 0 : ui.Form) && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(CurrentForm, {
      Form: ui.Form,
    ...
    })), !steps && props.form && /*#__PURE__*/React__default.createElement(ContentForm, _extends({}, props, {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, content && content());
}
...
function CollectionByProperty(props) {
  ...
  var uif = React.useMemo(function () {
  ...
  var queryFilter = React.useMemo(function () {
  ...
  var display = React.useCallback(function (item, value) {
    if (item && value) {
...
function Frm(props) {
  ...
  var getFormFields = React.useCallback(function () {
  ...
  var getFieldFormItemProps = React.useCallback(function (item) {
    return {
  ...
  var getFieldProps = React.useCallback(function (item) {
  ...
  var getFuncRenderArgs = React.useCallback(function (item, idx) {
    return {
      auth: auth,
      item: item,
      context: {
  ...
  var getCollectionTabProps = React.useCallback(function (e, idx) {
    return {
      auth: auth,
      item: e,
      object: object,
  ...
  var getObjectDisplayValue = React.useCallback(function () {
  ...
  var getLocatorForModel = React.useCallback(function (l, o) {
...
function Model(props) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, props !== null && props !== void 0 && props.subheader ? props === null || props === void 0 ? void 0 : props.subheader : null, /*#__PURE__*/React__default.createElement(Frm, {
    auth: auth,
    form: form,
    links: links,
    contextObject: contextObject,
...
function SortingFieldsUI(props) {
  ...
  if (isDesktopOrLaptop && ui !== null && ui !== void 0 && ui.Divider && ui !== null && ui !== void 0 && ui.Select && ui !== null && ui !== void 0 && ui.Button && ui !== null && ui !== void 0 && ui.Tooltip && ui !== null && ui !== void 0 && ui.Icons) {
    ...
    var sortingOrder = React__default.useCallback(function () {
      if (value.order === "ASC") {
        _onChange({
          name: value.name,
          order: "DESC"
    ...
    var onSortingChangeString = React__default.useCallback(function (v) {
      _onChange({
        name: v,
        order: value.order
      });
    }, [value]);
    var onOk = React__default.useCallback(function (v) {
      if (v.length) {
    ...
    var _useState = React.useState(false),
      visible = _useState[0],
      setVisible = _useState[1];
    var current = React__default.useMemo(function () {
      var _s$find;
    ...
    }, "\u0421\u043E\u0440\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u043F\u043E"), /*#__PURE__*/React__default.createElement("div", {
      style: {
        paddingBottom: "10px",
        display: "flex",
        gap: "5px"
...
function FilterContent(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, isDesktopOrLaptop && showFilterButtons && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
    ...
    disabled: lodash.isEmpty(state.filter),
    onClick: clearFilter
  }, "\u041E\u0447\u0438\u0441\u0442\u0438\u0442\u044C")), /*#__PURE__*/React__default.createElement("div", {
    style: {
      flex: "1 1 auto"
    }
  }, ButtonComp ? /*#__PURE__*/React__default.createElement(ButtonComp, {
...
function Collection(props) {
  ...
  var _useState1 = React.useState(defSorting(props.filters ? fltrs : [])),
    sorting = _useState1[0],
    setSorting = _useState1[1];
  var _useState10 = React.useState(props.page ? parseInt(props.page()) || 1 : 1),
    current = _useState10[0],
    _setCurrent = _useState10[1];
  var _useState11 = React.useState(props.count ? parseInt(props.count()) || 20 : 20),
    count = _useState11[0],
  ...
  var setCollection = React__default.useCallback(function (array) {
    if (onSetCollection) {
  ...
  var setCollectionItem = React__default.useCallback(function (item) {
    setCollection(updateInArray(collection, item));
  }, [collection]);
  var removeCollectionItem = React__default.useCallback(function (item) {
    setCollection(deleteInArray(collection, item));
  }, [collection]);
  var clearFilter = React__default.useCallback(function () {
  ...
  var applyFilter = React__default.useMemo(function () {
    return function () {
  ...
  var _request = React__default.useMemo(function () {
  ...
  var update = React__default.useCallback(function () {
    _request(state.filter);
  }, [_request, state.filter]);
  React.useEffect(function () {
    _request(state.filter);
  }, [source, name, state.filter, filters, sorting, current, contextFilters]);
  var _useState14 = React.useState(selection || 'checkbox'),
  ...
  var defaultModelAction = React__default.useCallback(function (item) {
    return !name ? [] : [{
      key: "update",
      title: "Изменить",
      action: {
  ...
  var RenderOnCollectionActions = React__default.useCallback(function () {
    var defaultAction = defaultCollectionAction();
    if (!_collectionActions) return /*#__PURE__*/React__default.createElement(React__default.Fragment, null);
    ...
    if (!values || !values.length) return /*#__PURE__*/React__default.createElement(React__default.Fragment, null);
...
exports.CollectionByProperty = CollectionByProperty;
...
exports.SortingFieldsUI = SortingFieldsUI;
...
exports.clean = clean;
exports.collectionQueryParams = collectionQueryParams;
