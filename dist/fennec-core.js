...
function Collection(props) {
  ...
  var _useState0 = React.useState(defSorting(props.filters ? fltrs : [])),
    sorting = _useState0[0],
    setSorting = _useState0[1];
  var _useState1 = React.useState(props.page ? parseInt(props.page()) || 1 : 1),
    current = _useState1[0],
    _setCurrent = _useState1[1];
  var _useState10 = React.useState(props.count ? parseInt(props.count()) || 20 : 20),
    count = _useState10[0],
  ...
  var _useState13 = React.useState(selection || 'checkbox'),
