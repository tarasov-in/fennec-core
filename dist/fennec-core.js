...
var _unwrap = function unwrap(value, element) {
  if (_$1.isFunction(value) == true) {
    return _unwrap(value());
  } else if (_$1.isArray(value)) {
    return value;
  }
...
var QueryParams = function QueryParams(queryParams) {
  ...
  if (queryParams) {
    for (var i = 0; i < queryParams.length; i++) {
      ...
      if (_$1.isString(param)) {
        ext += !ext ? param : '&' + param;
      } else if (_$1.isFunction(param)) {
        ext += !ext ? param() : '&' + param();
      }
    }
  }
...
var contextFilterToObject = function contextFilterToObject(contextFilters) {
  ...
  if (contextFilters) {
    var ctx = [];
    if (_$1.isFunction(contextFilters)) {
...
var contextFilterToQueryFilters = function contextFilterToQueryFilters(item) {
  ...
  } else if (_$1.isFunction(item)) {
    return item();
  } else if (_$1.isString(item)) {
    return item;
  }
};
...
var _queryFiltersToContextFilter = function queryFiltersToContextFilter(item) {
  if (_$1.isObject(item) && item !== null && item !== void 0 && item.name) {
    return item;
  } else if (_$1.isFunction(item)) {
...
var QueryFiltersToContextFilters = function QueryFiltersToContextFilters(queryFilters) {
  ...
  if (queryFilters) {
    var ctx = [];
    if (_$1.isFunction(queryFilters)) {
    ...
    switch (item.filterType) {
      ...
      case "range":
        switch (item.type) {
          ...
          case "uint64":
          case "uint32":
            if (_$1.isArray(filterByKey) && filterByKey.length >= 2) {
...
var errorCatch = function errorCatch(err, callback) {
  if (err) {
    try {
      var _require = require('../core/error'),
        getNotifier = _require.getNotifier;
...
var detectMutation = function detectMutation(mutation) {
  if (_$1.isFunction(mutation)) {
    return mutation;
  } else if (_$1.isString(mutation)) {
    switch (mutation) {
      case "upgrade":
...
function GetMetaPropertyByPath(meta, obj, path) {
  ...
  if (array && array.length > 1) {
    var _loop3 = function _loop3() {
        ...
        var nobj = _$1.get(property, "relation.reference.object");
        var type = _$1.get(property, "relation.type");
        if (nobj) {
          var mnobj = meta[nobj];
          if (mnobj) {
            return {
...
function SetMetaProperties(meta, properties) {
  return meta && _$1.isArray(meta) ? properties : _extends({}, meta, {
...
var updateInPropertiesUUID = function updateInPropertiesUUID(properties, item, first) {
  ...
  if (_$1.findIndex(properties, (_$findIndex = {}, _$findIndex[key] = item[key], _$findIndex)) >= 0) {
    var _properties;
...
var updateInProperties = function updateInProperties(properties, item, first) {
  ...
  if (!properties) properties = [];
  if (!item || !item[key]) return properties;
  if (_$1.findIndex(properties, (_$findIndex2 = {}, _$findIndex2[key] = item[key], _$findIndex2)) >= 0) {
    var _properties2;
...
function metaGetCloneObject(objectName, meta) {
  return _$1.cloneDeep(meta[objectName]);
}
...
function formItemRules(item) {
  var res = [];
  if (item && item.validators) {
    if (_$1.isArray(item.validators)) {
    ...
    } else if (_$1.isObject(item.validators)) {
    ...
    if (lodash.isArray(item.validators)) {
      ...
      if ((item === null || item === void 0 ? void 0 : (_item$validators1 = item.validators) === null || _item$validators1 === void 0 ? void 0 : _item$validators1.min) !== undefined && (item === null || item === void 0 ? void 0 : (_item$validators10 = item.validators) === null || _item$validators10 === void 0 ? void 0 : _item$validators10.min) !== null) {
        ...
        res.push({
          type: (item === null || item === void 0 ? void 0 : item.type) == "string" || (item === null || item === void 0 ? void 0 : item.type) == "text" ? "string" : "number",
          min: item === null || item === void 0 ? void 0 : (_item$validators11 = item.validators) === null || _item$validators11 === void 0 ? void 0 : _item$validators11.min,
          message: "\u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u0434\u043E\u043B\u0436\u043D\u043E \u0431\u044B\u0442\u044C \u043D\u0435 \u043C\u0435\u043D\u044C\u0448\u0435 " + (item === null || item === void 0 ? void 0 : (_item$validators12 = item.validators) === null || _item$validators12 === void 0 ? void 0 : _item$validators12.min) + ((item === null || item === void 0 ? void 0 : item.type) == "string" ? " символов" : "") + "!"
        });
      }
      if (item !== null && item !== void 0 && (_item$validators13 = item.validators) !== null && _item$validators13 !== void 0 && _item$validators13.pattern) {
        var _item$validators14, _item$validators15;
...
var FieldCore = /*#__PURE__*/function () {
  ...
  var _proto = FieldCore.prototype;
  _proto.getFieldType = function getFieldType() {
    var _this$meta;
  ...
  _proto.formatValue = function formatValue(value) {
    ...
    switch (type) {
      ...
      case 'date':
      case 'localdate':
        if (dayjs_min.isDayjs(value)) return value;
        if (!value) return null;
        return dayjs_min(value);
      case 'time':
      case 'localtime':
        if (dayjs_min.isDayjs(value)) return value;
        if (!value) return null;
        if (typeof value === 'string' && value.length <= 8) {
          return dayjs_min(value, 'HH:mm:ss');
        }
        return dayjs_min(value);
      case 'datetime':
      case 'timestamp':
  ...
  _proto.getComponentProps = function getComponentProps() {
    var type = this.getFieldType();
  ...
  _proto.handleChange = function handleChange(value) {
    ...
    (_this$props$onChange = (_this$props = this.props).onChange) === null || _this$props$onChange === void 0 ? void 0 : _this$props$onChange.call(_this$props, parsed);
  };
  _proto.isDisabled = function isDisabled() {
    var _this$meta2;
    return this.props.disabled || ((_this$meta2 = this.meta) === null || _this$meta2 === void 0 ? void 0 : _this$meta2.disabled) || false;
  };
  _proto.isReadOnly = function isReadOnly() {
    var _this$meta3;
    return this.props.readOnly || ((_this$meta3 = this.meta) === null || _this$meta3 === void 0 ? void 0 : _this$meta3.readOnly) || false;
  };
  _proto.getPlaceholder = function getPlaceholder() {
    var _this$meta4, _this$meta5;
    if (this.props.placeholder) {
      return this.props.placeholder;
    }
    if ((_this$meta4 = this.meta) !== null && _this$meta4 !== void 0 && _this$meta4.placeholder) {
      return this.meta.placeholder;
    }
    var label = ((_this$meta5 = this.meta) === null || _this$meta5 === void 0 ? void 0 : _this$meta5.label) || '';
    var type = this.getFieldType();
    switch (type) {
      case 'integer':
      case 'int':
  ...
  _proto.getTypeSpecificProps = function getTypeSpecificProps(type) {
    var _this$meta6, _this$meta6$validator, _this$meta7, _this$meta7$validator, _this$meta8, _this$meta8$validator, _this$meta9, _this$meta9$validator, _this$meta0, _this$meta1, _this$meta10, _this$meta11, _this$meta12, _this$meta13, _this$meta14, _this$meta15, _this$meta16, _this$meta17, _this$meta18, _this$meta19, _this$meta20, _this$meta21, _this$meta22, _this$meta23, _this$meta24, _this$meta25, _this$meta26, _this$meta27, _this$meta28, _this$meta29, _this$meta30, _this$meta31, _this$meta32;
    switch (type) {
      case 'integer':
      case 'int':
      case 'long':
        return {
          min: (_this$meta6 = this.meta) === null || _this$meta6 === void 0 ? void 0 : (_this$meta6$validator = _this$meta6.validators) === null || _this$meta6$validator === void 0 ? void 0 : _this$meta6$validator.min,
          max: (_this$meta7 = this.meta) === null || _this$meta7 === void 0 ? void 0 : (_this$meta7$validator = _this$meta7.validators) === null || _this$meta7$validator === void 0 ? void 0 : _this$meta7$validator.max,
          precision: 0,
          step: 1,
          style: {
            width: '100%'
      ...
      case 'bigdecimal':
        return {
          min: (_this$meta8 = this.meta) === null || _this$meta8 === void 0 ? void 0 : (_this$meta8$validator = _this$meta8.validators) === null || _this$meta8$validator === void 0 ? void 0 : _this$meta8$validator.min,
          max: (_this$meta9 = this.meta) === null || _this$meta9 === void 0 ? void 0 : (_this$meta9$validator = _this$meta9.validators) === null || _this$meta9$validator === void 0 ? void 0 : _this$meta9$validator.max,
          precision: 2,
          step: 0.01,
          style: {
            width: '100%'
      ...
      case 'localdate':
        return {
          format: ((_this$meta0 = this.meta) === null || _this$meta0 === void 0 ? void 0 : _this$meta0.format) || 'DD.MM.YYYY',
          style: {
            width: '100%'
          }
        };
      ...
      case 'localtime':
        return {
          format: ((_this$meta1 = this.meta) === null || _this$meta1 === void 0 ? void 0 : _this$meta1.format) || 'HH:mm:ss',
          style: {
            width: '100%'
          }
        };
      ...
      case 'localdatetime':
        return {
          format: ((_this$meta10 = this.meta) === null || _this$meta10 === void 0 ? void 0 : _this$meta10.format) || 'DD.MM.YYYY HH:mm:ss',
          showTime: true,
          style: {
            width: '100%'
          }
      ...
      case 'select':
        return {
          ...
          showSearch: ((_this$meta11 = this.meta) === null || _this$meta11 === void 0 ? void 0 : _this$meta11.searchable) !== false,
      ...
      case 'multiselect':
        return {
          options: this.getOptions(),
          mode: 'multiple',
          showSearch: ((_this$meta12 = this.meta) === null || _this$meta12 === void 0 ? void 0 : _this$meta12.searchable) !== false,
          allowClear: !this.isRequired(),
          style: {
            width: '100%'
          }
      ...
      case 'checkbox':
        return {
          checked: this.formatValue(this.props.value),
          children: ((_this$meta13 = this.meta) === null || _this$meta13 === void 0 ? void 0 : _this$meta13.checkboxLabel) || ((_this$meta14 = this.meta) === null || _this$meta14 === void 0 ? void 0 : _this$meta14.label)
        };
      case 'file':
        return {
          accept: (_this$meta15 = this.meta) === null || _this$meta15 === void 0 ? void 0 : _this$meta15.accept,
          maxCount: 1,
          maxSize: (_this$meta16 = this.meta) === null || _this$meta16 === void 0 ? void 0 : _this$meta16.maxSize,
          listType: 'text'
        };
      case 'files':
        return {
          accept: (_this$meta17 = this.meta) === null || _this$meta17 === void 0 ? void 0 : _this$meta17.accept,
          multiple: true,
          maxCount: ((_this$meta18 = this.meta) === null || _this$meta18 === void 0 ? void 0 : _this$meta18.maxCount) || 10,
          maxSize: (_this$meta19 = this.meta) === null || _this$meta19 === void 0 ? void 0 : _this$meta19.maxSize,
          listType: 'text'
        };
      case 'image':
        return {
          accept: ((_this$meta20 = this.meta) === null || _this$meta20 === void 0 ? void 0 : _this$meta20.accept) || 'image/*',
          maxCount: (_this$meta21 = this.meta) !== null && _this$meta21 !== void 0 && _this$meta21.multiple ? ((_this$meta22 = this.meta) === null || _this$meta22 === void 0 ? void 0 : _this$meta22.maxCount) || 10 : 1,
          multiple: ((_this$meta23 = this.meta) === null || _this$meta23 === void 0 ? void 0 : _this$meta23.multiple) || false,
          maxSize: (_this$meta24 = this.meta) === null || _this$meta24 === void 0 ? void 0 : _this$meta24.maxSize,
          listType: 'picture-card'
        };
      case 'rate':
        return {
          count: ((_this$meta25 = this.meta) === null || _this$meta25 === void 0 ? void 0 : _this$meta25.count) || 5,
          allowHalf: ((_this$meta26 = this.meta) === null || _this$meta26 === void 0 ? void 0 : _this$meta26.allowHalf) || false
        };
      case 'color':
        return {
          showText: ((_this$meta27 = this.meta) === null || _this$meta27 === void 0 ? void 0 : _this$meta27.showText) || false
        };
      case 'slider':
        return {
          min: ((_this$meta28 = this.meta) === null || _this$meta28 === void 0 ? void 0 : _this$meta28.min) || 0,
          max: ((_this$meta29 = this.meta) === null || _this$meta29 === void 0 ? void 0 : _this$meta29.max) || 100,
          step: ((_this$meta30 = this.meta) === null || _this$meta30 === void 0 ? void 0 : _this$meta30.step) || 1,
          marks: (_this$meta31 = this.meta) === null || _this$meta31 === void 0 ? void 0 : _this$meta31.marks,
          style: {
            width: '100%'
          }
        };
      case 'json':
        return {
          rows: ((_this$meta32 = this.meta) === null || _this$meta32 === void 0 ? void 0 : _this$meta32.rows) || 6,
          autoSize: {
            minRows: 4,
            maxRows: 20
          }
  ...
  _proto.getOptions = function getOptions() {
    var _this$meta33, _this$meta34, _this$meta35;
    if ((_this$meta33 = this.meta) !== null && _this$meta33 !== void 0 && _this$meta33.options) {
      return this.meta.options;
    }
    if ((_this$meta34 = this.meta) !== null && _this$meta34 !== void 0 && _this$meta34["enum"]) {
      return this.meta["enum"].map(function (value) {
        return {
          label: value,
          value: value
        };
    ...
    if ((_this$meta35 = this.meta) !== null && _this$meta35 !== void 0 && _this$meta35.choices) {
      return this.meta.choices.map(function (choice) {
        return {
  ...
  _proto.getLabel = function getLabel() {
    var _this$meta36;
    return this.props.label || ((_this$meta36 = this.meta) === null || _this$meta36 === void 0 ? void 0 : _this$meta36.label) || '';
  };
  _proto.getHelp = function getHelp() {
    var _this$meta37;
    return this.props.help || ((_this$meta37 = this.meta) === null || _this$meta37 === void 0 ? void 0 : _this$meta37.help) || '';
  };
  _proto.getTooltip = function getTooltip() {
    var _this$meta38;
    return this.props.tooltip || ((_this$meta38 = this.meta) === null || _this$meta38 === void 0 ? void 0 : _this$meta38.tooltip) || '';
  };
  return FieldCore;
}();

var UIContext = React.createContext(null);
function UIProvider(_ref) {
  var children = _ref.children,
    adapter = _ref.adapter;
  var memoizedAdapter = React.useMemo(function () {
    return adapter;
  }, [adapter]);
  return /*#__PURE__*/React__default.createElement(UIContext.Provider, {
...
function useUIOptional() {
  return React.useContext(UIContext);
}

function getUIComponentForType(type, adapter) {
  var _adapter$Input, _adapter$Input2, _adapter$Radio;
  switch (type) {
    case 'string':
    case 'email':
    case 'url':
    ...
    case 'password':
      return ((_adapter$Input = adapter.Input) === null || _adapter$Input === void 0 ? void 0 : _adapter$Input.Password) || adapter.Input;
    case 'text':
      return ((_adapter$Input2 = adapter.Input) === null || _adapter$Input2 === void 0 ? void 0 : _adapter$Input2.TextArea) || adapter.TextArea;
    case 'integer':
    case 'int':
    case 'long':
    case 'float':
    ...
    case 'multiselect':
      return adapter.Select;
    case 'radio':
      return ((_adapter$Radio = adapter.Radio) === null || _adapter$Radio === void 0 ? void 0 : _adapter$Radio.Group) || adapter.Radio;
    case 'checkbox':
...
var FieldRenderer = function FieldRenderer(_ref) {
  ...
  var type = fieldCore.getFieldType();
  var componentProps = fieldCore.getComponentProps();
  var label = fieldCore.getLabel();
  var help = fieldCore.getHelp();
  var tooltip = fieldCore.getTooltip();
  var rules = fieldCore.getValidationRules();
  var UIComponent = getUIComponentForType(type, adapter);
  if (!UIComponent) {
    console.warn("FieldRenderer: No UI component found for type \"" + type + "\" in adapter. Using fallback.");
    return /*#__PURE__*/React__default.createElement("div", {
      className: className,
      style: style
    }, /*#__PURE__*/React__default.createElement("input", componentProps));
  }
  var FormItem = ((_adapter$Form = adapter.Form) === null || _adapter$Form === void 0 ? void 0 : _adapter$Form.Item) || adapter.FormItem;
  if (!FormItem) {
    return /*#__PURE__*/React__default.createElement("div", {
      className: className,
      style: style
    }, label && /*#__PURE__*/React__default.createElement("label", null, label), /*#__PURE__*/React__default.createElement(UIComponent, componentProps), help && /*#__PURE__*/React__default.createElement("small", null, help));
  }
  ...
  }, /*#__PURE__*/React__default.createElement(UIComponent, componentProps));
};

function FieldMobileRenderer(props) {
  var fieldCore = props.fieldCore,
  ...
  var ui = useUI();
  var fieldType = React.useMemo(function () {
    return fieldCore.getFieldType();
  }, [fieldCore]);
  var placeholder = React.useMemo(function () {
    return fieldCore.getPlaceholder();
  }, [fieldCore]);
  var label = React.useMemo(function () {
    return fieldCore.getLabel();
  }, [fieldCore]);
  var required = React.useMemo(function () {
    return fieldCore.isRequired();
  }, [fieldCore]);
  var options = React.useMemo(function () {
    var _fieldCore$getSelectO;
    return ((_fieldCore$getSelectO = fieldCore.getSelectOptions) === null || _fieldCore$getSelectO === void 0 ? void 0 : _fieldCore$getSelectO.call(fieldCore)) || [];
  }, [fieldCore]);
  var renderField = function renderField() {
    ...
    if (fieldType === 'number') {
      return /*#__PURE__*/React__default.createElement(ui.InputNumber, {
        value: value,
        onChange: _onChange,
        placeholder: placeholder,
        disabled: disabled,
    ...
    if (fieldType === 'date') {
      var _fieldCore$parseDate;
      return ui.renderDatePicker({
        value: (_fieldCore$parseDate = fieldCore.parseDate) === null || _fieldCore$parseDate === void 0 ? void 0 : _fieldCore$parseDate.call(fieldCore, value),
        onChange: function onChange(date) {
          var _fieldCore$formatDate;
          return _onChange(((_fieldCore$formatDate = fieldCore.formatDate) === null || _fieldCore$formatDate === void 0 ? void 0 : _fieldCore$formatDate.call(fieldCore, date)) || date);
        },
        disabled: disabled,
        readOnly: readonly
      });
    ...
    if (fieldType === 'time') {
      var _fieldCore$parseTime;
      return /*#__PURE__*/React__default.createElement(ui.TimePicker, {
        value: (_fieldCore$parseTime = fieldCore.parseTime) === null || _fieldCore$parseTime === void 0 ? void 0 : _fieldCore$parseTime.call(fieldCore, value),
        onChange: function onChange(time) {
          var _fieldCore$formatTime;
          return _onChange(((_fieldCore$formatTime = fieldCore.formatTime) === null || _fieldCore$formatTime === void 0 ? void 0 : _fieldCore$formatTime.call(fieldCore, time)) || time);
        },
        disabled: disabled,
        readOnly: readonly
      });
    ...
    if (fieldType === 'datetime') {
      var _fieldCore$parseDateT;
      return ui.renderDatePicker({
        value: (_fieldCore$parseDateT = fieldCore.parseDateTime) === null || _fieldCore$parseDateT === void 0 ? void 0 : _fieldCore$parseDateT.call(fieldCore, value),
        onChange: function onChange(dateTime) {
          var _fieldCore$formatDate2;
          return _onChange(((_fieldCore$formatDate2 = fieldCore.formatDateTime) === null || _fieldCore$formatDate2 === void 0 ? void 0 : _fieldCore$formatDate2.call(fieldCore, dateTime)) || dateTime);
        },
        disabled: disabled,
        readOnly: readonly,
        showTime: true
    ...
    if (fieldType === 'checkbox') {
      return /*#__PURE__*/React__default.createElement(ui.Checkbox, {
        checked: value,
        onChange: function onChange(e) {
    ...
    if (fieldType === 'radio') {
      return /*#__PURE__*/React__default.createElement(ui.Radio.Group, {
        value: value,
        onChange: function onChange(e) {
          return _onChange(e.target.value);
        },
        ...
        return /*#__PURE__*/React__default.createElement(ui.Radio, {
          key: opt.value,
          value: opt.value
        }, opt.label);
      }));
    ...
    if (fieldType === 'switch') {
      return /*#__PURE__*/React__default.createElement(ui.Switch, {
        checked: value,
    ...
    if (fieldType === 'slider') {
      return /*#__PURE__*/React__default.createElement(ui.Slider, {
        value: value,
        onChange: _onChange,
        disabled: disabled,
        min: item.min || 0,
    ...
    if (fieldType === 'rate') {
      return /*#__PURE__*/React__default.createElement(ui.Rate, {
        value: value,
        onChange: _onChange,
        disabled: disabled,
        count: item.count || 5
    ...
    if (fieldType === 'file' || fieldType === 'image') {
      return /*#__PURE__*/React__default.createElement(ui.Upload, {
        fileList: value || [],
        onChange: function onChange(info) {
          return _onChange(info.fileList);
        },
        disabled: disabled,
    ...
    if (fieldType === 'tag') {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
        className: "fennec-mobile-tag-field"
      }, tags.map(function (tag, index) {
        return /*#__PURE__*/React__default.createElement(ui.Tag, {
          key: index,
      ...
      }), !disabled && !readonly && /*#__PURE__*/React__default.createElement(ui.SearchBar, {
        placeholder: "Add tag",
        onSearch: function onSearch(val) {
          if (val) {
            _onChange([].concat(tags, [val]));
          }
        }
      }));
    }
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: "fennec-field-mobile"
  }, label && /*#__PURE__*/React__default.createElement("div", {
    className: "fennec-field-mobile-label"
  }, label, required && /*#__PURE__*/React__default.createElement("span", {
    className: "fennec-required"
  }, "*")), /*#__PURE__*/React__default.createElement("div", {
    className: "fennec-field-mobile-control"
  }, renderField()));
}
...
function metaGetFieldByName$1(metaObject, meta, fieldName) {
  ...
  if (!lodash.get(metaObject, "properties.length") || !fieldName) {
    return;
  }
  if (typeof fieldName === "string") {
    fieldName = fieldName.split(".");
    ...
    return properties === null || properties === void 0 ? void 0 : properties.map(function (item, idx) {
      if (item.type === "object" || item.type === "document") {
        var _require = require('../../Tool'),
          getObjectValue = _require.getObjectValue,
          getDisplay = _require.getDisplay,
          uncapitalize = _require.uncapitalize;
        var fieldMeta = meta[getObjectValue(item, "relation.reference.object")];
        var display = function display(_display) {
          if (_display.fields) {
            return _display;
      ...
      var _require2 = require('../../Tool'),
        getFormatFieldValueTableView = _require2.getFormatFieldValueTableView;
      return {
        title: item.label,
        render: function render(text, record, index) {
          return /*#__PURE__*/React__default.createElement("div", {
...
function getAILocator$1(id, value, options) {
  ...
  if (value !== null && value !== undefined) {
    var cleanValue = String(value).replace(/\s+/g, '-').toLowerCase();
...
function getFieldDisplay$1(data, propertyMeta, meta) {
  ...
  if (!propertyMeta || !meta || !data) return undefined;
  var display = function display(_display2) {
    if (_display2 !== null && _display2 !== void 0 && _display2.fields) {
      return _display2;
    }
  };
...
function getDisplay$1(data, display, metaObject, meta) {
  ...
  for (var i = 0; i < display.fields.length; i++) {
    ...
    var _require = require('../meta/helpers'),
      metaGetFieldByName = _require.metaGetFieldByName;
    if (lodash.isObject(value_field)) {
      var _metaGetFieldByName, _metaGetFieldByName$r;
      value_field = getDisplay$1(value_field, (_metaGetFieldByName = metaGetFieldByName(metaObject, meta, name_field)) === null || _metaGetFieldByName === void 0 ? void 0 : (_metaGetFieldByName$r = _metaGetFieldByName.relation) === null || _metaGetFieldByName$r === void 0 ? void 0 : _metaGetFieldByName$r.display, metaObject, meta);
      if (!value_field) {
        var _metaGetFieldByName2, _metaGetFieldByName2$, _metaGetFieldByName2$2, _subMeta;
        var subMeta = meta[(_metaGetFieldByName2 = metaGetFieldByName(metaObject, meta, name_field)) === null || _metaGetFieldByName2 === void 0 ? void 0 : (_metaGetFieldByName2$ = _metaGetFieldByName2.relation) === null || _metaGetFieldByName2$ === void 0 ? void 0 : (_metaGetFieldByName2$2 = _metaGetFieldByName2$.reference) === null || _metaGetFieldByName2$2 === void 0 ? void 0 : _metaGetFieldByName2$2.object];
...
var GETWITH$1 = function GETWITH(auth, url, queryParams, callback, error) {
  var _require = require('../query'),
    QueryParams = _require.QueryParams;
  var ext = QueryParams(queryParams);
...
var GETWITHP$1 = function GETWITHP(auth, url, queryParams) {
  var _require2 = require('../query'),
    QueryParams = _require2.QueryParams;
  var ext = QueryParams(queryParams);
...
var ModelCore = /*#__PURE__*/function () {
  ...
  _proto.getFilteredProperties = function getFilteredProperties() {
    ...
    return properties.filter(function (e) {
      return !e.name || e.name && e.name.toUpperCase() !== 'ID';
    }).filter(function (e) {
      return !e.relation || e.relation && e.relation.type !== 'one-many';
    });
  };
  _proto.getOneToManyRelations = function getOneToManyRelations() {
    var _this$scheme;
    var properties = this.getProperties();
    if (!properties) return [];
    var oneToMany = properties.filter(function (e) {
      return e.relation && e.relation.type === 'one-many';
    });
    if (this.scheme && !this.scheme.length) {
      return [];
    }
    if ((_this$scheme = this.scheme) !== null && _this$scheme !== void 0 && _this$scheme.length) {
      var headScheme = {};
      for (var i = 0; i < this.scheme.length; i++) {
        var element = this.scheme[i].toLowerCase();
        var arr = element.split('.');
        if (arr && arr.length && arr[0]) {
          headScheme[arr[0]] = true;
        }
      }
      var func = this.linksCompareFunction || function (e) {
        return _$3.get(e, 'name');
      };
      oneToMany = oneToMany.filter(function (e) {
        var _func;
  ...
  _proto.getTailScheme = function getTailScheme() {
    var _this$scheme2;
    if (!((_this$scheme2 = this.scheme) !== null && _this$scheme2 !== void 0 && _this$scheme2.length)) return undefined;
    var tailScheme = [];
    for (var i = 0; i < this.scheme.length; i++) {
      var element = this.scheme[i].toLowerCase();
      var arr = element.split('.');
  ...
  _proto.getExcludeFields = function getExcludeFields() {
    if (!this.contextFilters) return {};
    var excludeFields = {};
    if (Array.isArray(this.contextFilters)) {
      this.contextFilters.forEach(function (filter) {
        if (filter.name) {
      ...
      Object.keys(this.contextFilters).forEach(function (key) {
  ...
  _proto.shouldExcludeProperty = function shouldExcludeProperty(property, excludeFields) {
    if (!property.name) return false;
    var lowerName = property.name.toLowerCase();
    return !!(excludeFields[lowerName] || excludeFields[lowerName + 'ID']);
  };
  _proto.getPropertiesForRendering = function getPropertiesForRendering() {
    var _this = this;
    var filtered = this.getFilteredProperties();
    var excludeFields = this.getExcludeFields();
    return filtered.filter(function (property) {
      return !_this.shouldExcludeProperty(property, excludeFields);
    });
  };
  _proto.hasOneToManyRelations = function hasOneToManyRelations() {
    var relations = this.getOneToManyRelations();
    return !!(this.object && this.object.ID && relations && relations.length > 0);
  };
  _proto.getPropertyLabel = function getPropertyLabel(property) {
    if (property.type === 'bool' || property.type === 'boolean') {
      return undefined;
    }
    return property.label;
  };
  _proto.getObjectDisplay = function getObjectDisplay(_getObjectDisplay, gmeta) {
    if (!this.meta.name || !this.object) return '';
    return _getObjectDisplay(this.object, this.meta.name, gmeta);
  };
  _proto.isFunctionalProperty = function isFunctionalProperty(property) {
...
function ModelRenderer(props) {
  var auth = props.auth,
    ...
    relationTabsWrapperStyle = props.relationTabsWrapperStyle,
    relationTabsWrapperClassName = props.relationTabsWrapperClassName,
    headerStyle = props.headerStyle,
    headerClassName = props.headerClassName,
    headerLabelStyle = props.headerLabelStyle,
    headerContentStyle = props.headerContentStyle,
    headerActionsStyle = props.headerActionsStyle,
    headerTagStyle = props.headerTagStyle,
    formWrapperStyle = props.formWrapperStyle,
    formWrapperClassName = props.formWrapperClassName,
  ...
  var modelCore = React__default.useMemo(function () {
  ...
  var properties = modelCore.getProperties();
  var propertiesForRendering = modelCore.getPropertiesForRendering();
  var propertiesOneMany = modelCore.getOneToManyRelations();
  var tailScheme = modelCore.getTailScheme();
  var hasRelations = modelCore.hasOneToManyRelations();
  var initialValues = modelCore.getInitialValues();
  React.useEffect(function () {
    form.resetFields();
    if (object) {
  ...
  var AntForm = adapter.Form;
  var FormItem = adapter.FormItem;
  var Tooltip = adapter.Tooltip;
  var Tag = adapter.Tag;
  var CheckableTag = (Tag === null || Tag === void 0 ? void 0 : Tag.CheckableTag) || Tag;
  var Tabs = adapter.Tabs;
  var TabPane = adapter.TabPane || (Tabs === null || Tabs === void 0 ? void 0 : Tabs.TabPane);
  if (!properties) return null;
  var renderFunctionalField = function renderFunctionalField(property, idx) {
    if (!property.render) return null;
    return /*#__PURE__*/React__default.createElement("div", {
      key: 'func_' + idx
    }, property.render(auth, property, {
      data: data,
      object: object,
  ...
  var renderFormField = function renderFormField(property) {
    var _property$name;
    return /*#__PURE__*/React__default.createElement(FormItem, {
      ...
      formItem: true,
      data: data,
      item: _extends({}, property, {
        filterType: undefined,
        func: funcStat && funcStat[(_property$name = property.name) === null || _property$name === void 0 ? void 0 : _property$name.toLowerCase()] ? funcStat[property.name.toLowerCase()] : {}
      }),
      isChanged: isChangedField ? isChangedField(modelCore.getFieldName(property)) : undefined
    }));
  };
  var renderRelationTabs = function renderRelationTabs() {
    if (!hasRelations || !links) return null;
    return /*#__PURE__*/React__default.createElement("div", {
      style: _extends({
        display: visible || links === 'inline' ? 'block' : 'none'
      }, relationTabsWrapperStyle || {}),
      className: relationTabsWrapperClassName
    }, /*#__PURE__*/React__default.createElement(Tabs, null, propertiesOneMany.map(function (property, idx) {
      var relationName = _$4.get(property, 'relation.reference.object');
  ...
  var renderHeader = function renderHeader() {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      title: "\u0421\u0432\u044F\u0437\u0438"
    }, /*#__PURE__*/React__default.createElement(CheckableTag, {
      style: headerTagStyle,
      checked: visible,
      onChange: function onChange(checked) {
        return setVisible(checked);
      }
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, /*#__PURE__*/React__default.createElement(AntForm, _extends({
    form: form,
    onFinish: submit,
    ...
    labelAlign: "left",
    layout: "vertical"
  }), propertiesForRendering.map(function (property, idx) {
...
function ModelMobileRenderer(props) {
  var modelCore = props.modelCore,
    object = props.object,
    _onChange = props.onChange,
    readonly = props.readonly,
    disabled = props.disabled;
  ...
  var fields = React.useMemo(function () {
    return modelCore.getFields();
  }, [modelCore]);
  var layout = React.useMemo(function () {
    var _modelCore$getLayout;
    return ((_modelCore$getLayout = modelCore.getLayout) === null || _modelCore$getLayout === void 0 ? void 0 : _modelCore$getLayout.call(modelCore)) || 'vertical';
  }, [modelCore]);
  var renderField = function renderField(item) {
    var fieldCore = new FieldCore({
      item: item,
      object: object
    });
    return /*#__PURE__*/React__default.createElement("div", {
      key: item.name,
      className: "fennec-model-mobile-field"
    }, /*#__PURE__*/React__default.createElement(FieldMobileRenderer, {
      fieldCore: fieldCore,
      item: item,
      value: object === null || object === void 0 ? void 0 : object[item.name],
      onChange: function onChange(e) {
        var _e$target$value, _e$target, _extends2;
        var newValue = (_e$target$value = e === null || e === void 0 ? void 0 : (_e$target = e.target) === null || _e$target === void 0 ? void 0 : _e$target.value) != null ? _e$target$value : e;
        var updatedObject = _extends({}, object, (_extends2 = {}, _extends2[item.name] = newValue, _extends2));
        _onChange === null || _onChange === void 0 ? void 0 : _onChange(updatedObject);
      },
      readonly: readonly,
      disabled: disabled,
      object: object
  ...
  var renderFields = function renderFields() {
    if (layout === 'vertical') {
      return /*#__PURE__*/React__default.createElement("div", {
        className: "fennec-model-mobile-vertical"
      }, fields.map(renderField));
    }
    if (layout === 'horizontal') {
      return /*#__PURE__*/React__default.createElement("div", {
        className: "fennec-model-mobile-horizontal"
      }, fields.map(renderField));
    }
    if (layout === 'grid') {
      return /*#__PURE__*/React__default.createElement("div", {
        className: "fennec-model-mobile-grid"
      }, fields.map(renderField));
    }
    return /*#__PURE__*/React__default.createElement("div", {
      className: "fennec-model-mobile-vertical"
...
function Model(props) {
  ...
  var Renderer = React.useMemo(function () {
    return isMobile ? ModelMobileRenderer : ModelRenderer;
  }, [isMobile]);
...
var ActionModalCore = /*#__PURE__*/function () {
  ...
  var _proto = ActionModalCore.prototype;
  ...
  _proto.open = function open(options) {
    ...
    this.opened = true;
    this.onOpenCallbacks.forEach(function (callback) {
      return callback();
    });
  ...
  _proto.close = function close(options) {
    if (options === void 0) {
      options = {};
    }
    if (this.controlled) {
    ...
    if (!options.skipCallback) {
      this.onCloseCallbacks.forEach(function (callback) {
        return callback();
      });
    }
    return true;
  ...
  _proto.updateControlledState = function updateControlledState(visible) {
    if (this.controlled) {
      this.opened = visible;
    }
  };
  _proto.onOpen = function onOpen(callback) {
    ...
    return function () {
      _this.onOpenCallbacks = _this.onOpenCallbacks.filter(function (cb) {
        return cb !== callback;
      });
    };
  };
  _proto.onClose = function onClose(callback) {
    ...
    return function () {
      _this2.onCloseCallbacks = _this2.onCloseCallbacks.filter(function (cb) {
        return cb !== callback;
      });
    };
  };
  _proto.getModalProps = function getModalProps() {
    var _this3 = this;
    return {
      visible: this.opened,
      onClose: function onClose() {
  ...
  _proto.getTriggerProps = function getTriggerProps(customProps) {
    var _this4 = this;
    if (customProps === void 0) {
      customProps = {};
    }
  ...
  return ActionModalCore;
}();

var ActionWizardCore = /*#__PURE__*/function () {
  function ActionWizardCore(steps) {
    if (steps === void 0) {
      steps = [];
    }
    this.steps = steps;
  ...
  var _proto = ActionWizardCore.prototype;
  _proto.isWizard = function isWizard() {
    return this.steps && this.steps.length > 1;
  };
  _proto.getTotalSteps = function getTotalSteps() {
    return this.steps ? this.steps.length : 0;
  };
  _proto.getCurrentStepIndex = function getCurrentStepIndex() {
    return this.currentStepIndex;
  };
  _proto.getCurrentStep = function getCurrentStep() {
    var _this$steps;
    return ((_this$steps = this.steps) === null || _this$steps === void 0 ? void 0 : _this$steps[this.currentStepIndex]) || null;
  };
  _proto.getStep = function getStep(index) {
    var _this$steps2;
    return ((_this$steps2 = this.steps) === null || _this$steps2 === void 0 ? void 0 : _this$steps2[index]) || null;
  };
  _proto.isFirstStep = function isFirstStep() {
    return this.currentStepIndex === 0;
  };
  _proto.isLastStep = function isLastStep() {
  ...
  _proto.prevStep = function prevStep() {
    if (this.isFirstStep()) {
      return false;
    }
    this.currentStepIndex--;
  ...
  _proto.goToStep = function goToStep(index) {
  ...
  _proto.setStepData = function setStepData(stepKey, data) {
    this.stepData[stepKey] = data;
  };
  _proto.getStepData = function getStepData(stepKey) {
    return this.stepData[stepKey];
  };
  _proto.getAllStepData = function getAllStepData() {
    return _extends({}, this.stepData);
  };
  _proto.clearStepData = function clearStepData() {
    this.stepData = {};
  };
  ...
  _proto.getCurrentForm = function getCurrentForm() {
    var step = this.getCurrentStep();
    return (step === null || step === void 0 ? void 0 : step.form) || null;
  };
  _proto.getCurrentObject = function getCurrentObject() {
    var step = this.getCurrentStep();
    return (step === null || step === void 0 ? void 0 : step.object) || {};
  };
  _proto.getCurrentMeta = function getCurrentMeta() {
    var step = this.getCurrentStep();
    return (step === null || step === void 0 ? void 0 : step.meta) || {};
  };
  _proto.getCurrentTitles = function getCurrentTitles() {
    var step = this.getCurrentStep();
    return (step === null || step === void 0 ? void 0 : step.titles) || {};
  };
  _proto.getCurrentOptions = function getCurrentOptions() {
    var step = this.getCurrentStep();
    return (step === null || step === void 0 ? void 0 : step.options) || {};
  };
  _proto.hasNestedSteps = function hasNestedSteps() {
    var step = this.getCurrentStep();
    return !!(step !== null && step !== void 0 && step.steps && step.steps.length > 0);
  };
  _proto.getNestedSteps = function getNestedSteps() {
    var step = this.getCurrentStep();
    return (step === null || step === void 0 ? void 0 : step.steps) || null;
  };
  _proto.isAntFormEnabled = function isAntFormEnabled() {
    var step = this.getCurrentStep();
    return (step === null || step === void 0 ? void 0 : step.noAntForm) !== true;
  };
  _proto.onStepChange = function onStepChange(callback) {
    var _this = this;
    this.onStepChangeCallbacks.push(callback);
    return function () {
      _this.onStepChangeCallbacks = _this.onStepChangeCallbacks.filter(function (cb) {
        return cb !== callback;
      });
    };
  };
  _proto.notifyStepChange = function notifyStepChange() {
    var _this2 = this;
    this.onStepChangeCallbacks.forEach(function (callback) {
      callback(_this2.currentStepIndex, _this2.getCurrentStep());
    });
  };
  _proto.getNavigationProps = function getNavigationProps() {
    return {
  ...
  return ActionWizardCore;
}();

var ActionFormCore = /*#__PURE__*/function () {
  function ActionFormCore(props) {
    if (props === void 0) {
      props = {};
    }
    this.props = props;
    this.initialValues = props.object || {};
    this.currentValues = _extends({}, this.initialValues);
    this.changedFields = new Set();
    this.onChangeCallbacks = [];
  }
  var _proto = ActionFormCore.prototype;
  _proto.getInitialValues = function getInitialValues() {
    return _extends({}, this.initialValues);
  };
  _proto.getCurrentValues = function getCurrentValues() {
    return _extends({}, this.currentValues);
  };
  _proto.setValues = function setValues(values) {
    this.currentValues = _extends({}, values);
    this.detectChanges();
    this.notifyChange();
  };
  _proto.setFieldValue = function setFieldValue(fieldName, value) {
    this.currentValues[fieldName] = value;
    this.detectChanges();
    this.notifyChange();
  };
  _proto.getFieldValue = function getFieldValue(fieldName) {
    return this.currentValues[fieldName];
  };
  _proto.isFormChanged = function isFormChanged() {
    return this.changedFields.size > 0;
  };
  _proto.isFieldChanged = function isFieldChanged(fieldName) {
    return this.changedFields.has(fieldName);
  };
  _proto.getChangedFields = function getChangedFields() {
    return Array.from(this.changedFields);
  };
  _proto.detectChanges = function detectChanges() {
    var _this = this;
    this.changedFields.clear();
    Object.keys(this.currentValues).forEach(function (key) {
      var initialValue = _this.initialValues[key];
      var currentValue = _this.currentValues[key];
      if (_this.isValueDifferent(initialValue, currentValue)) {
        _this.changedFields.add(key);
      }
    });
    Object.keys(this.initialValues).forEach(function (key) {
      if (!(key in _this.currentValues)) {
        _this.changedFields.add(key);
      }
    });
  };
  _proto.isValueDifferent = function isValueDifferent(a, b) {
    var _this2 = this;
    if (a === b) {
      return false;
    }
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.some(function (item, index) {
        return _this2.isValueDifferent(item, b[index]);
      });
    }
    if (typeof a === 'object' && typeof b === 'object') {
      ...
      return keysA.some(function (key) {
        return _this2.isValueDifferent(a[key], b[key]);
      });
    }
    return a !== b;
  };
  ...
  _proto.applyModify = function applyModify(values) {
  ...
  _proto.toFormData = function toFormData(values) {
    var isFormData = this.props.isFormData;
    if (isFormData) {
      return makeFormData(values);
    }
    return values;
  };
  _proto.prepareForSubmit = function prepareForSubmit(values) {
    var modifiedValues = this.applyModify(values);
    return this.toFormData(modifiedValues);
  };
  _proto.isSubmitDisabled = function isSubmitDisabled() {
    var _this$props = this.props,
      disabledOkOnUncahngedForm = _this$props.disabledOkOnUncahngedForm,
      readonly = _this$props.readonly,
      disabled = _this$props.disabled;
    if (disabled || readonly) {
      return true;
  ...
  _proto.onChange = function onChange(callback) {
    ...
    return function () {
      _this3.onChangeCallbacks = _this3.onChangeCallbacks.filter(function (cb) {
        return cb !== callback;
      });
    };
  };
  _proto.notifyChange = function notifyChange() {
    ...
    this.onChangeCallbacks.forEach(function (callback) {
      callback(_this4.currentValues, _this4.changedFields);
    });
  };
  _proto.shouldUseAntForm = function shouldUseAntForm() {
  ...
  _proto.getFormProps = function getFormProps() {
    ...
    return {
      ...
      onChange: function onChange(values) {
        return _this5.setValues(values);
      }
    };
  };
  _proto.destroy = function destroy() {
  ...
  return ActionFormCore;
}();

var ActionCore = /*#__PURE__*/function () {
  ...
  var _proto = ActionCore.prototype;
  _proto.isWizard = function isWizard() {
  ...
  _proto.getButtonText = function getButtonText() {
    ...
    if (this.isWizard()) {
      var isLastStep = this.wizard.isLastStep();
      var isFirstStep = this.wizard.isFirstStep();
      return {
  ...
  _proto.handleOk = function handleOk(formValues) {
    try {
      var _this = this;
      return Promise.resolve(function () {
        if (_this.isWizard()) {
          var currentStep = _this.wizard.getCurrentStep();
          var stepKey = currentStep === null || currentStep === void 0 ? void 0 : currentStep.key;
          if (stepKey) {
            _this.wizard.setStepData(stepKey, formValues);
          }
          if (!_this.wizard.isLastStep()) {
            _this.wizard.nextStep();
            return;
          }
          var allStepData = _this.wizard.getAllStepData();
          return Promise.resolve(_this.executeAction(allStepData)).then(function () {});
        } else {
          return Promise.resolve(_this.executeAction(formValues)).then(function () {});
        }
      }());
    } catch (e) {
      return Promise.reject(e);
  ...
  _proto.handleBack = function handleBack() {
    if (this.isWizard()) {
      this.wizard.prevStep();
    }
  };
  _proto.executeAction = function executeAction(values) {
    try {
      var _this2 = this;
      ...
      var preparedValues = _this2.form.prepareForSubmit(values);
      _this2.setLoading(true);
      var unlock = function unlock() {
        _this2.setLoading(false);
      };
      var close = function close(skipCallback) {
      ...
      return Promise.resolve(_catch(function () {
        return Promise.resolve(action(preparedValues, unlock, close)).then(function () {
  ...
  _proto.getRenderProps = function getRenderProps() {
    ...
    return {
      ...
      onOk: function onOk(values) {
        return _this3.handleOk(values);
      },
      onBack: function onBack() {
        return _this3.handleBack();
      },
      onClose: function onClose() {
        return _this3.modal.close();
      },
  ...
  _proto.updateProps = function updateProps(newProps) {
  ...
  _proto.onLoadingChange = function onLoadingChange(callback) {
    var _this4 = this;
    this.onLoadingChangeCallbacks.push(callback);
    return function () {
      _this4.onLoadingChangeCallbacks = _this4.onLoadingChangeCallbacks.filter(function (cb) {
        return cb !== callback;
      });
    };
  };
  _proto.notifyLoadingChange = function notifyLoadingChange() {
    var _this5 = this;
    this.onLoadingChangeCallbacks.forEach(function (callback) {
      callback(_this5.loading);
    });
  };
  _proto.destroy = function destroy() {
    this.modal.destroy();
...
function ActionRenderer(_ref) {
  var renderProps = _ref.renderProps,
    children = _ref.children,
    wizardNavStyle = _ref.wizardNavStyle,
    wizardNavProgressStyle = _ref.wizardNavProgressStyle,
    wizardNavStepStyle = _ref.wizardNavStepStyle,
    briefStyle = _ref.briefStyle;
  var ui = useUI();
  var modalProps = renderProps.modalProps,
    triggerProps = renderProps.triggerProps,
    FormComponent = renderProps.currentForm,
    currentObject = renderProps.currentObject,
    useAntForm = renderProps.useAntForm,
    loading = renderProps.loading,
    submitDisabled = renderProps.submitDisabled,
    isWizard = renderProps.isWizard,
    wizardProps = renderProps.wizardProps,
    titles = renderProps.titles,
    buttonText = renderProps.buttonText,
    onOk = renderProps.onOk,
    onBack = renderProps.onBack,
    onClose = renderProps.onClose,
    mode = renderProps.mode,
    brief = renderProps.brief,
    formWraperStyle = renderProps.formWraperStyle,
    triggerStyle = renderProps.triggerStyle;
  ...
  var renderTrigger = function renderTrigger() {
    ...
    return ui.renderButton(_extends({}, triggerProps, {
      style: triggerStyle,
      children: buttonText.placeholder
    }));
  };
  var renderWizardNavigation = function renderWizardNavigation() {
    if (!isWizard) {
      return null;
    }
    return /*#__PURE__*/React__default.createElement("div", {
      style: wizardNavStyle
    }, /*#__PURE__*/React__default.createElement("div", {
      style: wizardNavProgressStyle
    }, ui.renderProgress({
      percent: wizardProps.currentStep / wizardProps.totalSteps * 100,
      showInfo: true,
      format: function format() {
        return wizardProps.currentStep + 1 + " / " + wizardProps.totalSteps;
      }
    })), /*#__PURE__*/React__default.createElement("div", {
      style: wizardNavStepStyle
  ...
  var renderFormContent = function renderFormContent() {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      style: formWraperStyle
    }, brief && /*#__PURE__*/React__default.createElement("div", {
      style: briefStyle
    }, brief), useAntForm ? ui.renderForm({
      initialValues: currentObject,
      onFinish: handleSubmit,
      children: /*#__PURE__*/React__default.createElement(FormComponent, {
        object: currentObject
      })
    }) :
    /*#__PURE__*/
    React__default.createElement(FormComponent, {
      object: currentObject,
  ...
  return /*#__PURE__*/React__default.createElement(Fragment, null, renderTrigger(), ui.renderModal(_extends({}, modalProps, {
    title: titles === null || titles === void 0 ? void 0 : titles.header,
    subTitle: titles === null || titles === void 0 ? void 0 : titles.subheader,
    footer: renderFooter(),
    width: 600,
    destroyOnClose: true,
    children: /*#__PURE__*/React__default.createElement(Fragment, null, renderWizardNavigation(), renderFormContent())
  })));
}

function ActionMobileRenderer(_ref) {
  var renderProps = _ref.renderProps,
    footerStyle = _ref.footerStyle,
    footerClassName = _ref.footerClassName,
    backButtonStyle = _ref.backButtonStyle,
    wizardProgressStyle = _ref.wizardProgressStyle,
    wizardProgressStepStyle = _ref.wizardProgressStepStyle,
    wizardProgressBarStyle = _ref.wizardProgressBarStyle,
  ...
  var modalProps = renderProps.modalProps,
    ...
    onBack = renderProps.onBack,
    onClose = renderProps.onClose,
    triggerElement = renderProps.triggerElement;
  var renderFooter = function renderFooter() {
    var buttons = [];
    if (isWizard && buttonText.showBack) {
      buttons.push(ui.renderButton({
  ...
  var renderWizardProgress = function renderWizardProgress() {
    if (!isWizard || !wizardProps) return null;
    var currentStep = wizardProps.currentStep,
      totalSteps = wizardProps.totalSteps,
      progress = wizardProps.progress;
    return /*#__PURE__*/React__default.createElement("div", {
      className: "fennec-action-mobile-wizard-progress",
      style: wizardProgressStyle
    }, /*#__PURE__*/React__default.createElement("div", {
      style: wizardProgressStepStyle
    }, "Step ", currentStep + 1, " of ", totalSteps), /*#__PURE__*/React__default.createElement(ui.Progress, {
      percent: progress,
  ...
  return /*#__PURE__*/React__default.createElement(Fragment, null, triggerElement, /*#__PURE__*/React__default.createElement(ui.CenterPopup, {
    visible: modalProps.visible,
    onClose: onClose,
    showCloseButton: true,
    style: popupStyle
  }, /*#__PURE__*/React__default.createElement("div", {
    className: "fennec-action-mobile"
  }, modalProps.title && /*#__PURE__*/React__default.createElement("div", {
    className: headerClassName,
    style: headerStyle
  }, modalProps.title), renderWizardProgress(), renderContent(), renderFooter())));
}

var _excluded$1 = ["form", "steps", "object", "action", "modify", "callback", "mode", "visible", "titles", "okText", "dismissText", "nextText", "backText", "placeholder", "brief", "noAntForm", "isFormData", "disabledOkOnUncahngedForm", "readonly", "disabled", "fire", "fireClose", "triggerStyle", "triggerOptions", "formWraperStyle", "actionRef", "children", "forceMobile"];
function Action(props) {
  var form = props.form,
    ...
    forceMobile = props.forceMobile,
    rendererProps = _objectWithoutPropertiesLoose(props, _excluded$1);
  var isSystemMobile = reactResponsive.useMediaQuery({
    maxWidth: 768
  });
  var isMobile = forceMobile !== undefined ? forceMobile : isSystemMobile;
  var core = React.useMemo(function () {
    return new ActionCore({
      ...
      disabledOkOnUncahngedForm: disabledOkOnUncahngedForm,
      readonly: readonly,
      disabled: disabled,
      triggerStyle: triggerStyle,
      triggerOptions: triggerOptions,
      formWraperStyle: formWraperStyle
    });
  }, []);
  var _useState = React.useState({}),
    forceUpdate = _useState[1];
  var triggerRerender = function triggerRerender() {
    return forceUpdate({});
  };
  React.useEffect(function () {
    core.updateProps({
    ...
    triggerRerender();
  }, [core, form, steps, object, action, modify, callback, mode, visible, titles, okText, dismissText, nextText, backText, placeholder, brief, noAntForm, isFormData, disabledOkOnUncahngedForm, readonly, disabled, triggerStyle, triggerOptions, formWraperStyle]);
  React.useEffect(function () {
    return core.onLoadingChange(function () {
      triggerRerender();
    });
  }, [core]);
  React.useEffect(function () {
    return core.wizard.onStepChange(function () {
      triggerRerender();
    });
  }, [core]);
  React.useEffect(function () {
    var unregisterOpen = core.modal.onOpen(function () {
      return triggerRerender();
    });
    var unregisterClose = core.modal.onClose(function () {
      return triggerRerender();
    });
    return function () {
      unregisterOpen();
  ...
  React.useEffect(function () {
    if (fire) {
      var token = subscribe(fire, function (msg, data) {
        core.modal.open();
        triggerRerender();
      });
      return function () {
  ...
  React.useEffect(function () {
    if (fireClose) {
      var token = subscribe(fireClose, function (msg, data) {
        core.modal.close();
        triggerRerender();
      });
      return function () {
  ...
  var renderProps = React.useMemo(function () {
    return core.getRenderProps();
  }, [core, core.modal.opened, core.loading, core.wizard.currentStepIndex]);
  var Renderer = React.useMemo(function () {
    return isMobile ? ActionMobileRenderer : ActionRenderer;
  }, [isMobile]);
  return /*#__PURE__*/React__default.createElement(Renderer, _extends({
...
var _excluded$2 = ["onChange"],
  _excluded2 = ["onChange"],
  _excluded3 = ["options", "onChange", "value", "mode"],
  _excluded4 = ["count", "value", "onChange"],
  _excluded5 = ["onChange", "value"],
  _excluded6 = ["onChange", "value"],
  _excluded7 = ["onChange", "fileList", "maxCount"],
  _excluded8 = ["dataSource", "columns", "renderItem", "loading", "onItemClick"],
  _excluded9 = ["visible", "onOk", "onCancel", "title", "children", "footer"],
  _excluded0 = ["current", "total", "pageSize", "onChange"];
var AntdMobileAdapter = /*#__PURE__*/function (_UIAdapter) {
  function AntdMobileAdapter() {
    var _this;
    _this = _UIAdapter.call(this) || this;
    _this.initializeComponents();
    return _this;
  }
  _inheritsLoose(AntdMobileAdapter, _UIAdapter);
  var _proto = AntdMobileAdapter.prototype;
  _proto.initializeComponents = function initializeComponents() {
    this.Input = this.wrapInput();
    this.TextArea = antdMobile.TextArea;
    this.InputNumber = this.wrapInputNumber();
    this.Select = this.wrapSelector();
    this.Checkbox = antdMobile.Checkbox;
    this.Radio = antdMobile.Radio;
    this.Switch = antdMobile.Switch;
    this.Slider = antdMobile.Slider;
    ...
    this.SearchBar = antdMobile.SearchBar;
    this.Stepper = antdMobile.Stepper;
    this.Table = this.wrapList();
    this.List = antdMobile.List;
    this.Tag = antdMobile.Tag;
    this.Badge = antdMobile.Badge;
    this.Avatar = antdMobile.Image;
    this.Image = antdMobile.Image;
    this.Progress = antdMobile.ProgressBar;
    this.Modal = this.wrapModal();
    this.Drawer = antdMobile.Popup;
    this.Popup = antdMobile.Popup;
    this.CenterPopup = antdMobile.CenterPopup;
    this.Message = this.wrapToast();
    this.Notification = this.wrapToast();
    this.Popconfirm = this.wrapDialog();
    this.Spin = antdMobile.Loading;
    this.Loading = antdMobile.Loading;
    this.Button = antdMobile.Button;
    this.Pagination = this.wrapPagination();
    this.Picker = antdMobile.Picker;
    this.CascadePicker = antdMobile.CascadePicker;
    this.Form = antdMobile.Form;
  };
  _proto.wrapInput = function wrapInput() {
    return function (props) {
      var _onChange = props.onChange,
        rest = _objectWithoutPropertiesLoose(props, _excluded$2);
      return /*#__PURE__*/React__default.createElement(antdMobile.Input, _extends({}, rest, {
  ...
  _proto.wrapInputNumber = function wrapInputNumber() {
    return function (props) {
      ...
      return /*#__PURE__*/React__default.createElement(antdMobile.Input, _extends({}, rest, {
        type: "number",
        onChange: function onChange(value) {
          var numValue = value ? Number(value) : undefined;
          if (_onChange2) {
            _onChange2(numValue);
          }
        }
  ...
  _proto.wrapSelector = function wrapSelector() {
    return function (props) {
      ...
      return /*#__PURE__*/React__default.createElement(antdMobile.Selector, _extends({}, rest, {
  ...
  _proto.wrapRate = function wrapRate() {
    return function (props) {
      ...
      return /*#__PURE__*/React__default.createElement("div", _extends({
        ...
        return /*#__PURE__*/React__default.createElement("span", {
          ...
          onClick: function onClick() {
            return onChange && onChange(index + 1);
          },
          style: {
            fontSize: '24px',
  ...
  _proto.wrapDatePicker = function wrapDatePicker() {
    return function (props) {
      var onChange = props.onChange,
        value = props.value,
        rest = _objectWithoutPropertiesLoose(props, _excluded5);
      return /*#__PURE__*/React__default.createElement(antdMobile.DatePicker, _extends({}, rest, {
        value: value,
        ...
        return (value === null || value === void 0 ? void 0 : value.toLocaleDateString()) || 'Select date';
      });
    };
  };
  _proto.wrapTimePicker = function wrapTimePicker() {
    return function (props) {
      var onChange = props.onChange,
        value = props.value,
      ...
      return /*#__PURE__*/React__default.createElement(antdMobile.DatePicker, _extends({}, rest, {
        ...
        return (value === null || value === void 0 ? void 0 : value.toLocaleTimeString()) || 'Select time';
      });
    };
  };
  _proto.wrapImageUploader = function wrapImageUploader() {
    return function (props) {
      ...
      return /*#__PURE__*/React__default.createElement(antdMobile.ImageUploader, _extends({}, rest, {
        value: fileList,
        maxCount: maxCount,
  ...
  _proto.wrapList = function wrapList() {
    return function (props) {
      ...
      if (renderItem) {
        return /*#__PURE__*/React__default.createElement(antdMobile.List, rest, dataSource.map(function (item, index) {
          return /*#__PURE__*/React__default.createElement(antdMobile.List.Item, {
            key: item.ID || item.id || index
          }, renderItem(item));
        }));
      }
      var defaultRenderItem = function defaultRenderItem(item) {
        var mainColumn = columns[0];
        var mainContent = mainColumn !== null && mainColumn !== void 0 && mainColumn.render ? mainColumn.render(item[mainColumn.dataIndex], item) : item[mainColumn === null || mainColumn === void 0 ? void 0 : mainColumn.dataIndex];
        return /*#__PURE__*/React__default.createElement("div", {
          onClick: function onClick() {
            return onItemClick === null || onItemClick === void 0 ? void 0 : onItemClick(item);
          }
      ...
      return /*#__PURE__*/React__default.createElement(antdMobile.List, rest, loading && /*#__PURE__*/React__default.createElement(antdMobile.Loading, null), !loading && dataSource.map(function (item, index) {
        return /*#__PURE__*/React__default.createElement(antdMobile.List.Item, {
          key: item.ID || item.id || index
  ...
  _proto.wrapModal = function wrapModal() {
    return function (props) {
      ...
      return /*#__PURE__*/React__default.createElement(antdMobile.Modal, _extends({}, rest, {
        visible: visible,
        title: title,
        onClose: onCancel,
        content: children,
  ...
  _proto.wrapToast = function wrapToast() {
    return {
      success: function success(content) {
        return antdMobile.Toast.show({
          icon: 'success',
          content: content
        });
      },
  ...
  _proto.wrapDialog = function wrapDialog() {
    return function (props) {
  ...
  _proto.wrapPagination = function wrapPagination() {
    return function (props) {
      ...
      var hasMore = current * pageSize < total;
      return /*#__PURE__*/React__default.createElement(antdMobile.InfiniteScroll, _extends({}, rest, {
        hasMore: hasMore,
  ...
  _proto.renderInput = function renderInput(props) {
    var InputComponent = this.Input;
    return /*#__PURE__*/React__default.createElement(InputComponent, props);
  };
  _proto.renderTextArea = function renderTextArea(props) {
    return /*#__PURE__*/React__default.createElement(antdMobile.TextArea, props);
  };
  _proto.renderSelect = function renderSelect(props) {
    var SelectComponent = this.Select;
    return /*#__PURE__*/React__default.createElement(SelectComponent, props);
  };
  _proto.renderDatePicker = function renderDatePicker(props) {
    var DatePickerComponent = this.DatePicker;
    return /*#__PURE__*/React__default.createElement(DatePickerComponent, props);
  };
  _proto.renderButton = function renderButton(props) {
    return /*#__PURE__*/React__default.createElement(antdMobile.Button, props);
  };
  _proto.renderModal = function renderModal(props) {
    var ModalComponent = this.Modal;
    return /*#__PURE__*/React__default.createElement(ModalComponent, props);
  };
  _proto.renderPopup = function renderPopup(props) {
    return /*#__PURE__*/React__default.createElement(antdMobile.Popup, props);
  };
  _proto.renderList = function renderList(props) {
    var ListComponent = this.Table;
    return /*#__PURE__*/React__default.createElement(ListComponent, props);
  };
  _proto.renderLoading = function renderLoading(props) {
    return /*#__PURE__*/React__default.createElement(antdMobile.Loading, props);
  };
  _proto.showSuccess = function showSuccess(content) {
    this.Message.success(content);
  };
  _proto.showError = function showError(content) {
    this.Message.error(content);
  };
  _proto.showInfo = function showInfo(content) {
...
var _excluded$3 = ["value", "onChange"],
  _excluded2$1 = ["value", "onChange"];
var AntTextArea = antd.Input.TextArea;
function Input(_ref) {
...
function TextArea(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(AntTextArea, _extends({
    value: value,
    onChange: handleChange
  }, rest));
}

var _excluded$4 = ["value", "onChange", "options", "multiple", "searchable", "loading", "onSearch"];
...
function Select(_ref) {
  ...
  var showSearch = searchable;
  var filterOption = rest.filterOption !== undefined ? rest.filterOption : function (input, option) {
    if (option !== null && option !== void 0 && option.children) {
  ...
  }, rest), options === null || options === void 0 ? void 0 : options.map(function (opt) {
...
var _excluded$5 = ["value", "onChange", "format", "showTime"],
  _excluded2$2 = ["value", "onChange", "format"],
  _excluded3$1 = ["value", "onChange", "format"];
var AntRangePicker = antd.DatePicker.RangePicker;
function DatePicker(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.DatePicker, _extends({
    value: value,
    onChange: onChange,
    format: format,
    showTime: showTime,
...
function TimePicker(_ref2) {
  var value = _ref2.value,
    ...
    format = _ref2$format === void 0 ? 'HH:mm:ss' : _ref2$format,
    rest = _objectWithoutPropertiesLoose(_ref2, _excluded2$2);
  return /*#__PURE__*/React__default.createElement(antd.TimePicker, _extends({
    value: value,
    onChange: onChange,
    format: format,
    locale: locale
...
var _excluded$6 = ["onFinish", "initialValues", "form", "layout"],
  _excluded2$3 = ["label", "name", "rules", "required", "children"];
var AntFormItem = antd.Form.Item;
function Form(_ref) {
...
function FormItem(_ref2) {
  ...
  if (required && !normalizedRules.some(function (r) {
    return r.required;
  })) {
    normalizedRules.push({
      required: true,
      message: label + " \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E \u0434\u043B\u044F \u0437\u0430\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u044F"
    });
  }
  return /*#__PURE__*/React__default.createElement(AntFormItem, _extends({
    label: label,
    name: name,
...
function useFormInstance() {
  return antd.Form.useForm();
}

var _excluded$7 = ["dataSource", "columns", "loading", "pagination", "onChange", "rowKey", "rowSelection"],
  _excluded2$4 = ["dataSource", "renderItem", "loading", "pagination"];
function Table(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Table, _extends({
...
function List(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.List, _extends({
    dataSource: dataSource,
    renderItem: renderItem,
    loading: loading,
    pagination: pagination
...
var _excluded$8 = ["visible", "onClose", "title", "footer", "width", "children"],
  _excluded2$5 = ["visible", "onClose", "title", "placement", "width", "children"],
  _excluded3$2 = ["activeKey", "onChange", "items", "children"],
  _excluded4$1 = ["tab", "children"],
  _excluded5$1 = ["type", "orientation", "children"],
  _excluded6$1 = ["direction", "size", "children"],
  _excluded7$1 = ["title", "extra", "children"];
var AntTabPane = antd.Tabs.TabPane;
function Modal(_ref) {
...
function Drawer(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Drawer, _extends({
    open: visible,
    onClose: onClose,
    title: title,
    placement: placement,
...
function Tabs(_ref3) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Tabs, _extends({
    activeKey: activeKey,
    onChange: onChange,
    items: items
  }, rest), children);
}
function TabPane(_ref4) {
  var tab = _ref4.tab,
    children = _ref4.children,
    rest = _objectWithoutPropertiesLoose(_ref4, _excluded4$1);
  return /*#__PURE__*/React__default.createElement(AntTabPane, _extends({
    tab: tab
  }, rest), children);
}
function Divider(_ref5) {
  var _ref5$type = _ref5.type,
    type = _ref5$type === void 0 ? 'horizontal' : _ref5$type,
    orientation = _ref5.orientation,
    children = _ref5.children,
    rest = _objectWithoutPropertiesLoose(_ref5, _excluded5$1);
  return /*#__PURE__*/React__default.createElement(antd.Divider, _extends({
    type: type,
    orientation: orientation
  }, rest), children);
}
function Space(_ref6) {
  var _ref6$direction = _ref6.direction,
    direction = _ref6$direction === void 0 ? 'horizontal' : _ref6$direction,
    _ref6$size = _ref6.size,
    size = _ref6$size === void 0 ? 'small' : _ref6$size,
    children = _ref6.children,
    rest = _objectWithoutPropertiesLoose(_ref6, _excluded6$1);
  return /*#__PURE__*/React__default.createElement(antd.Space, _extends({
    direction: direction,
    size: size
  }, rest), children);
}
function Card(_ref7) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Card, _extends({
    title: title,
    extra: extra
  }, rest), children);
}

var _excluded$9 = ["onClick", "type", "disabled", "loading", "icon", "children"],
  _excluded2$6 = ["menu", "trigger", "children"],
  _excluded3$3 = ["title", "placement", "children"];
...
function Dropdown(_ref2) {
  var menu = _ref2.menu,
    ...
    children = _ref2.children,
    rest = _objectWithoutPropertiesLoose(_ref2, _excluded2$6);
  return /*#__PURE__*/React__default.createElement(antd.Dropdown, _extends({
    menu: menu,
    trigger: [trigger]
  }, rest), children);
}
function Tooltip(_ref3) {
  var title = _ref3.title,
    ...
    children = _ref3.children,
    rest = _objectWithoutPropertiesLoose(_ref3, _excluded3$3);
  return /*#__PURE__*/React__default.createElement(antd.Tooltip, _extends({
    title: title,
    placement: placement
  }, rest), children);
}

var _excluded$a = ["current", "total", "pageSize", "onChange", "showSizeChanger"],
  _excluded2$7 = ["spinning", "size", "children"],
  _excluded3$4 = ["description", "image"],
  _excluded4$2 = ["color", "onClose", "closable", "children"],
  _excluded5$2 = ["count", "dot", "children"],
  _excluded6$2 = ["value", "onChange", "min", "max", "step", "disabled"],
  _excluded7$2 = ["value", "onChange", "min", "max", "step", "disabled"],
  _excluded8$1 = ["value", "onChange", "accept", "multiple", "maxSize", "onUpload"],
  _excluded9$1 = ["value", "onChange", "accept", "multiple"],
  _excluded0$1 = ["checked", "onChange", "disabled", "label", "children"],
  _excluded1 = ["value", "onChange", "options", "disabled"],
  _excluded10 = ["src", "alt", "width", "height", "preview"],
  _excluded11 = ["checked", "onChange", "disabled"],
  _excluded12 = ["value", "onChange", "count", "disabled", "allowHalf"],
  _excluded13 = ["value", "onChange", "disabled", "showText"];
var AntDragger = antd.Upload.Dragger;
function Pagination(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Pagination, _extends({
    current: current,
    total: total,
    pageSize: pageSize,
    onChange: onChange,
...
function Spin(_ref2) {
  var _ref2$spinning = _ref2.spinning,
    spinning = _ref2$spinning === void 0 ? true : _ref2$spinning,
    _ref2$size = _ref2.size,
    size = _ref2$size === void 0 ? 'default' : _ref2$size,
    children = _ref2.children,
    rest = _objectWithoutPropertiesLoose(_ref2, _excluded2$7);
  return /*#__PURE__*/React__default.createElement(antd.Spin, _extends({
    spinning: spinning,
    size: size
  }, rest), children);
}
function Empty(_ref3) {
  var description = _ref3.description,
    image = _ref3.image,
    rest = _objectWithoutPropertiesLoose(_ref3, _excluded3$4);
  return /*#__PURE__*/React__default.createElement(antd.Empty, _extends({
...
function Tag(_ref4) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Tag, _extends({
    color: color,
    onClose: onClose,
    closable: closable
  }, rest), children);
...
function Badge(_ref5) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Badge, _extends({
    count: count,
    dot: dot
  }, rest), children);
}
function InputNumber(_ref6) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.InputNumber, _extends({
    value: value,
    onChange: onChange,
    min: min,
    max: max,
...
function Slider(_ref7) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Slider, _extends({
    value: value,
    onChange: onChange,
    min: min,
    max: max,
...
function Upload(_ref8) {
  var value = _ref8.value,
    onChange = _ref8.onChange,
    accept = _ref8.accept,
    multiple = _ref8.multiple,
    onUpload = _ref8.onUpload,
    rest = _objectWithoutPropertiesLoose(_ref8, _excluded8$1);
  var fileList = value || [];
  ...
  var customRequest = function customRequest(options) {
    try {
      var _temp2 = function () {
        if (onUpload) {
          var _temp = _catch(function () {
            return Promise.resolve(onUpload(options.file)).then(function () {
              options.onSuccess();
            });
          }, function (error) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Upload, _extends({
    fileList: fileList,
    onChange: handleChange,
    accept: accept,
    multiple: multiple,
...
function Dragger(_ref9) {
  var value = _ref9.value,
    onChange = _ref9.onChange,
    accept = _ref9.accept,
    multiple = _ref9.multiple,
    rest = _objectWithoutPropertiesLoose(_ref9, _excluded9$1);
  var fileList = value || [];
  var handleChange = function handleChange(info) {
    if (onChange) {
      onChange(info.fileList);
  ...
  return /*#__PURE__*/React__default.createElement(AntDragger, _extends({
    fileList: fileList,
    onChange: handleChange,
    accept: accept,
    multiple: multiple
...
function Checkbox(_ref0) {
  var checked = _ref0.checked,
  ...
  return /*#__PURE__*/React__default.createElement(antd.Checkbox, _extends({
    checked: checked,
    onChange: handleChange,
    disabled: disabled
  }, rest), label || children);
}
function Radio(_ref1) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Radio.Group, _extends({
    value: value,
    onChange: function onChange(e) {
...
function Image(_ref10) {
  var src = _ref10.src,
    alt = _ref10.alt,
    width = _ref10.width,
    height = _ref10.height,
    _ref10$preview = _ref10.preview,
    preview = _ref10$preview === void 0 ? true : _ref10$preview,
    rest = _objectWithoutPropertiesLoose(_ref10, _excluded10);
  return /*#__PURE__*/React__default.createElement(antd.Image, _extends({
    src: src,
    alt: alt,
    width: width,
    height: height,
...
function Switch(_ref11) {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Switch, _extends({
    checked: checked,
    onChange: handleChange,
    disabled: disabled
  }, rest));
}
function Rate(_ref12) {
  var value = _ref12.value,
    onChange = _ref12.onChange,
    _ref12$count = _ref12.count,
    count = _ref12$count === void 0 ? 5 : _ref12$count,
    disabled = _ref12.disabled,
    _ref12$allowHalf = _ref12.allowHalf,
    allowHalf = _ref12$allowHalf === void 0 ? false : _ref12$allowHalf,
    rest = _objectWithoutPropertiesLoose(_ref12, _excluded12);
  var handleChange = function handleChange(rating) {
    if (onChange) {
      onChange(rating);
    }
  };
  return /*#__PURE__*/React__default.createElement(antd.Rate, _extends({
    value: value,
    onChange: handleChange,
    count: count,
    disabled: disabled,
...
function ColorPicker(_ref13) {
  var value = _ref13.value,
    onChange = _ref13.onChange,
    disabled = _ref13.disabled,
    _ref13$showText = _ref13.showText,
    showText = _ref13$showText === void 0 ? false : _ref13$showText,
    rest = _objectWithoutPropertiesLoose(_ref13, _excluded13);
  var handleChange = function handleChange(color) {
    if (onChange) {
      var _color$toHexString;
      var hexValue = (color === null || color === void 0 ? void 0 : (_color$toHexString = color.toHexString) === null || _color$toHexString === void 0 ? void 0 : _color$toHexString.call(color)) || color;
      onChange(hexValue);
    }
  };
  return /*#__PURE__*/React__default.createElement(antd.ColorPicker, _extends({
    value: value,
    onChange: handleChange,
    disabled: disabled,
    showText: showText
...
var AntdAdapter = /*#__PURE__*/function (_UIAdapter) {
  function AntdAdapter() {
    var _this;
    _this = _UIAdapter.call(this) || this;
    _this.Input = Input;
    ...
    _this.Icons = {
      ...
      SortAscending: icons.SortAscendingOutlined,
      SortDescending: icons.SortDescendingOutlined,
      Fullscreen: icons.FullscreenOutlined,
      FullscreenExit: icons.FullscreenExitOutlined
    };
  ...
  _inheritsLoose(AntdAdapter, _UIAdapter);
  var _proto = AntdAdapter.prototype;
  _proto.transformFormData = function transformFormData(data) {
    return data;
  };
  _proto.transformTableData = function transformTableData(data) {
  ...
  _proto.normalizeFiles = function normalizeFiles(fileList) {
    ...
    return fileList.map(function (file) {
      ...
      return {
        ...
        name: file.name,
        status: file.status,
        url: file.url || ((_file$response = file.response) === null || _file$response === void 0 ? void 0 : _file$response.url),
...
var CollectionCore = /*#__PURE__*/function () {
  ...
  var _proto = CollectionCore.prototype;
  _proto.getDefaultFilters = function getDefaultFilters(filters) {
    if (!filters || !filters.length) return {};
    var filtr = {};
    for (var d = 0; d < filters.length; d++) {
      var element = filters[d];
      if (element.filtered) {
        var _extends2;
        filtr = _extends({}, filtr, (_extends2 = {}, _extends2[element.name] = element.filtered, _extends2));
      }
    }
    return filtr;
  };
  _proto.getDefaultSorting = function getDefaultSorting(filters) {
    var sorted = {
      name: '',
      order: 'ASC'
    };
  ...
  _proto.buildQueryParams = function buildQueryParams(filters, contextFilters, filter, sorting, current, count, queryDetail) {
    ...
    Object.keys(filter).forEach(function (key) {
      ...
      if (item) {
        var filterByKey = filter[key];
        flt.push.apply(flt, _this.buildFilterByType(item, akey, filterByKey));
      }
    });
    var func = [];
    filters === null || filters === void 0 ? void 0 : filters.forEach(function (item) {
      if (item.func && _$6.isArray(item.func)) {
  ...
  _proto.buildFilterByType = function buildFilterByType(item, akey, filterByKey) {
    ...
    switch (item === null || item === void 0 ? void 0 : item.filterType) {
      ...
      case 'range':
        ...
        break;
      default:
        flt.push.apply(flt, this.buildDefaultFilter(item, akey, filterByKey));
        break;
    }
    return flt;
  };
  _proto.buildRangeFilter = function buildRangeFilter(item, akey, filterByKey) {
    var flt = [];
    if (!_$6.isArray(filterByKey) || filterByKey.length < 2) {
      return flt;
    }
    switch (item === null || item === void 0 ? void 0 : item.type) {
      ...
      default:
        if (item !== null && item !== void 0 && item.queryComparer) {
          var comparer = _$6.isFunction(item === null || item === void 0 ? void 0 : item.queryComparer) ? item === null || item === void 0 ? void 0 : item.queryComparer(filterByKey, item) : item === null || item === void 0 ? void 0 : item.queryComparer;
  ...
  _proto.buildDefaultFilter = function buildDefaultFilter(item, akey, filterByKey) {
    var flt = [];
    switch (item === null || item === void 0 ? void 0 : item.type) {
      case 'string':
        var comparer = _$6.isFunction(item === null || item === void 0 ? void 0 : item.queryComparer) ? (item === null || item === void 0 ? void 0 : item.queryComparer(filterByKey, item)) || 'co' : (item === null || item === void 0 ? void 0 : item.queryComparer) || 'co';
        flt.push(QueryParam$1("w-" + comparer + "-" + akey, filterByKey));
        break;
      case 'func':
        var prefix = _$6.isFunction(item === null || item === void 0 ? void 0 : item.queryPrefix) ? (item === null || item === void 0 ? void 0 : item.queryPrefix(filterByKey, item)) || '' : (item === null || item === void 0 ? void 0 : item.queryPrefix) || '';
        flt.push(QueryParam$1("" + prefix + akey, filterByKey));
        break;
      default:
        if (item !== null && item !== void 0 && item.queryRaw) {
          var raw = _$6.isFunction(item === null || item === void 0 ? void 0 : item.queryRaw) ? item === null || item === void 0 ? void 0 : item.queryRaw(filterByKey, item, akey) : item === null || item === void 0 ? void 0 : item.queryRaw;
          flt.push(raw);
        } else if (item !== null && item !== void 0 && item.queryComparer) {
          var _comparer = _$6.isFunction(item === null || item === void 0 ? void 0 : item.queryComparer) ? item === null || item === void 0 ? void 0 : item.queryComparer(filterByKey, item) : item === null || item === void 0 ? void 0 : item.queryComparer;
  ...
  _proto.hasFiltersChanged = function hasFiltersChanged(oldFilter, newFilter) {
    return !_$6.isEqual(oldFilter, newFilter);
  };
  ...
  _proto.hasMorePages = function hasMorePages(current, totalPages) {
    return current < totalPages;
  };
  _proto.getFilterValue = function getFilterValue(filters, fieldName) {
    return filters[fieldName];
  };
  _proto.setFilterValue = function setFilterValue(filters, fieldName, value, item) {
    var _extends3;
    if (!value && !(item !== null && item !== void 0 && item.permanent) || item !== null && item !== void 0 && item.permanent && (value === undefined || value === null) || _$6.isArray(value) && value.length == 0) {
      var f = _extends({}, filters);
      delete f[fieldName];
      return f;
    }
    return _extends({}, filters, (_extends3 = {}, _extends3[fieldName] = value, _extends3));
  };
...
var defaultOverlayBackdropStyle = {
  padding: '5px',
  backgroundColor: 'rgba(0,0,0,0.4)',
  height: '100%',
  width: '100%'
};
function PopoverModal(_ref) {
  var open = _ref.open,
    setOpen = _ref.setOpen,
    content = _ref.content,
    children = _ref.children,
    overlayStyle = _ref.overlayStyle,
    overlayBackdropStyle = _ref.overlayBackdropStyle,
    contentStyle = _ref.contentStyle,
    contentClassName = _ref.contentClassName;
  return /*#__PURE__*/React__default.createElement(Fragment, null, children, /*#__PURE__*/React__default.createElement(Overlay, {
    open: open,
    setOpen: setOpen,
    overlayStyle: overlayStyle != null ? overlayStyle : defaultOverlayStyle,
    overlayBackdropStyle: overlayBackdropStyle != null ? overlayBackdropStyle : defaultOverlayBackdropStyle,
    contentStyle: contentStyle != null ? contentStyle : {
      maxWidth: '90vw'
    },
...
var IconFilter = function IconFilter(props) {
  return /*#__PURE__*/React__default.createElement("svg", _extends({}, svgProps, props), /*#__PURE__*/React__default.createElement("path", {
...
var IconSortAsc = function IconSortAsc(props) {
  return /*#__PURE__*/React__default.createElement("svg", _extends({}, svgProps, props), /*#__PURE__*/React__default.createElement("path", {
    d: "M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"
  }));
};
var IconSortDesc = function IconSortDesc(props) {
  return /*#__PURE__*/React__default.createElement("svg", _extends({}, svgProps, props), /*#__PURE__*/React__default.createElement("path", {
    d: "M884 768H140c-6.5 0-10.3-7.4-6.5-12.7l352.6-486.1c12.8-17.6 39-17.6 51.7 0l352.6 486.1c3.9 5.3-.1 12.7-6.4 12.7z"
  }));
};
var IconFullscreen = function IconFullscreen(props) {
  return /*#__PURE__*/React__default.createElement("svg", _extends({}, svgProps, props), /*#__PURE__*/React__default.createElement("path", {
    d: "M290 236.4l43.9-43.9a8 8 0 0 0 0-11.3l-50.7-50.7a8 8 0 0 0-11.3 0L237 173.3a8 8 0 0 0 0 11.3l43.9 43.9a8 8 0 0 0 11.3 0l50.7-50.7a8 8 0 0 0 0-11.3zM734 236.4l43.9-43.9a8 8 0 0 0 0-11.3l-50.7-50.7a8 8 0 0 0-11.3 0L681 173.3a8 8 0 0 0 0 11.3l43.9 43.9a8 8 0 0 0 11.3 0l50.7-50.7a8 8 0 0 0 0-11.3zM290 787.6l43.9 43.9a8 8 0 0 0 11.3 0l50.7-50.7a8 8 0 0 0 0-11.3L347 734.7a8 8 0 0 0-11.3 0l-50.7 50.7a8 8 0 0 0 0 11.3l43.9 43.9zM734 787.6l43.9 43.9a8 8 0 0 0 11.3 0l50.7-50.7a8 8 0 0 0 0-11.3L787 734.7a8 8 0 0 0-11.3 0l-50.7 50.7a8 8 0 0 0 0 11.3l43.9 43.9z"
  }));
};
var IconFullscreenExit = function IconFullscreenExit(props) {
  return /*#__PURE__*/React__default.createElement("svg", _extends({}, svgProps, props), /*#__PURE__*/React__default.createElement("path", {
    d: "M391 240c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8h240c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8H391zm0 288c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8h240c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8H391zm-64 96c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8h304c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8H327zm0-288c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8h304c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8H327z"
  }));
};
function SortingFieldsUI(props) {
  var filters = props.filters,
    ...
    contentStyle = props.contentStyle,
    contentClassName = props.contentClassName,
    sortRowStyle = props.sortRowStyle,
    selectStyle = props.selectStyle;
  var adapter = useUIAdapter();
  var Select = adapter.Select;
  var Option = (Select === null || Select === void 0 ? void 0 : Select.Option) || adapter.Select;
  var Button = adapter.Button;
  var Tooltip = adapter.Tooltip;
  var Divider = adapter.Divider;
  var Icons = adapter.Icons || {};
  var SortAscIcon = Icons.SortAscending || IconSortAsc;
  var SortDescIcon = Icons.SortDescending || IconSortDesc;
  return /*#__PURE__*/React__default.createElement(Fragment, null, /*#__PURE__*/React__default.createElement(Divider, {
    type: "horizontal",
    orientation: "left",
    style: dividerStyle,
...
function FiltersFieldsUI(props) {
  ...
  var auth = props.auth,
    ...
    contentStyle = props.contentStyle,
    contentClassName = props.contentClassName,
    fieldWrapperStyle = props.fieldWrapperStyle;
  var adapter = useUIAdapter();
  var Divider = adapter.Divider;
  var Text = ((_adapter$Typography = adapter.Typography) === null || _adapter$Typography === void 0 ? void 0 : _adapter$Typography.Text) || 'span';
  var _onFilterChange = React.useMemo(function () {
    return function (v, item) {
      if (!v && !(item !== null && item !== void 0 && item.permanent) || item !== null && item !== void 0 && item.permanent && (v === undefined || v === null) || _$7.isArray(v) && v.length == 0) {
...
function FilterButton(props) {
  var _adapter$Icons, _Object$keys;
  var ref = React.useRef(null);
  var setBounding = props.setBounding,
  ...
  var adapter = useUIAdapter();
  var Badge = adapter.Badge;
  var FilterIcon = ((_adapter$Icons = adapter.Icons) === null || _adapter$Icons === void 0 ? void 0 : _adapter$Icons.Filter) || IconFilter;
  React.useEffect(function () {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    dot: state && state.filter && ((_Object$keys = Object.keys(state.filter)) === null || _Object$keys === void 0 ? void 0 : _Object$keys.length) > 0 ? true : false
  }, /*#__PURE__*/React__default.createElement(FilterIcon, {
    style: iconStyle
  })));
}
function FilterContent(props) {
  var auth = props.auth,
    ...
    name = props.name,
    fieldName = props.fieldName,
    _onFilterChange = props._onFilterChange,
    applyFilter = props.applyFilter,
    clearFilter = props.clearFilter,
    applyWrapperStyle = props.applyWrapperStyle,
    applyButtonStyle = props.applyButtonStyle,
    clearWrapperStyle = props.clearWrapperStyle,
    clearButtonStyle = props.clearButtonStyle,
    dividerStyle = props.dividerStyle,
    dividerClassName = props.dividerClassName,
    sortContentStyle = props.sortContentStyle,
    sortContentClassName = props.sortContentClassName,
    sortRowStyle = props.sortRowStyle,
    selectStyle = props.selectStyle,
    filtersContentStyle = props.filtersContentStyle,
    filtersContentClassName = props.filtersContentClassName,
    fieldWrapperStyle = props.fieldWrapperStyle;
  var adapter = useUIAdapter();
  var Button = adapter.Button;
  return /*#__PURE__*/React__default.createElement(Fragment, null, function () {
    ...
    if (filtered && fl.length > 0) {
      return /*#__PURE__*/React__default.createElement(Fragment, null, /*#__PURE__*/React__default.createElement("div", {
        ...
        disabled: _$7.isEmpty(state.filter),
        onClick: clearFilter
      }, "\u041E\u0447\u0438\u0441\u0442\u0438\u0442\u044C")));
    }
    return null;
    ...
    contentStyle: sortContentStyle,
    contentClassName: sortContentClassName,
    sortRowStyle: sortRowStyle,
    ...
    dividerStyle: dividerStyle,
    dividerClassName: dividerClassName,
    contentStyle: filtersContentStyle,
    contentClassName: filtersContentClassName,
    fieldWrapperStyle: fieldWrapperStyle
  }));
}
function CollectionRenderer(props) {
  var auth = props.auth,
    name = props.name,
    fieldName = props.fieldName,
    propMeta = props.meta,
    propFilters = props.filters,
    contextFilters = props.contextFilters,
    source = props.source,
    ...
    paginationProp = _props$pagination === void 0 ? true : _props$pagination,
    ...
    headerStyle = props.headerStyle,
    headerClassName = props.headerClassName,
    headerToolbarStyle = props.headerToolbarStyle,
    collectionActionsStyle = props.collectionActionsStyle,
    collectionActionsClassName = props.collectionActionsClassName,
    paginationWrapperStyle = props.paginationWrapperStyle,
    paginationWrapperClassName = props.paginationWrapperClassName,
    cardStyle = props.cardStyle,
    cardClassName = props.cardClassName,
    filterButtonClassName = props.filterButtonClassName,
    filterButtonStyle = props.filterButtonStyle,
    filterButtonIconStyle = props.filterButtonIconStyle,
    filterContentApplyWrapperStyle = props.filterContentApplyWrapperStyle,
    filterContentApplyButtonStyle = props.filterContentApplyButtonStyle,
    filterContentClearWrapperStyle = props.filterContentClearWrapperStyle,
    filterContentClearButtonStyle = props.filterContentClearButtonStyle,
    filterContentDividerStyle = props.filterContentDividerStyle,
    filterContentDividerClassName = props.filterContentDividerClassName,
    filterContentSortContentStyle = props.filterContentSortContentStyle,
    filterContentSortContentClassName = props.filterContentSortContentClassName,
    filterContentSortRowStyle = props.filterContentSortRowStyle,
    filterContentSelectStyle = props.filterContentSelectStyle,
    filterContentFiltersContentStyle = props.filterContentFiltersContentStyle,
    filterContentFiltersContentClassName = props.filterContentFiltersContentClassName,
    filterContentFieldWrapperStyle = props.filterContentFieldWrapperStyle,
    overlayStyleProp = props.overlayStyle,
    overlayBackdropStyle = props.overlayBackdropStyle,
    overlayContentStyle = props.overlayContentStyle,
    overlayContentClassName = props.overlayContentClassName;
  var adapter = useUIAdapter();
  var gmeta = useMetaContext();
  var Pagination = adapter.Pagination;
  var Button = adapter.Button;
  var Card = adapter.Card;
  var collectionCore = React.useMemo(function () {
  ...
  var fltrs = React.useMemo(function () {
    return propFilters ? propFilters() : [];
  }, [propFilters]);
  var meta = propMeta || gmeta;
  var _useState = React.useState(false),
    loading = _useState[0],
  ...
  var _useState6 = React.useState(),
    mobject = _useState6[0],
    setMObject = _useState6[1];
  ...
  var _useState9 = React.useState(false),
    filtered = _useState9[0],
    setFiltered = _useState9[1];
  var _useState0 = React.useState(collectionCore.getDefaultSorting(fltrs)),
    sorting = _useState0[0],
    setSorting = _useState0[1];
  var _useState1 = React.useState(1),
    current = _useState1[0],
    _setCurrent = _useState1[1];
  var _useState10 = React.useState(20),
    count = _useState10[0],
  ...
  var _useState13 = React.useState(),
    bounding = _useState13[0],
    setBounding = _useState13[1];
  var setCurrent = React.useCallback(function (value) {
    _setCurrent(value);
  ...
  React.useEffect(function () {
    if (name && meta) {
      ...
      if (mo) {
        setMObject(mo);
        if (propFilters) {
          var f = collectionCore.enrichFiltersWithMetadata(fltrs, meta, mo);
          setFilters(f);
        }
      }
    } else {
  ...
  var setCollection = React.useCallback(function (array) {
    if (onSetCollection) {
      var result = onSetCollection(array);
  ...
  var _onFilterChange = React.useCallback(function (newFilter) {
    var filterChanged = collectionCore.hasFiltersChanged(state.filter, newFilter);
  ...
  var applyFilter = React.useCallback(function () {
    ...
    setCurrent(1);
    if (onApplyFilter) {
      var queryParams = collectionCore.buildQueryParams(filters, contextFilters, newState.filter, sorting, 1, count, queryDetail);
      onApplyFilter({
        filters: filters,
        page: 1,
        count: count,
  ...
  var request = React.useCallback(function (filter) {
    if (!meta || !filters) return;
    var queryParams = collectionCore.buildQueryParams(filters, contextFilters, filter, sorting, current, count, queryDetail);
    if (source && _$7.isFunction(source)) {
      source({
        lock: lock,
        unlock: unlock,
        page: current,
        ...
        apply: function apply(data) {
          ...
          setTotalPages((data === null || data === void 0 ? void 0 : data.totalPages) || 1);
          setCount((data === null || data === void 0 ? void 0 : data.size) || count);
          setTotal((data === null || data === void 0 ? void 0 : data.totalElements) || 0);
          setCollection((data === null || data === void 0 ? void 0 : data.content) || []);
          setResponse(data);
          unlock();
        }
      });
  ...
  var renderContext = React.useMemo(function () {
    return {
      collection: collection,
      setCollection: setCollection,
  ...
  }, [collection, setCollection, setCollectionItem, removeCollectionItem, collectionActions, modelActions, request, funcStat, lock, unlock, loading]);
  var hasFilters = Boolean(filters && filters.some(function (f) {
    return f.filter || f.sort;
  }));
  var shellContext = React.useMemo(function () {
  ...
  var renderFilterPanel = function renderFilterPanel() {
    if (!filters || !filters.some(function (f) {
      return f.filter || f.sort;
    })) return null;
    return /*#__PURE__*/React__default.createElement(PopoverModal, {
      open: filtered,
      setOpen: setFiltered,
      bounding: bounding,
      content: /*#__PURE__*/React__default.createElement(FilterContent, {
        auth: auth,
        filters: filters,
        sorting: sorting,
        setSorting: setSorting,
  ...
  var renderCollectionActions = function renderCollectionActions() {
    if (!collectionActions || !collectionActions.length) return null;
    return /*#__PURE__*/React__default.createElement("div", {
      style: collectionActionsStyle,
      className: collectionActionsClassName
    }, collectionActions.map(function (action, idx) {
  ...
  var renderHeader = function renderHeader() {
    ...
    }, renderFilterPanel(), renderCollectionActions()), allowFullscreen && function (_adapter$Icons2, _adapter$Icons3) {
      var FullscreenIcon = fullscreen ? ((_adapter$Icons2 = adapter.Icons) === null || _adapter$Icons2 === void 0 ? void 0 : _adapter$Icons2.FullscreenExit) || IconFullscreenExit : ((_adapter$Icons3 = adapter.Icons) === null || _adapter$Icons3 === void 0 ? void 0 : _adapter$Icons3.Fullscreen) || IconFullscreen;
      return /*#__PURE__*/React__default.createElement(Button, {
        icon: /*#__PURE__*/React__default.createElement(FullscreenIcon, null),
        onClick: function onClick() {
  ...
  if (typeof renderShell === 'function') {
    var children = typeof render === 'function' ? render(collection, renderContext) : null;
    return renderShell(_extends({
      children: children
    }, shellContext));
  }
  ...
  if (fullscreen) {
    ...
    var defaultOverlayContentStyle = {
      position: 'relative',
      width: '100%',
      height: '100%',
      overflowY: 'auto',
    ...
    return /*#__PURE__*/React__default.createElement(Overlay, {
      ...
      overlayStyle: overlayStyleProp != null ? overlayStyleProp : defaultOverlayStyle,
      overlayBackdropStyle: overlayBackdropStyle != null ? overlayBackdropStyle : defaultOverlayBackdropStyle,
      contentStyle: overlayContentStyle != null ? overlayContentStyle : defaultOverlayContentStyle,
...
var _excluded$b = ["value", "onChange", "placeholder", "disabled", "type"],
  _excluded2$8 = ["value", "onChange", "placeholder", "disabled", "rows"],
  _excluded3$5 = ["value", "onChange", "min", "max", "step", "disabled"],
  _excluded4$3 = ["value", "onChange", "options", "disabled", "multiple", "searchable"],
  _excluded5$3 = ["checked", "onChange", "label", "disabled"],
  _excluded6$3 = ["value", "onChange", "options", "disabled"],
  _excluded7$3 = ["checked", "onChange", "label", "disabled"],
  _excluded8$2 = ["value", "onChange", "format", "disabled"],
  _excluded9$2 = ["value", "onChange", "format", "disabled"],
  _excluded0$2 = ["value", "onChange", "format", "disabled"],
  _excluded1$1 = ["value", "onChange", "min", "max", "step", "disabled"],
  _excluded10$1 = ["value", "onChange", "accept", "multiple", "disabled"],
  _excluded11$1 = ["value", "onChange", "count", "disabled", "allowHalf"],
  _excluded12$1 = ["value", "onChange", "disabled"],
  _excluded13$1 = ["dataSource", "columns", "loading", "pagination", "onChange", "rowKey"],
  _excluded14 = ["dataSource", "renderItem", "loading"],
  _excluded15 = ["title", "extra", "children"],
  _excluded16 = ["src", "alt", "width", "height"],
  _excluded17 = ["onFinish", "children"],
  _excluded18 = ["label", "name", "required", "help", "children"],
  _excluded19 = ["visible", "open", "onClose", "title", "children", "footer", "width"],
  _excluded20 = ["visible", "open", "onClose", "title", "placement", "children", "width"],
  _excluded21 = ["activeKey", "onChange", "items", "children"],
  _excluded22 = ["type", "children"],
  _excluded23 = ["direction", "size", "children"],
  _excluded24 = ["onClick", "type", "children", "disabled", "loading"],
  _excluded25 = ["menu", "children", "trigger"],
  _excluded26 = ["title", "children"],
  _excluded27 = ["current", "total", "pageSize", "onChange"],
  _excluded28 = ["spinning", "children", "size"],
  _excluded29 = ["description"],
  _excluded30 = ["color", "onClose", "closable", "children"],
  _excluded31 = ["count", "dot", "children"];
var MaterialUIAdapter = /*#__PURE__*/function (_UIAdapter) {
  function MaterialUIAdapter() {
    var _this;
    _this = _UIAdapter.call(this) || this;
    _this.Input = function (_ref) {
      var value = _ref.value,
    ...
    _this.TextArea = function (_ref2) {
      ...
      return /*#__PURE__*/React__default.createElement(material.TextField, _extends({
        value: value || '',
        onChange: function onChange(e) {
          return _onChange2 === null || _onChange2 === void 0 ? void 0 : _onChange2(e.target.value);
        },
        placeholder: placeholder,
        disabled: disabled,
        multiline: true,
    ...
    _this.InputNumber = function (_ref3) {
      var value = _ref3.value,
      ...
      return /*#__PURE__*/React__default.createElement(material.TextField, _extends({
        ...
        onChange: function onChange(e) {
          var val = e.target.value === '' ? undefined : Number(e.target.value);
          _onChange3 === null || _onChange3 === void 0 ? void 0 : _onChange3(val);
        },
        disabled: disabled,
        fullWidth: true,
        variant: "outlined",
    ...
    _this.Select = function (_ref4) {
      ...
      return /*#__PURE__*/React__default.createElement(material.FormControl, {
        ...
        size: "small",
        disabled: disabled
      }, props.label && /*#__PURE__*/React__default.createElement(material.InputLabel, null, props.label), /*#__PURE__*/React__default.createElement(material.Select, _extends({
        value: value != null ? value : multiple ? [] : '',
        onChange: function onChange(e) {
          return _onChange4 === null || _onChange4 === void 0 ? void 0 : _onChange4(e.target.value);
        },
        multiple: multiple,
        label: props.label
    ...
    _this.Checkbox = function (_ref5) {
      var checked = _ref5.checked,
        _onChange5 = _ref5.onChange,
        label = _ref5.label,
        disabled = _ref5.disabled,
        props = _objectWithoutPropertiesLoose(_ref5, _excluded5$3);
      var checkbox = /*#__PURE__*/React__default.createElement(material.Checkbox, _extends({
        checked: !!checked,
        onChange: function onChange(e) {
          return _onChange5 === null || _onChange5 === void 0 ? void 0 : _onChange5(e.target.checked);
        },
        disabled: disabled
      }, props));
      if (label) {
    ...
    _this.Radio = function (_ref6) {
      ...
      return /*#__PURE__*/React__default.createElement(material.RadioGroup, _extends({
        value: value != null ? value : '',
        onChange: function onChange(e) {
          return _onChange6 === null || _onChange6 === void 0 ? void 0 : _onChange6(e.target.value);
        }
      }, props), options.map(function (option) {
        return /*#__PURE__*/React__default.createElement(material.FormControlLabel, {
          key: option.value,
    ...
    _this.Switch = function (_ref7) {
      var checked = _ref7.checked,
        _onChange7 = _ref7.onChange,
        label = _ref7.label,
        disabled = _ref7.disabled,
        props = _objectWithoutPropertiesLoose(_ref7, _excluded7$3);
      var switchComponent = /*#__PURE__*/React__default.createElement(material.Switch, _extends({
        checked: !!checked,
        onChange: function onChange(e) {
          return _onChange7 === null || _onChange7 === void 0 ? void 0 : _onChange7(e.target.checked);
        },
        disabled: disabled
      }, props));
      if (label) {
    ...
    _this.DatePicker = function (_ref8) {
      var value = _ref8.value,
        _onChange8 = _ref8.onChange,
        _ref8$format = _ref8.format,
        format = _ref8$format === void 0 ? 'YYYY-MM-DD' : _ref8$format,
        disabled = _ref8.disabled,
        props = _objectWithoutPropertiesLoose(_ref8, _excluded8$2);
      ...
      }, /*#__PURE__*/React__default.createElement(xDatePickers.DatePicker, _extends({
        value: value ? dayjs_min(value) : null,
        onChange: function onChange(newValue) {
          return _onChange8 === null || _onChange8 === void 0 ? void 0 : _onChange8(newValue);
        },
        format: format,
        disabled: disabled,
        slotProps: {
    ...
    _this.TimePicker = function (_ref9) {
      var value = _ref9.value,
        _onChange9 = _ref9.onChange,
        _ref9$format = _ref9.format,
        format = _ref9$format === void 0 ? 'HH:mm:ss' : _ref9$format,
        disabled = _ref9.disabled,
        props = _objectWithoutPropertiesLoose(_ref9, _excluded9$2);
      return /*#__PURE__*/React__default.createElement(LocalizationProvider.LocalizationProvider, {
        dateAdapter: AdapterDayjs.AdapterDayjs
      }, /*#__PURE__*/React__default.createElement(xDatePickers.TimePicker, _extends({
        value: value ? dayjs_min(value) : null,
        onChange: function onChange(newValue) {
          return _onChange9 === null || _onChange9 === void 0 ? void 0 : _onChange9(newValue);
        },
        format: format,
        disabled: disabled,
        slotProps: {
    ...
    _this.RangePicker = function (_ref0) {
      var value = _ref0.value,
        _onChange0 = _ref0.onChange,
        _ref0$format = _ref0.format,
        format = _ref0$format === void 0 ? 'YYYY-MM-DD' : _ref0$format,
        disabled = _ref0.disabled,
        props = _objectWithoutPropertiesLoose(_ref0, _excluded0$2);
      var _ref1 = value || [null, null],
        start = _ref1[0],
        end = _ref1[1];
      return /*#__PURE__*/React__default.createElement(LocalizationProvider.LocalizationProvider, {
        dateAdapter: AdapterDayjs.AdapterDayjs
        ...
        label: "Start Date",
        value: start ? dayjs_min(start) : null,
        onChange: function onChange(newValue) {
          return _onChange0 === null || _onChange0 === void 0 ? void 0 : _onChange0([newValue, end]);
        },
        format: format,
        disabled: disabled,
        slotProps: {
      ...
      }, props)), /*#__PURE__*/React__default.createElement(xDatePickers.DatePicker, _extends({
        label: "End Date",
        value: end ? dayjs_min(end) : null,
        onChange: function onChange(newValue) {
          return _onChange0 === null || _onChange0 === void 0 ? void 0 : _onChange0([start, newValue]);
        },
        format: format,
        disabled: disabled,
        slotProps: {
    ...
    _this.Slider = function (_ref10) {
      var value = _ref10.value,
        _onChange1 = _ref10.onChange,
        ...
        props = _objectWithoutPropertiesLoose(_ref10, _excluded1$1);
      return /*#__PURE__*/React__default.createElement(material.Slider, _extends({
        value: value != null ? value : min,
        onChange: function onChange(e, newValue) {
          return _onChange1 === null || _onChange1 === void 0 ? void 0 : _onChange1(newValue);
        },
        min: min,
        max: max,
        step: step,
    ...
    _this.Upload = function (_ref11) {
      var _onChange10 = _ref11.onChange,
        accept = _ref11.accept,
        multiple = _ref11.multiple,
        disabled = _ref11.disabled,
        props = _objectWithoutPropertiesLoose(_ref11, _excluded10$1);
      return /*#__PURE__*/React__default.createElement(material.Button, _extends({
        variant: "outlined",
        component: "label",
        disabled: disabled,
        fullWidth: true
      }, props), "Upload File", /*#__PURE__*/React__default.createElement("input", {
        type: "file",
        hidden: true,
        accept: accept,
        multiple: multiple,
        onChange: function onChange(e) {
          ...
          _onChange10 === null || _onChange10 === void 0 ? void 0 : _onChange10(files);
        }
      }));
    };
    _this.Dragger = _this.Upload;
    _this.Rate = function (_ref12) {
      var value = _ref12.value,
        _onChange11 = _ref12.onChange,
        _ref12$count = _ref12.count,
        count = _ref12$count === void 0 ? 5 : _ref12$count,
        disabled = _ref12.disabled,
        allowHalf = _ref12.allowHalf,
        props = _objectWithoutPropertiesLoose(_ref12, _excluded11$1);
      return /*#__PURE__*/React__default.createElement(material.Rating, _extends({
        value: value != null ? value : 0,
        onChange: function onChange(e, newValue) {
          return _onChange11 === null || _onChange11 === void 0 ? void 0 : _onChange11(newValue);
        },
        max: count,
        disabled: disabled,
    ...
    _this.ColorPicker = function (_ref13) {
      var value = _ref13.value,
        _onChange12 = _ref13.onChange,
        disabled = _ref13.disabled,
        props = _objectWithoutPropertiesLoose(_ref13, _excluded12$1);
      return /*#__PURE__*/React__default.createElement(material.TextField, _extends({
        type: "color",
        value: value || '#000000',
        onChange: function onChange(e) {
          return _onChange12 === null || _onChange12 === void 0 ? void 0 : _onChange12(e.target.value);
        },
        disabled: disabled,
        fullWidth: true,
        size: "small"
    ...
    _this.Table = function (_ref14) {
      var _ref14$dataSource = _ref14.dataSource,
        dataSource = _ref14$dataSource === void 0 ? [] : _ref14$dataSource,
        ...
        _ref14$rowKey = _ref14.rowKey,
        rowKey = _ref14$rowKey === void 0 ? 'id' : _ref14$rowKey,
        props = _objectWithoutPropertiesLoose(_ref14, _excluded13$1);
      return /*#__PURE__*/React__default.createElement(material.TableContainer, null, /*#__PURE__*/React__default.createElement(material.Table, _extends({
        size: "small"
      }, props), /*#__PURE__*/React__default.createElement(material.TableHead, null, /*#__PURE__*/React__default.createElement(material.TableRow, null, columns.map(function (col) {
        return /*#__PURE__*/React__default.createElement(material.TableCell, {
          key: col.key || col.dataIndex
        }, col.title);
      }))), /*#__PURE__*/React__default.createElement(material.TableBody, null, dataSource.map(function (row, index) {
      ...
      }))), pagination && /*#__PURE__*/React__default.createElement(material.TablePagination, {
        component: "div",
        count: pagination.total || 0,
        page: (pagination.current || 1) - 1,
        rowsPerPage: pagination.pageSize || 10,
        onPageChange: function onPageChange(e, page) {
          onChange === null || onChange === void 0 ? void 0 : onChange(_extends({}, pagination, {
            current: page + 1
          }), {}, {});
        },
    ...
    _this.List = function (_ref15) {
      var _ref15$dataSource = _ref15.dataSource,
        dataSource = _ref15$dataSource === void 0 ? [] : _ref15$dataSource,
        renderItem = _ref15.renderItem,
        props = _objectWithoutPropertiesLoose(_ref15, _excluded14);
      return /*#__PURE__*/React__default.createElement(material.List, props, dataSource.map(function (item, index) {
        return /*#__PURE__*/React__default.createElement(material.ListItem, {
          key: index
        }, renderItem ? renderItem(item, index) : /*#__PURE__*/React__default.createElement(material.ListItemText, {
          primary: JSON.stringify(item)
        }));
      }));
    };
    _this.Card = function (_ref16) {
      var title = _ref16.title,
        extra = _ref16.extra,
        children = _ref16.children,
        props = _objectWithoutPropertiesLoose(_ref16, _excluded15);
      return /*#__PURE__*/React__default.createElement(material.Card, props, title && /*#__PURE__*/React__default.createElement(material.CardHeader, {
        title: title,
        action: extra
      }), /*#__PURE__*/React__default.createElement(material.CardContent, null, children));
    };
    _this.Image = function (_ref17) {
      var src = _ref17.src,
        alt = _ref17.alt,
        width = _ref17.width,
    ...
    _this.Form = function (_ref18) {
      var onFinish = _ref18.onFinish,
        children = _ref18.children,
        props = _objectWithoutPropertiesLoose(_ref18, _excluded17);
      return /*#__PURE__*/React__default.createElement(material.Box, _extends({
        component: "form",
        onSubmit: function onSubmit(e) {
          e.preventDefault();
          onFinish === null || onFinish === void 0 ? void 0 : onFinish(new FormData(e.target));
        }
      }, props), children);
    };
    _this.FormItem = function (_ref19) {
      ...
      return /*#__PURE__*/React__default.createElement(material.FormControl, _extends({
        ...
        margin: "normal",
        required: required
      }, props), label && /*#__PURE__*/React__default.createElement(material.InputLabel, {
        shrink: true
      }, label), children, help && /*#__PURE__*/React__default.createElement(material.FormHelperText, null, help));
    };
    _this.Modal = function (_ref20) {
      var _ref21;
      var visible = _ref20.visible,
        ...
        footer = _ref20.footer,
        width = _ref20.width,
        props = _objectWithoutPropertiesLoose(_ref20, _excluded19);
      return /*#__PURE__*/React__default.createElement(material.Dialog, _extends({
        open: (_ref21 = visible != null ? visible : open) != null ? _ref21 : false,
        onClose: onClose,
      ...
      }, props), title && /*#__PURE__*/React__default.createElement(material.DialogTitle, null, title), /*#__PURE__*/React__default.createElement(material.DialogContent, null, children), footer && /*#__PURE__*/React__default.createElement(material.DialogActions, null, footer));
    };
    _this.Drawer = function (_ref22) {
      var _ref23;
      var visible = _ref22.visible,
        open = _ref22.open,
        onClose = _ref22.onClose,
        title = _ref22.title,
        _ref22$placement = _ref22.placement,
        placement = _ref22$placement === void 0 ? 'right' : _ref22$placement,
        children = _ref22.children,
        width = _ref22.width,
        props = _objectWithoutPropertiesLoose(_ref22, _excluded20);
      return /*#__PURE__*/React__default.createElement(material.Drawer, _extends({
        open: (_ref23 = visible != null ? visible : open) != null ? _ref23 : false,
        onClose: onClose,
        anchor: placement,
        PaperProps: {
          sx: {
      ...
      }, props), title && /*#__PURE__*/React__default.createElement(material.Box, {
        sx: {
          p: 2,
          borderBottom: 1,
          borderColor: 'divider'
    ...
    _this.Tabs = function (_ref24) {
      var _items$value;
      var activeKey = _ref24.activeKey,
        onChange = _ref24.onChange,
        _ref24$items = _ref24.items,
        items = _ref24$items === void 0 ? [] : _ref24$items,
        props = _objectWithoutPropertiesLoose(_ref24, _excluded21);
      var _React$useState = React__default.useState(activeKey || 0),
      ...
      return /*#__PURE__*/React__default.createElement(material.Box, null, /*#__PURE__*/React__default.createElement(material.Tabs, _extends({
        value: value,
        onChange: handleChange
      }, props), items.map(function (item, index) {
        return /*#__PURE__*/React__default.createElement(material.Tab, {
          key: item.key || index,
          label: item.label
        });
      })), (_items$value = items[value]) === null || _items$value === void 0 ? void 0 : _items$value.children);
    };
    _this.TabPane = null;
    _this.Divider = function (_ref25) {
      var _ref25$type = _ref25.type,
        type = _ref25$type === void 0 ? 'horizontal' : _ref25$type,
        children = _ref25.children,
        props = _objectWithoutPropertiesLoose(_ref25, _excluded22);
      return /*#__PURE__*/React__default.createElement(material.Divider, _extends({
        orientation: type === 'vertical' ? 'vertical' : 'horizontal'
      }, props), children);
    };
    _this.Space = function (_ref26) {
      var _ref26$direction = _ref26.direction,
        direction = _ref26$direction === void 0 ? 'horizontal' : _ref26$direction,
        _ref26$size = _ref26.size,
        size = _ref26$size === void 0 ? 2 : _ref26$size,
        children = _ref26.children,
        props = _objectWithoutPropertiesLoose(_ref26, _excluded23);
      return /*#__PURE__*/React__default.createElement(material.Stack, _extends({
        direction: direction === 'vertical' ? 'column' : 'row',
        spacing: size
      }, props), children);
    };
    _this.Button = function (_ref27) {
      var onClick = _ref27.onClick,
        _ref27$type = _ref27.type,
        type = _ref27$type === void 0 ? 'default' : _ref27$type,
        children = _ref27.children,
        disabled = _ref27.disabled,
        loading = _ref27.loading,
        props = _objectWithoutPropertiesLoose(_ref27, _excluded24);
      var variantMap = {
        primary: 'contained',
        "default": 'outlined',
        text: 'text',
      ...
      }, props), loading && /*#__PURE__*/React__default.createElement(material.CircularProgress, {
        size: 20,
        sx: {
          mr: 1
        }
    ...
    _this.Dropdown = function (_ref28) {
      var _menu$items;
      var menu = _ref28.menu,
        children = _ref28.children,
        props = _objectWithoutPropertiesLoose(_ref28, _excluded25);
      var _React$useState2 = React__default.useState(null),
        anchorEl = _React$useState2[0],
        setAnchorEl = _React$useState2[1];
      return /*#__PURE__*/React__default.createElement(Fragment, null, /*#__PURE__*/React__default.createElement("span", {
        onClick: function onClick(e) {
          return setAnchorEl(e.currentTarget);
        }
      }, children), /*#__PURE__*/React__default.createElement(material.Menu, _extends({
        anchorEl: anchorEl,
        open: Boolean(anchorEl),
        onClose: function onClose() {
          return setAnchorEl(null);
        }
      }, props), menu === null || menu === void 0 ? void 0 : (_menu$items = menu.items) === null || _menu$items === void 0 ? void 0 : _menu$items.map(function (item, index) {
        return /*#__PURE__*/React__default.createElement(material.MenuItem, {
          key: index,
          onClick: function onClick() {
            var _item$onClick;
    ...
    _this.Tooltip = function (_ref29) {
      var title = _ref29.title,
        children = _ref29.children,
        props = _objectWithoutPropertiesLoose(_ref29, _excluded26);
    ...
    _this.Pagination = function (_ref30) {
      var current = _ref30.current,
        total = _ref30.total,
        pageSize = _ref30.pageSize,
        onChange = _ref30.onChange,
        props = _objectWithoutPropertiesLoose(_ref30, _excluded27);
      return /*#__PURE__*/React__default.createElement(material.TablePagination, _extends({
        component: "div",
        count: total || 0,
        page: (current || 1) - 1,
        rowsPerPage: pageSize || 10,
        onPageChange: function onPageChange(e, page) {
          return onChange === null || onChange === void 0 ? void 0 : onChange(page + 1, pageSize);
        },
        onRowsPerPageChange: function onRowsPerPageChange(e) {
          return onChange === null || onChange === void 0 ? void 0 : onChange(1, parseInt(e.target.value, 10));
        }
      }, props));
    };
    _this.Spin = function (_ref31) {
      var _ref31$spinning = _ref31.spinning,
        spinning = _ref31$spinning === void 0 ? true : _ref31$spinning,
        children = _ref31.children,
        _ref31$size = _ref31.size,
        size = _ref31$size === void 0 ? 40 : _ref31$size,
        props = _objectWithoutPropertiesLoose(_ref31, _excluded28);
      ...
      }, /*#__PURE__*/React__default.createElement(material.CircularProgress, _extends({
        size: size
      }, props)), children);
    };
    _this.Empty = function (_ref32) {
      var _ref32$description = _ref32.description,
        description = _ref32$description === void 0 ? 'No Data' : _ref32$description,
        props = _objectWithoutPropertiesLoose(_ref32, _excluded29);
      return /*#__PURE__*/React__default.createElement(material.Box, _extends({
        sx: {
          textAlign: 'center',
          p: 4,
    ...
    _this.Tag = function (_ref33) {
      var color = _ref33.color,
        onClose = _ref33.onClose,
        closable = _ref33.closable,
        children = _ref33.children,
        props = _objectWithoutPropertiesLoose(_ref33, _excluded30);
      return /*#__PURE__*/React__default.createElement(material.Chip, _extends({
        label: children,
        color: color,
    ...
    _this.Badge = function (_ref34) {
      var count = _ref34.count,
        dot = _ref34.dot,
        children = _ref34.children,
        props = _objectWithoutPropertiesLoose(_ref34, _excluded31);
      return /*#__PURE__*/React__default.createElement(material.Badge, _extends({
        badgeContent: dot ? '●' : count,
        color: "error"
      }, props), children);
    };
    _this.adapterName = 'material-ui';
    return _this;
  }
  _inheritsLoose(MaterialUIAdapter, _UIAdapter);
  var _proto = MaterialUIAdapter.prototype;
  _proto.getType = function getType() {
    return 'material-ui';
  };
  _proto.isMobile = function isMobile() {
...
var _excluded$c = ["value", "onChange", "placeholder", "disabled", "type", "maxLength"],
  _excluded2$9 = ["value", "onChange", "placeholder", "disabled", "rows", "maxLength"],
  _excluded3$6 = ["value", "onChange", "placeholder", "disabled", "min", "max", "step"],
  _excluded4$4 = ["value", "onChange", "options", "disabled", "placeholder", "multiple"],
  _excluded5$4 = ["value", "onChange", "disabled", "children"],
  _excluded6$4 = ["value", "onChange", "options", "disabled"],
  _excluded7$4 = ["value", "onChange", "disabled", "children"],
  _excluded8$3 = ["value", "onChange", "disabled", "format"],
  _excluded9$3 = ["value", "onChange", "disabled"],
  _excluded0$3 = ["value", "onChange", "disabled"],
  _excluded1$2 = ["value", "onChange", "min", "max", "step", "disabled"],
  _excluded10$2 = ["onChange", "disabled", "accept", "multiple", "children"],
  _excluded11$2 = ["value", "onChange", "count", "disabled"],
  _excluded12$2 = ["value", "onChange", "disabled"],
  _excluded13$2 = ["columns", "dataSource", "loading", "pagination", "onChange"],
  _excluded14$1 = ["dataSource", "renderItem"],
  _excluded15$1 = ["title", "children", "extra"],
  _excluded16$1 = ["src", "alt"],
  _excluded17$1 = ["visible", "onClose", "title", "children", "footer", "width"],
  _excluded18$1 = ["visible", "onClose", "title", "children", "placement", "width"],
  _excluded19$1 = ["items", "activeKey", "onChange"],
  _excluded20$1 = ["orientation"],
  _excluded21$1 = ["direction", "size", "children"],
  _excluded22$1 = ["type", "children", "onClick", "disabled", "loading", "icon"],
  _excluded23$1 = ["items", "children"],
  _excluded24$1 = ["title", "children"],
  _excluded25$1 = ["current", "total", "pageSize", "onChange"],
  _excluded26$1 = ["spinning", "children"],
  _excluded27$1 = ["description"],
  _excluded28$1 = ["children", "closable", "onClose", "color"],
  _excluded29$1 = ["count", "children", "dot"];
var ChakraUIAdapter = /*#__PURE__*/function (_UIAdapter) {
  function ChakraUIAdapter() {
    var _this;
    _this = _UIAdapter.call(this) || this;
    _this.adapterName = 'ChakraUIAdapter';
    _this.loadChakraComponents();
    return _this;
  }
  _inheritsLoose(ChakraUIAdapter, _UIAdapter);
  var _proto = ChakraUIAdapter.prototype;
  _proto.loadChakraComponents = function loadChakraComponents() {
    try {
      var _this2 = this;
      var _temp = _catch(function () {
        return Promise.resolve(new Promise(function (resolve) { resolve(_interopNamespace(require('@chakra-ui/react'))); })).then(function (chakra) {
          _this2.Input = function (_ref) {
            var value = _ref.value,
              _onChange = _ref.onChange,
              placeholder = _ref.placeholder,
              disabled = _ref.disabled,
            ...
            return /*#__PURE__*/React__default.createElement(chakra.Input, _extends({
              value: value || '',
              onChange: function onChange(e) {
                return _onChange === null || _onChange === void 0 ? void 0 : _onChange(e.target.value);
              },
          ...
          _this2.TextArea = function (_ref2) {
            var value = _ref2.value,
              _onChange2 = _ref2.onChange,
              placeholder = _ref2.placeholder,
              disabled = _ref2.disabled,
            ...
            return /*#__PURE__*/React__default.createElement(chakra.Textarea, _extends({
              value: value || '',
              onChange: function onChange(e) {
                return _onChange2 === null || _onChange2 === void 0 ? void 0 : _onChange2(e.target.value);
              },
          ...
          _this2.InputNumber = function (_ref3) {
            var value = _ref3.value,
              _onChange3 = _ref3.onChange,
              ...
              props = _objectWithoutPropertiesLoose(_ref3, _excluded3$6);
            return /*#__PURE__*/React__default.createElement(chakra.NumberInput, _extends({
              value: value != null ? value : '',
              onChange: function onChange(valueString, valueNumber) {
                return _onChange3 === null || _onChange3 === void 0 ? void 0 : _onChange3(valueNumber);
              },
              min: min,
              max: max,
              step: step,
              isDisabled: disabled,
              size: "md"
            }, props), /*#__PURE__*/React__default.createElement(chakra.NumberInputField, {
              placeholder: placeholder
            }), /*#__PURE__*/React__default.createElement(chakra.NumberInputStepper, null, /*#__PURE__*/React__default.createElement(chakra.NumberIncrementStepper, null), /*#__PURE__*/React__default.createElement(chakra.NumberDecrementStepper, null)));
          };
          _this2.Select = function (_ref4) {
            var value = _ref4.value,
              _onChange4 = _ref4.onChange,
              _ref4$options = _ref4.options,
              options = _ref4$options === void 0 ? [] : _ref4$options,
            ...
            if (multiple) {
              return /*#__PURE__*/React__default.createElement(chakra.Select, _extends({
                value: value || [],
                onChange: function onChange(e) {
                  var selectedOptions = Array.from(e.target.selectedOptions, function (option) {
                    return option.value;
                  });
                  _onChange4 === null || _onChange4 === void 0 ? void 0 : _onChange4(selectedOptions);
                },
                isDisabled: disabled,
                placeholder: placeholder,
                multiple: true,
          ...
          _this2.Checkbox = function (_ref5) {
            var value = _ref5.value,
              _onChange5 = _ref5.onChange,
              disabled = _ref5.disabled,
              children = _ref5.children,
              props = _objectWithoutPropertiesLoose(_ref5, _excluded5$4);
            return /*#__PURE__*/React__default.createElement(chakra.Checkbox, _extends({
              isChecked: !!value,
              onChange: function onChange(e) {
                return _onChange5 === null || _onChange5 === void 0 ? void 0 : _onChange5(e.target.checked);
              },
          ...
          _this2.Radio = function (_ref6) {
            ...
            return /*#__PURE__*/React__default.createElement(chakra.RadioGroup, _extends({
              value: value != null ? value : '',
              onChange: onChange,
              isDisabled: disabled
            }, props), /*#__PURE__*/React__default.createElement(chakra.Stack, {
              direction: "column",
              spacing: 2
            }, options.map(function (option) {
              return /*#__PURE__*/React__default.createElement(chakra.Radio, {
                key: option.value,
                value: option.value
              }, option.label);
            })));
          };
          _this2.Switch = function (_ref7) {
            var value = _ref7.value,
              _onChange6 = _ref7.onChange,
              disabled = _ref7.disabled,
              children = _ref7.children,
              props = _objectWithoutPropertiesLoose(_ref7, _excluded7$4);
            return /*#__PURE__*/React__default.createElement(chakra.FormControl, {
              display: "flex",
              alignItems: "center"
            }, /*#__PURE__*/React__default.createElement(chakra.Switch, _extends({
              isChecked: !!value,
              onChange: function onChange(e) {
                return _onChange6 === null || _onChange6 === void 0 ? void 0 : _onChange6(e.target.checked);
              },
              isDisabled: disabled,
              size: "md"
            }, props)), children && /*#__PURE__*/React__default.createElement(chakra.FormLabel, {
              ml: 2,
              mb: 0
            }, children));
          };
          _this2.DatePicker = function (_ref8) {
            var value = _ref8.value,
              _onChange7 = _ref8.onChange,
              disabled = _ref8.disabled,
              _ref8$format = _ref8.format,
              format = _ref8$format === void 0 ? 'YYYY-MM-DD' : _ref8$format,
              props = _objectWithoutPropertiesLoose(_ref8, _excluded8$3);
            var dateValue = value ? new Date(value).toISOString().split('T')[0] : '';
            return /*#__PURE__*/React__default.createElement(chakra.Input, _extends({
              type: "date",
              value: dateValue,
              onChange: function onChange(e) {
                return _onChange7 === null || _onChange7 === void 0 ? void 0 : _onChange7(e.target.value);
              },
              isDisabled: disabled,
              size: "md"
            }, props));
          };
          _this2.TimePicker = function (_ref9) {
            var value = _ref9.value,
              _onChange8 = _ref9.onChange,
              disabled = _ref9.disabled,
              props = _objectWithoutPropertiesLoose(_ref9, _excluded9$3);
            return /*#__PURE__*/React__default.createElement(chakra.Input, _extends({
              type: "time",
              value: value || '',
              onChange: function onChange(e) {
                return _onChange8 === null || _onChange8 === void 0 ? void 0 : _onChange8(e.target.value);
              },
              isDisabled: disabled,
              size: "md"
            }, props));
          };
          _this2.RangePicker = function (_ref0) {
            var _ref0$value = _ref0.value,
              value = _ref0$value === void 0 ? [] : _ref0$value,
              _onChange9 = _ref0.onChange,
              disabled = _ref0.disabled,
              props = _objectWithoutPropertiesLoose(_ref0, _excluded0$3);
            var start = value[0],
              end = value[1];
            return /*#__PURE__*/React__default.createElement(chakra.HStack, _extends({
              spacing: 2
            }, props), /*#__PURE__*/React__default.createElement(chakra.Input, {
              type: "date",
              value: start ? new Date(start).toISOString().split('T')[0] : '',
              onChange: function onChange(e) {
                return _onChange9 === null || _onChange9 === void 0 ? void 0 : _onChange9([e.target.value, end]);
              },
              isDisabled: disabled,
              placeholder: "Start date",
              size: "md"
            }), /*#__PURE__*/React__default.createElement(chakra.Text, null, "to"), /*#__PURE__*/React__default.createElement(chakra.Input, {
              type: "date",
              value: end ? new Date(end).toISOString().split('T')[0] : '',
              onChange: function onChange(e) {
                return _onChange9 === null || _onChange9 === void 0 ? void 0 : _onChange9([start, e.target.value]);
              },
              isDisabled: disabled,
          ...
          _this2.Slider = function (_ref1) {
            var value = _ref1.value,
              onChange = _ref1.onChange,
              _ref1$min = _ref1.min,
              min = _ref1$min === void 0 ? 0 : _ref1$min,
              _ref1$max = _ref1.max,
              max = _ref1$max === void 0 ? 100 : _ref1$max,
              _ref1$step = _ref1.step,
              step = _ref1$step === void 0 ? 1 : _ref1$step,
              disabled = _ref1.disabled,
              props = _objectWithoutPropertiesLoose(_ref1, _excluded1$2);
            return /*#__PURE__*/React__default.createElement(chakra.Slider, _extends({
              value: value != null ? value : min,
              onChange: onChange,
              min: min,
              max: max,
              step: step,
              isDisabled: disabled
            }, props), /*#__PURE__*/React__default.createElement(chakra.SliderTrack, null, /*#__PURE__*/React__default.createElement(chakra.SliderFilledTrack, null)), /*#__PURE__*/React__default.createElement(chakra.SliderThumb, null));
          };
          _this2.Upload = function (_ref10) {
            var _onChange0 = _ref10.onChange,
              disabled = _ref10.disabled,
              accept = _ref10.accept,
              multiple = _ref10.multiple,
              children = _ref10.children,
              props = _objectWithoutPropertiesLoose(_ref10, _excluded10$2);
            var inputRef = React__default.useRef(null);
            return /*#__PURE__*/React__default.createElement(chakra.Box, props, /*#__PURE__*/React__default.createElement(chakra.Input, {
              ref: inputRef,
              type: "file",
              onChange: function onChange(e) {
                return _onChange0 === null || _onChange0 === void 0 ? void 0 : _onChange0(e.target.files);
              },
              disabled: disabled,
              accept: accept,
              multiple: multiple,
              display: "none"
            }), /*#__PURE__*/React__default.createElement(chakra.Button, {
              onClick: function onClick() {
                var _inputRef$current;
                return (_inputRef$current = inputRef.current) === null || _inputRef$current === void 0 ? void 0 : _inputRef$current.click();
              },
              isDisabled: disabled,
              leftIcon: /*#__PURE__*/React__default.createElement(chakra.Icon, {
                as: function as() {
                  return '📁';
                }
              }),
          ...
          _this2.Dragger = _this2.Upload;
          _this2.Rate = function (_ref11) {
            var _ref11$value = _ref11.value,
              value = _ref11$value === void 0 ? 0 : _ref11$value,
              onChange = _ref11.onChange,
              _ref11$count = _ref11.count,
              count = _ref11$count === void 0 ? 5 : _ref11$count,
              disabled = _ref11.disabled,
              props = _objectWithoutPropertiesLoose(_ref11, _excluded11$2);
            return /*#__PURE__*/React__default.createElement(chakra.HStack, _extends({
              spacing: 1
            }, props), Array.from({
              length: count
            }, function (_, index) {
              return /*#__PURE__*/React__default.createElement(chakra.Icon, {
                key: index,
                as: function as() {
                  return index < value ? '⭐' : '☆';
                },
                ...
                onClick: function onClick() {
                  return !disabled && (onChange === null || onChange === void 0 ? void 0 : onChange(index + 1));
                }
              });
            }));
          };
          _this2.ColorPicker = function (_ref12) {
            var value = _ref12.value,
              _onChange1 = _ref12.onChange,
              disabled = _ref12.disabled,
              props = _objectWithoutPropertiesLoose(_ref12, _excluded12$2);
            return /*#__PURE__*/React__default.createElement(chakra.Input, _extends({
              type: "color",
              value: value || '#000000',
              onChange: function onChange(e) {
                return _onChange1 === null || _onChange1 === void 0 ? void 0 : _onChange1(e.target.value);
              },
              isDisabled: disabled,
              size: "md",
              width: "100px"
          ...
          _this2.Table = function (_ref13) {
            var _ref13$columns = _ref13.columns,
              columns = _ref13$columns === void 0 ? [] : _ref13$columns,
              _ref13$dataSource = _ref13.dataSource,
              dataSource = _ref13$dataSource === void 0 ? [] : _ref13$dataSource,
              loading = _ref13.loading,
              pagination = _ref13.pagination,
              onChange = _ref13.onChange,
              props = _objectWithoutPropertiesLoose(_ref13, _excluded13$2);
            return /*#__PURE__*/React__default.createElement(chakra.Box, _extends({
              overflowX: "auto"
            }, props), /*#__PURE__*/React__default.createElement(chakra.Table, {
              variant: "simple"
            }, /*#__PURE__*/React__default.createElement(chakra.Thead, null, /*#__PURE__*/React__default.createElement(chakra.Tr, null, columns.map(function (col, index) {
              return /*#__PURE__*/React__default.createElement(chakra.Th, {
                key: col.key || index
              }, col.title);
            }))), /*#__PURE__*/React__default.createElement(chakra.Tbody, null, loading ? /*#__PURE__*/React__default.createElement(chakra.Tr, null, /*#__PURE__*/React__default.createElement(chakra.Td, {
              colSpan: columns.length,
              textAlign: "center"
            }, /*#__PURE__*/React__default.createElement(chakra.Spinner, null))) : dataSource.length === 0 ? /*#__PURE__*/React__default.createElement(chakra.Tr, null, /*#__PURE__*/React__default.createElement(chakra.Td, {
              colSpan: columns.length,
              textAlign: "center",
              color: "gray.500"
            }, "No data")) : dataSource.map(function (record, rowIndex) {
              return /*#__PURE__*/React__default.createElement(chakra.Tr, {
                key: record.id || rowIndex
              }, columns.map(function (col, colIndex) {
                return /*#__PURE__*/React__default.createElement(chakra.Td, {
                  key: col.key || colIndex
                }, col.render ? col.render(record[col.dataIndex], record, rowIndex) : record[col.dataIndex]);
              }));
            }))));
          };
          _this2.List = function (_ref14) {
            var _ref14$dataSource = _ref14.dataSource,
              dataSource = _ref14$dataSource === void 0 ? [] : _ref14$dataSource,
              renderItem = _ref14.renderItem,
              props = _objectWithoutPropertiesLoose(_ref14, _excluded14$1);
            return /*#__PURE__*/React__default.createElement(chakra.List, _extends({
              spacing: 2
            }, props), dataSource.map(function (item, index) {
              return /*#__PURE__*/React__default.createElement(chakra.ListItem, {
                key: item.id || index
              }, renderItem ? renderItem(item, index) : String(item));
            }));
          };
          _this2.Card = function (_ref15) {
            var title = _ref15.title,
              children = _ref15.children,
              extra = _ref15.extra,
              props = _objectWithoutPropertiesLoose(_ref15, _excluded15$1);
            return /*#__PURE__*/React__default.createElement(chakra.Card, props, title && /*#__PURE__*/React__default.createElement(chakra.CardHeader, {
              display: "flex",
              justifyContent: "space-between",
              alignItems: "center"
            }, /*#__PURE__*/React__default.createElement(chakra.Heading, {
              size: "md"
            }, title), extra), /*#__PURE__*/React__default.createElement(chakra.CardBody, null, children));
          };
          _this2.Image = function (_ref16) {
            var src = _ref16.src,
              alt = _ref16.alt,
              props = _objectWithoutPropertiesLoose(_ref16, _excluded16$1);
            return /*#__PURE__*/React__default.createElement(chakra.Image, _extends({
              src: src,
              alt: alt
            }, props));
          };
          _this2.Modal = function (_ref17) {
            var visible = _ref17.visible,
              onClose = _ref17.onClose,
              title = _ref17.title,
              children = _ref17.children,
              footer = _ref17.footer,
              width = _ref17.width,
              props = _objectWithoutPropertiesLoose(_ref17, _excluded17$1);
            return /*#__PURE__*/React__default.createElement(chakra.Modal, _extends({
              isOpen: visible,
              onClose: onClose,
              size: width ? 'full' : 'md'
            }, props), /*#__PURE__*/React__default.createElement(chakra.ModalOverlay, null), /*#__PURE__*/React__default.createElement(chakra.ModalContent, {
              maxWidth: width
            }, title && /*#__PURE__*/React__default.createElement(chakra.ModalHeader, null, title), /*#__PURE__*/React__default.createElement(chakra.ModalCloseButton, null), /*#__PURE__*/React__default.createElement(chakra.ModalBody, null, children), footer && /*#__PURE__*/React__default.createElement(chakra.ModalFooter, null, footer)));
          };
          _this2.Drawer = function (_ref18) {
            var visible = _ref18.visible,
              onClose = _ref18.onClose,
              title = _ref18.title,
              children = _ref18.children,
              _ref18$placement = _ref18.placement,
              placement = _ref18$placement === void 0 ? 'right' : _ref18$placement,
              width = _ref18.width,
              props = _objectWithoutPropertiesLoose(_ref18, _excluded18$1);
            return /*#__PURE__*/React__default.createElement(chakra.Drawer, _extends({
              isOpen: visible,
              onClose: onClose,
              placement: placement,
              size: width ? 'full' : 'md'
            }, props), /*#__PURE__*/React__default.createElement(chakra.DrawerOverlay, null), /*#__PURE__*/React__default.createElement(chakra.DrawerContent, {
              maxWidth: width
            }, /*#__PURE__*/React__default.createElement(chakra.DrawerCloseButton, null), title && /*#__PURE__*/React__default.createElement(chakra.DrawerHeader, null, title), /*#__PURE__*/React__default.createElement(chakra.DrawerBody, null, children)));
          };
          _this2.Tabs = function (_ref19) {
            var _ref19$items = _ref19.items,
              items = _ref19$items === void 0 ? [] : _ref19$items,
              activeKey = _ref19.activeKey,
              _onChange10 = _ref19.onChange,
              props = _objectWithoutPropertiesLoose(_ref19, _excluded19$1);
            var index = items.findIndex(function (item) {
              return item.key === activeKey;
            });
            return /*#__PURE__*/React__default.createElement(chakra.Tabs, _extends({
              index: index,
              onChange: function onChange(idx) {
                var _items$idx;
                return _onChange10 === null || _onChange10 === void 0 ? void 0 : _onChange10((_items$idx = items[idx]) === null || _items$idx === void 0 ? void 0 : _items$idx.key);
              }
            }, props), /*#__PURE__*/React__default.createElement(chakra.TabList, null, items.map(function (item) {
              return /*#__PURE__*/React__default.createElement(chakra.Tab, {
                key: item.key
              }, item.label);
            })), /*#__PURE__*/React__default.createElement(chakra.TabPanels, null, items.map(function (item) {
              return /*#__PURE__*/React__default.createElement(chakra.TabPanel, {
                key: item.key
              }, item.children);
            })));
          };
          _this2.Divider = function (_ref20) {
            var _ref20$orientation = _ref20.orientation,
              orientation = _ref20$orientation === void 0 ? 'horizontal' : _ref20$orientation,
              props = _objectWithoutPropertiesLoose(_ref20, _excluded20$1);
            return /*#__PURE__*/React__default.createElement(chakra.Divider, _extends({
              orientation: orientation
            }, props));
          };
          _this2.Space = function (_ref21) {
            var _ref21$direction = _ref21.direction,
              direction = _ref21$direction === void 0 ? 'horizontal' : _ref21$direction,
              _ref21$size = _ref21.size,
              size = _ref21$size === void 0 ? 'md' : _ref21$size,
              children = _ref21.children,
              props = _objectWithoutPropertiesLoose(_ref21, _excluded21$1);
            var spacing = size === 'small' ? 2 : size === 'large' ? 4 : 3;
            return /*#__PURE__*/React__default.createElement(chakra.Stack, _extends({
              direction: direction === 'horizontal' ? 'row' : 'column',
              spacing: spacing
            }, props), children);
          };
          _this2.Button = function (_ref22) {
            var _ref22$type = _ref22.type,
              type = _ref22$type === void 0 ? 'default' : _ref22$type,
              children = _ref22.children,
              onClick = _ref22.onClick,
              disabled = _ref22.disabled,
              loading = _ref22.loading,
              icon = _ref22.icon,
              props = _objectWithoutPropertiesLoose(_ref22, _excluded22$1);
            var colorScheme = type === 'primary' ? 'blue' : type === 'danger' ? 'red' : 'gray';
            var variant = type === 'default' ? 'outline' : 'solid';
            return /*#__PURE__*/React__default.createElement(chakra.Button, _extends({
          ...
          _this2.Dropdown = function (_ref23) {
            var _ref23$items = _ref23.items,
              items = _ref23$items === void 0 ? [] : _ref23$items,
              children = _ref23.children,
              props = _objectWithoutPropertiesLoose(_ref23, _excluded23$1);
            return /*#__PURE__*/React__default.createElement(chakra.Menu, props, /*#__PURE__*/React__default.createElement(chakra.MenuButton, {
              as: chakra.Button,
              rightIcon: /*#__PURE__*/React__default.createElement(chakra.Icon, {
                as: function as() {
                  return '▼';
                }
              })
            }, children), /*#__PURE__*/React__default.createElement(chakra.MenuList, null, items.map(function (item) {
              return /*#__PURE__*/React__default.createElement(chakra.MenuItem, {
                key: item.key,
          ...
          _this2.Tooltip = function (_ref24) {
            var title = _ref24.title,
              children = _ref24.children,
              props = _objectWithoutPropertiesLoose(_ref24, _excluded24$1);
            return /*#__PURE__*/React__default.createElement(chakra.Tooltip, _extends({
              label: title
            }, props), children);
          };
          _this2.Pagination = function (_ref25) {
            var _ref25$current = _ref25.current,
              current = _ref25$current === void 0 ? 1 : _ref25$current,
              _ref25$total = _ref25.total,
              total = _ref25$total === void 0 ? 0 : _ref25$total,
              _ref25$pageSize = _ref25.pageSize,
              pageSize = _ref25$pageSize === void 0 ? 10 : _ref25$pageSize,
              onChange = _ref25.onChange,
              props = _objectWithoutPropertiesLoose(_ref25, _excluded25$1);
            var totalPages = Math.ceil(total / pageSize);
            return /*#__PURE__*/React__default.createElement(chakra.HStack, _extends({
              spacing: 2,
              justifyContent: "center"
            }, props), /*#__PURE__*/React__default.createElement(chakra.Button, {
              size: "sm",
              onClick: function onClick() {
                return onChange === null || onChange === void 0 ? void 0 : onChange(current - 1, pageSize);
              },
              isDisabled: current === 1
            }, "Previous"), /*#__PURE__*/React__default.createElement(chakra.Text, null, "Page ", current, " of ", totalPages), /*#__PURE__*/React__default.createElement(chakra.Button, {
              size: "sm",
              onClick: function onClick() {
                return onChange === null || onChange === void 0 ? void 0 : onChange(current + 1, pageSize);
              },
          ...
          _this2.Spin = function (_ref26) {
            var _ref26$spinning = _ref26.spinning,
              spinning = _ref26$spinning === void 0 ? true : _ref26$spinning,
              children = _ref26.children,
              props = _objectWithoutPropertiesLoose(_ref26, _excluded26$1);
            if (!spinning) return children;
            return /*#__PURE__*/React__default.createElement(chakra.Box, _extends({
              position: "relative"
            }, props), /*#__PURE__*/React__default.createElement(chakra.Center, {
              position: "absolute",
              top: 0,
              left: 0,
              right: 0,
              ...
              bg: "whiteAlpha.800",
              zIndex: 1
            }, /*#__PURE__*/React__default.createElement(chakra.Spinner, {
              size: "lg",
              color: "blue.500"
            })), /*#__PURE__*/React__default.createElement(chakra.Box, {
              opacity: spinning ? 0.5 : 1
            }, children));
          };
          _this2.Empty = function (_ref27) {
            var _ref27$description = _ref27.description,
              description = _ref27$description === void 0 ? 'No data' : _ref27$description,
              props = _objectWithoutPropertiesLoose(_ref27, _excluded27$1);
            return /*#__PURE__*/React__default.createElement(chakra.Box, _extends({
              textAlign: "center",
              py: 8,
              color: "gray.500"
            }, props), /*#__PURE__*/React__default.createElement(chakra.Text, {
              fontSize: "3xl",
              mb: 2
            }, "\uD83D\uDCED"), /*#__PURE__*/React__default.createElement(chakra.Text, null, description));
          };
          _this2.Tag = function (_ref28) {
            var children = _ref28.children,
              closable = _ref28.closable,
              onClose = _ref28.onClose,
              color = _ref28.color,
              props = _objectWithoutPropertiesLoose(_ref28, _excluded28$1);
            return /*#__PURE__*/React__default.createElement(chakra.Tag, _extends({
              colorScheme: color,
              size: "md"
            }, props), /*#__PURE__*/React__default.createElement(chakra.TagLabel, null, children), closable && /*#__PURE__*/React__default.createElement(chakra.TagCloseButton, {
              onClick: onClose
            }));
          };
          _this2.Badge = function (_ref29) {
            var count = _ref29.count,
              children = _ref29.children,
              dot = _ref29.dot,
              props = _objectWithoutPropertiesLoose(_ref29, _excluded29$1);
            return /*#__PURE__*/React__default.createElement(chakra.Box, _extends({
              position: "relative",
              display: "inline-block"
            }, props), children, (count > 0 || dot) && /*#__PURE__*/React__default.createElement(chakra.Badge, {
              position: "absolute",
              top: "-2",
              right: "-2",
              colorScheme: "red",
  ...
  return ChakraUIAdapter;
}(UIAdapter);

var Rate$1 = function Rate(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, [].concat(Array(count)).map(function (_, index) {
    var filled = index < Math.floor(displayValue);
    var halfFilled = allowHalf && index === Math.floor(displayValue) && displayValue % 1 !== 0;
    return /*#__PURE__*/React__default.createElement("button", {
      key: index,
      type: "button",
      onClick: function onClick() {
      ...
      onMouseEnter: function onMouseEnter() {
        return !disabled && setHoverValue(index + 1);
      },
    ...
    }, /*#__PURE__*/React__default.createElement(solid.StarIcon, {
      className: "h-6 w-6 " + (filled || halfFilled ? 'text-yellow-400' : 'text-gray-300')
    }));
  }));
};
...
var Pagination$1 = function Pagination(_ref) {
  ...
  var renderPageNumbers = function renderPageNumbers() {
    var pages = [];
    var showPages = 5;
    var startPage = Math.max(1, current - Math.floor(showPages / 2));
    var endPage = Math.min(totalPages, startPage + showPages - 1);
    if (endPage - startPage < showPages - 1) {
      startPage = Math.max(1, endPage - showPages + 1);
    }
    var _loop = function _loop(i) {
      pages.push(/*#__PURE__*/React__default.createElement("button", {
        key: i,
        onClick: function onClick() {
          return handlePageChange(i);
        },
        className: "relative inline-flex items-center px-4 py-2 text-sm font-semibold " + (i === current ? 'z-10 bg-indigo-600 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' : 'text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0')
      }, i));
    };
  ...
  }, "Next")), /*#__PURE__*/React__default.createElement("div", {
  ...
  }, "Showing ", /*#__PURE__*/React__default.createElement("span", {
    className: "font-medium"
  }, (current - 1) * pageSize + 1), " to", ' ', /*#__PURE__*/React__default.createElement("span", {
    className: "font-medium"
  }, Math.min(current * pageSize, total)), " of", ' ', /*#__PURE__*/React__default.createElement("span", {
    className: "font-medium"
  }, total), " results")), /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("nav", {
  ...
  }, /*#__PURE__*/React__default.createElement(outline.ChevronLeftIcon, {
    className: "h-5 w-5"
  ...
  }, /*#__PURE__*/React__default.createElement(outline.ChevronRightIcon, {
    className: "h-5 w-5"
  }))))));
};

var _excluded$d = ["value", "onChange", "placeholder", "disabled", "error", "type", "label", "required"],
  _excluded2$a = ["value", "onChange", "min", "max", "step", "disabled", "error", "label", "required"],
  _excluded3$7 = ["value", "onChange", "placeholder", "disabled", "error", "label", "required"],
  _excluded4$5 = ["value", "onChange", "placeholder", "disabled", "error", "rows", "label", "required"],
  _excluded5$5 = ["value", "onChange", "options", "placeholder", "disabled", "error", "label", "required"],
  _excluded6$5 = ["value", "onChange", "disabled", "error", "label", "required"],
  _excluded7$5 = ["value", "onChange", "disabled", "error", "label", "required"],
  _excluded8$4 = ["value", "onChange", "disabled", "error", "label", "required"],
  _excluded9$4 = ["value", "onChange", "options", "label", "placeholder"],
  _excluded0$4 = ["children", "color", "closable", "onClose"],
  _excluded1$3 = ["count", "children"],
  _excluded10$3 = ["title", "children"],
  _excluded11$3 = ["percent", "status"],
  _excluded12$3 = ["message", "type", "closable", "onClose", "children"],
  _excluded13$3 = ["size"],
  _excluded14$2 = ["src", "alt", "size", "children"],
  _excluded15$2 = ["description"],
  _excluded16$2 = ["title", "extra", "children"],
  _excluded17$2 = ["open", "onClose", "title", "children", "placement"],
  _excluded18$2 = ["children", "type", "size", "loading", "disabled", "danger", "onClick"],
  _excluded19$2 = ["onChange", "children"],
  _excluded20$2 = ["dataSource", "columns"];
var TailwindUIAdapter = function TailwindUIAdapter() {
  var _this = this;
  this.getInputClasses = function (error, disabled) {
    var base = 'block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6';
    var normal = 'ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600';
    var errorClass = 'ring-red-300 text-red-900 placeholder:text-red-300 focus:ring-red-500';
    var disabledClass = 'bg-gray-50 text-gray-500 cursor-not-allowed';
    return base + " " + (error ? errorClass : normal) + " " + (disabled ? disabledClass : '');
  };
  this.Label = function (_ref) {
    var children = _ref.children,
    ...
    }, children, required && /*#__PURE__*/React__default.createElement("span", {
      className: "text-red-500 ml-1"
    }, "*"));
  };
  this.ErrorMessage = function (_ref2) {
    var children = _ref2.children;
    return /*#__PURE__*/React__default.createElement("p", {
      className: "mt-2 text-sm text-red-600"
    }, children);
  };
  this.Input = function (_ref3) {
    var value = _ref3.value,
    ...
    return /*#__PURE__*/React__default.createElement("div", null, label && /*#__PURE__*/React__default.createElement(_this.Label, {
      htmlFor: id,
      required: required
    }, label), /*#__PURE__*/React__default.createElement("div", {
      ...
      placeholder: placeholder,
      disabled: disabled,
      className: _this.getInputClasses(error, disabled)
    }, props))), error && /*#__PURE__*/React__default.createElement(_this.ErrorMessage, null, error));
  };
  this.InputNumber = function (_ref4) {
    var value = _ref4.value,
      ...
      props = _objectWithoutPropertiesLoose(_ref4, _excluded2$a);
    var id = props.id || "number-" + Math.random().toString(36).substr(2, 9);
    return /*#__PURE__*/React__default.createElement("div", null, label && /*#__PURE__*/React__default.createElement(_this.Label, {
      htmlFor: id,
      required: required
    }, label), /*#__PURE__*/React__default.createElement("div", {
      ...
      value: value != null ? value : '',
      onChange: function onChange(e) {
        return _onChange2 === null || _onChange2 === void 0 ? void 0 : _onChange2(parseFloat(e.target.value));
      },
      min: min,
      max: max,
      step: step,
  ...
  this.Password = function (_ref5) {
    ...
    return /*#__PURE__*/React__default.createElement(_this.Input, _extends({
      type: "password",
      value: value,
      onChange: onChange,
      placeholder: placeholder,
  ...
  this.Textarea = function (_ref6) {
    var value = _ref6.value,
      ...
      rows = _ref6$rows === void 0 ? 4 : _ref6$rows,
      label = _ref6.label,
      required = _ref6.required,
      props = _objectWithoutPropertiesLoose(_ref6, _excluded4$5);
    var id = props.id || "textarea-" + Math.random().toString(36).substr(2, 9);
    return /*#__PURE__*/React__default.createElement("div", null, label && /*#__PURE__*/React__default.createElement(_this.Label, {
      htmlFor: id,
      required: required
    }, label), /*#__PURE__*/React__default.createElement("div", {
      ...
      value: value || '',
      onChange: function onChange(e) {
        return _onChange3 === null || _onChange3 === void 0 ? void 0 : _onChange3(e.target.value);
      },
      placeholder: placeholder,
      disabled: disabled,
      rows: rows,
  ...
  this.Select = function (_ref7) {
    var value = _ref7.value,
      onChange = _ref7.onChange,
      _ref7$options = _ref7.options,
      options = _ref7$options === void 0 ? [] : _ref7$options,
      _ref7$placeholder = _ref7.placeholder,
      placeholder = _ref7$placeholder === void 0 ? 'Select option' : _ref7$placeholder,
      disabled = _ref7.disabled,
      error = _ref7.error,
      label = _ref7.label,
      required = _ref7.required,
      props = _objectWithoutPropertiesLoose(_ref7, _excluded5$5);
    var selected = options.find(function (opt) {
      return opt.value === value;
    });
    return /*#__PURE__*/React__default.createElement("div", null, label && /*#__PURE__*/React__default.createElement(_this.Label, {
      required: required
    }, label), /*#__PURE__*/React__default.createElement(react.Listbox, {
      value: value,
      onChange: onChange,
      disabled: disabled
    }, /*#__PURE__*/React__default.createElement("div", {
      className: "relative mt-2"
    }, /*#__PURE__*/React__default.createElement(react.Listbox.Button, {
      className: _this.getInputClasses(error, disabled) + ' text-left relative pr-10'
    }, /*#__PURE__*/React__default.createElement("span", {
      className: "block truncate"
    }, selected ? selected.label : placeholder), /*#__PURE__*/React__default.createElement("span", {
      className: "pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2"
    }, /*#__PURE__*/React__default.createElement(outline.ChevronUpDownIcon, {
      className: "h-5 w-5 text-gray-400",
      "aria-hidden": "true"
    }))), /*#__PURE__*/React__default.createElement(react.Transition, {
      as: React.Fragment,
      leave: "transition ease-in duration-100",
      leaveFrom: "opacity-100",
      leaveTo: "opacity-0"
    }, /*#__PURE__*/React__default.createElement(react.Listbox.Options, {
      className: "absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
    }, options.map(function (option) {
      return /*#__PURE__*/React__default.createElement(react.Listbox.Option, {
        key: option.value,
        value: option.value,
        className: function className(_ref8) {
          var active = _ref8.active;
          return "relative cursor-pointer select-none py-2 pl-10 pr-4 " + (active ? 'bg-indigo-100 text-indigo-900' : 'text-gray-900');
        }
      }, function (_ref9) {
        ...
        }, option.label), selected && /*#__PURE__*/React__default.createElement("span", {
          className: "absolute inset-y-0 left-0 flex items-center pl-3 text-indigo-600"
        }, /*#__PURE__*/React__default.createElement(outline.CheckIcon, {
          className: "h-5 w-5",
          "aria-hidden": "true"
        })));
      });
    }))))), error && /*#__PURE__*/React__default.createElement(_this.ErrorMessage, null, error));
  };
  this.Checkbox = function (_ref0) {
    var checked = _ref0.checked,
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      onChange: function onChange(e) {
        return _onChange4 === null || _onChange4 === void 0 ? void 0 : _onChange4(e.target.checked);
      },
      disabled: disabled,
  ...
  this.Switch = function (_ref1) {
    var checked = _ref1.checked,
      onChange = _ref1.onChange,
      label = _ref1.label,
      disabled = _ref1.disabled,
      children = _ref1.children;
    return /*#__PURE__*/React__default.createElement(react.Switch.Group, {
      as: "div",
    ...
    })), (label || children) && /*#__PURE__*/React__default.createElement(react.Switch.Label, {
      as: "span",
  ...
  this.RadioGroup = function (_ref10) {
    var value = _ref10.value,
      _onChange5 = _ref10.onChange,
      _ref10$options = _ref10.options,
      options = _ref10$options === void 0 ? [] : _ref10$options,
      label = _ref10.label;
    return /*#__PURE__*/React__default.createElement("fieldset", null, label && /*#__PURE__*/React__default.createElement("legend", {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
        ...
        onChange: function onChange() {
          return _onChange5 === null || _onChange5 === void 0 ? void 0 : _onChange5(option.value);
        },
  ...
  this.DatePicker = function (_ref11) {
    var value = _ref11.value,
      ...
      props = _objectWithoutPropertiesLoose(_ref11, _excluded6$5);
    return /*#__PURE__*/React__default.createElement(_this.Input, _extends({
      type: "date",
      value: value,
      onChange: onChange,
  ...
  this.TimePicker = function (_ref12) {
    var value = _ref12.value,
      onChange = _ref12.onChange,
      disabled = _ref12.disabled,
      error = _ref12.error,
      ...
      props = _objectWithoutPropertiesLoose(_ref12, _excluded7$5);
    return /*#__PURE__*/React__default.createElement(_this.Input, _extends({
      type: "time",
      value: value,
      onChange: onChange,
  ...
  this.DateTimePicker = function (_ref13) {
    var value = _ref13.value,
      onChange = _ref13.onChange,
      disabled = _ref13.disabled,
      error = _ref13.error,
      ...
      props = _objectWithoutPropertiesLoose(_ref13, _excluded8$4);
    return /*#__PURE__*/React__default.createElement(_this.Input, _extends({
      type: "datetime-local",
      value: value,
      onChange: onChange,
  ...
  this.Slider = function (_ref14) {
    var value = _ref14.value,
      _onChange6 = _ref14.onChange,
      _ref14$min = _ref14.min,
      min = _ref14$min === void 0 ? 0 : _ref14$min,
      _ref14$max = _ref14.max,
      max = _ref14$max === void 0 ? 100 : _ref14$max,
    ...
    }, label, ": ", value), /*#__PURE__*/React__default.createElement("input", {
      type: "range",
      value: value != null ? value : min,
      onChange: function onChange(e) {
        return _onChange6 === null || _onChange6 === void 0 ? void 0 : _onChange6(parseFloat(e.target.value));
      },
      min: min,
      max: max,
      step: step,
  ...
  this.Rate = Rate$1;
  this.Autocomplete = function (_ref15) {
    var value = _ref15.value,
      ...
      props = _objectWithoutPropertiesLoose(_ref15, _excluded9$4);
    return /*#__PURE__*/React__default.createElement(_this.Select, _extends({
      value: value,
      onChange: onChange,
      options: options,
      label: label,
  ...
  this.Tag = function (_ref16) {
    var children = _ref16.children,
      _ref16$color = _ref16.color,
      color = _ref16$color === void 0 ? 'gray' : _ref16$color,
      closable = _ref16.closable,
      onClose = _ref16.onClose,
      props = _objectWithoutPropertiesLoose(_ref16, _excluded0$4);
    var colorClasses = {
    ...
    return /*#__PURE__*/React__default.createElement("span", {
      className: "inline-flex items-center gap-x-1.5 rounded-md px-2 py-1 text-xs font-medium " + (colorClasses[color] || colorClasses.gray)
    }, children, closable && /*#__PURE__*/React__default.createElement("button", {
      type: "button",
      onClick: onClose,
      className: "group relative -mr-1 h-3.5 w-3.5 rounded-sm hover:bg-gray-500/20"
    }, /*#__PURE__*/React__default.createElement(outline.XMarkIcon, {
      className: "h-3.5 w-3.5"
    })));
  };
  this.Badge = function (_ref17) {
    var count = _ref17.count,
      children = _ref17.children,
      props = _objectWithoutPropertiesLoose(_ref17, _excluded1$3);
    return /*#__PURE__*/React__default.createElement("span", {
      className: "relative inline-block"
    }, children, count > 0 && /*#__PURE__*/React__default.createElement("span", {
  ...
  this.Tooltip = function (_ref18) {
    var title = _ref18.title,
      children = _ref18.children,
      props = _objectWithoutPropertiesLoose(_ref18, _excluded10$3);
    return /*#__PURE__*/React__default.createElement("div", {
      className: "group relative inline-block"
    }, children, /*#__PURE__*/React__default.createElement("div", {
      className: "invisible group-hover:visible absolute z-10 bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 text-sm text-white bg-gray-900 rounded-lg shadow-sm whitespace-nowrap"
    }, title, /*#__PURE__*/React__default.createElement("div", {
      className: "absolute top-full left-1/2 -translate-x-1/2 -mt-1 border-4 border-transparent border-t-gray-900"
    })));
  };
  this.Progress = function (_ref19) {
    var _ref19$percent = _ref19.percent,
      percent = _ref19$percent === void 0 ? 0 : _ref19$percent,
      status = _ref19.status,
      props = _objectWithoutPropertiesLoose(_ref19, _excluded11$3);
    var colorClass = status === 'success' ? 'bg-green-600' : status === 'error' ? 'bg-red-600' : 'bg-indigo-600';
    return /*#__PURE__*/React__default.createElement("div", {
  ...
  this.Alert = function (_ref20) {
    var message = _ref20.message,
      _ref20$type = _ref20.type,
      type = _ref20$type === void 0 ? 'info' : _ref20$type,
      closable = _ref20.closable,
      onClose = _ref20.onClose,
      children = _ref20.children,
      props = _objectWithoutPropertiesLoose(_ref20, _excluded12$3);
    var icons = {
      info: /*#__PURE__*/React__default.createElement(outline.InformationCircleIcon, {
        className: "h-5 w-5"
      }),
      success: /*#__PURE__*/React__default.createElement(outline.CheckCircleIcon, {
        className: "h-5 w-5"
      }),
      warning: /*#__PURE__*/React__default.createElement(outline.ExclamationTriangleIcon, {
        className: "h-5 w-5"
      }),
      error: /*#__PURE__*/React__default.createElement(outline.XCircleIcon, {
        className: "h-5 w-5"
      })
    };
    var colorClasses = {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      className: "rounded-md border p-4 " + colorClasses[type]
    }, /*#__PURE__*/React__default.createElement("div", {
      className: "flex"
    }, /*#__PURE__*/React__default.createElement("div", {
    ...
    }, message || children)), closable && /*#__PURE__*/React__default.createElement("div", {
  ...
  this.Spin = function (_ref21) {
    var _ref21$size = _ref21.size,
      size = _ref21$size === void 0 ? 'default' : _ref21$size,
      props = _objectWithoutPropertiesLoose(_ref21, _excluded13$3);
    var sizeClasses = {
      small: 'h-4 w-4',
      "default": 'h-8 w-8',
      large: 'h-12 w-12'
  ...
  this.Avatar = function (_ref22) {
    var src = _ref22.src,
      alt = _ref22.alt,
      _ref22$size = _ref22.size,
      size = _ref22$size === void 0 ? 'default' : _ref22$size,
      children = _ref22.children,
      props = _objectWithoutPropertiesLoose(_ref22, _excluded14$2);
    var sizeClasses = {
      small: 'h-8 w-8',
      "default": 'h-10 w-10',
      large: 'h-12 w-12'
    ...
    return /*#__PURE__*/React__default.createElement("span", {
      className: sizeClasses[size] + " inline-flex items-center justify-center rounded-full bg-gray-500"
    }, /*#__PURE__*/React__default.createElement("span", {
      className: "text-sm font-medium leading-none text-white"
    }, children));
  };
  this.Empty = function (_ref23) {
    var _ref23$description = _ref23.description,
      description = _ref23$description === void 0 ? 'No data' : _ref23$description,
      props = _objectWithoutPropertiesLoose(_ref23, _excluded15$2);
    return /*#__PURE__*/React__default.createElement("div", {
  ...
  this.Card = function (_ref24) {
    var title = _ref24.title,
      extra = _ref24.extra,
      children = _ref24.children,
      props = _objectWithoutPropertiesLoose(_ref24, _excluded16$2);
    return /*#__PURE__*/React__default.createElement("div", {
      className: "bg-white shadow rounded-lg"
    }, (title || extra) && /*#__PURE__*/React__default.createElement("div", {
  ...
  this.Collapse = react.Disclosure;
  this.Tabs = react.Tab;
  this.Modal = react.Dialog;
  this.Drawer = function (_ref25) {
    var open = _ref25.open,
      onClose = _ref25.onClose,
      title = _ref25.title,
      children = _ref25.children,
      _ref25$placement = _ref25.placement,
      placement = _ref25$placement === void 0 ? 'right' : _ref25$placement,
      props = _objectWithoutPropertiesLoose(_ref25, _excluded17$2);
    var positionClasses = {
      left: 'left-0',
      right: 'right-0',
      top: 'top-0',
    ...
    return /*#__PURE__*/React__default.createElement(react.Transition, {
      show: open,
      as: React.Fragment
    }, /*#__PURE__*/React__default.createElement(react.Dialog, {
      as: "div",
      className: "relative z-50",
      onClose: onClose
    }, /*#__PURE__*/React__default.createElement(react.Transition.Child, {
      as: React.Fragment,
      ...
      className: "pointer-events-none fixed inset-y-0 flex max-w-full " + (positionClasses[placement] || positionClasses.right)
    }, /*#__PURE__*/React__default.createElement(react.Transition.Child, {
      as: React.Fragment,
    ...
    }, /*#__PURE__*/React__default.createElement(react.Dialog.Panel, {
    ...
    }, /*#__PURE__*/React__default.createElement(react.Dialog.Title, {
  ...
  this.Button = function (_ref26) {
    var children = _ref26.children,
      _ref26$type = _ref26.type,
      type = _ref26$type === void 0 ? 'default' : _ref26$type,
      _ref26$size = _ref26.size,
      size = _ref26$size === void 0 ? 'default' : _ref26$size,
      loading = _ref26.loading,
      disabled = _ref26.disabled,
      danger = _ref26.danger,
      onClick = _ref26.onClick,
      props = _objectWithoutPropertiesLoose(_ref26, _excluded18$2);
    var baseClasses = 'inline-flex items-center justify-center rounded-md font-semibold shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-colors';
    var sizeClasses = {
    ...
    var dangerClasses = 'bg-red-600 text-white hover:bg-red-500 focus-visible:outline-red-600';
    ...
    }, props), loading && /*#__PURE__*/React__default.createElement(_this.Spin, {
      size: "small"
    }), !loading && children);
  };
  this.Dropdown = react.Menu;
  this.Pagination = Pagination$1;
  this.Upload = function (_ref27) {
    var _onChange7 = _ref27.onChange,
      children = _ref27.children,
      props = _objectWithoutPropertiesLoose(_ref27, _excluded19$2);
    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("input", _extends({
      type: "file",
      onChange: function onChange(e) {
        var _e$target$files;
        return _onChange7 === null || _onChange7 === void 0 ? void 0 : _onChange7((_e$target$files = e.target.files) === null || _e$target$files === void 0 ? void 0 : _e$target$files[0]);
      },
      className: "block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
    }, props)), children);
  };
  this.Table = function (_ref28) {
    var _ref28$dataSource = _ref28.dataSource,
      dataSource = _ref28$dataSource === void 0 ? [] : _ref28$dataSource,
      _ref28$columns = _ref28.columns,
      columns = _ref28$columns === void 0 ? [] : _ref28$columns,
      props = _objectWithoutPropertiesLoose(_ref28, _excluded20$2);
    return /*#__PURE__*/React__default.createElement("div", {
    ...
    }, /*#__PURE__*/React__default.createElement("tr", null, columns.map(function (col, idx) {
    ...
    }, dataSource.map(function (row, rowIdx) {
...
exports.And = And;
exports.AntdAdapter = AntdAdapter;
exports.AntdMobileAdapter = AntdMobileAdapter;
exports.AuthProvider = AuthProvider;
exports.AuthService = AuthService;
exports.CREATE = CREATE;
exports.CREATEP = CREATEP;
exports.CRUD = index$4;
exports.ChakraUIAdapter = ChakraUIAdapter;
...
exports.MaterialUIAdapter = MaterialUIAdapter;
...
exports.TailwindUIAdapter = TailwindUIAdapter;
