...
//---------------------------------------------------------------------
// ПРИМЕЧАНИЕ: Следующие функции мигрированы в core/ модули:
// - publish, subscribe, unsubscribe → core/pubsub
// - HasRole, HasRoleID → core/roles
// - getLocator, getAILocator, LOCATOR_TYPES, LOCATOR_ACTIONS → core/utils/locator
// - equals → core/utils/comparison
// - unwrap, clean, If, IfElse, And, Or, uncapitalize → core/utils/functional
// - arrayUnpack, upgradeInArray, createInArray, updateInArray, deleteInArray и др. → core/utils/array
// - getObjectValue, getObjectValueOrDefault → core/utils/object
// - getDisplay, getObjectDisplay, getFieldDisplay, getFormatFieldValueTableView → core/utils/display
// - typeIsNumber, priceFormat → core/utils/display
// - makeFormData, unpackFormFields, preventDefault, eventExecution, detectMutation → core/utils/form
// - CREATE, READ, UPDATE, DELETE, POST, GET и их Promise-версии → core/crud
// - FennecError, errorCatch, errorAlert, messageError → core/error
// - QueryParams, QueryParam, QueryOrder, QueryDetail, QueryFunc → core/query/params
// - ContextFiltersToQueryFilters, QueryFiltersToContextFilters и др. → core/query/contextFilters
// - FilterToQueryParameters, QueryParametersToFilters и др. → core/query/filterBuilder
// - isRequired, validator, formItemRules → core/validation
// - GetMeta, GetMetaProperties, SetMetaProperties, GetMetaPropertyByPath → core/meta
// - metaGetCloneObject, metaGetFieldByName, getSortingDisplayFields → core/meta/helpers
// - MetaColumns → core/meta/MetaColumns
//
// Они также экспортируются отсюда для обратной совместимости
// В будущих версиях остальные функции также будут мигрированы в core/
//---------------------------------------------------------------------